...
import (
	"fmt"
	"github.com/ionos-cloud/ionosctl/cmds/cloudapi-v6"
	"os"
	"strconv"
	"strings"
...
func addCommands() {
	...
	rootCmd.AddCommand(commands.location())
	rootCmd.AddCommand(commands.datacenter())
	rootCmd.AddCommand(commands.server())
	rootCmd.AddCommand(commands.volume())
	rootCmd.AddCommand(commands.lan())
	rootCmd.AddCommand(commands.natgateway())
	rootCmd.AddCommand(commands.networkloadbalancer())
	rootCmd.AddCommand(commands.nic())
	rootCmd.AddCommand(commands.loadBalancer())
	rootCmd.AddCommand(commands.ipblock())
	rootCmd.AddCommand(commands.ipconsumer())
	rootCmd.AddCommand(commands.ipfailover())
	rootCmd.AddCommand(commands.request())
	rootCmd.AddCommand(commands.snapshot())
	rootCmd.AddCommand(commands.image())
	rootCmd.AddCommand(commands.firewallrule())
	rootCmd.AddCommand(commands.flowlog())
	rootCmd.AddCommand(commands.label())
	rootCmd.AddCommand(commands.contract())
	rootCmd.AddCommand(commands.user())
	rootCmd.AddCommand(commands.group())
	rootCmd.AddCommand(commands.resource())
	rootCmd.AddCommand(commands.backupunit())
	rootCmd.AddCommand(commands.pcc())
	rootCmd.AddCommand(commands.share())
	rootCmd.AddCommand(commands.k8s())
	rootCmd.AddCommand(commands.template())
}
