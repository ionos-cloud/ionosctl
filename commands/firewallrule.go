...
* Firewall Rule Protocol`, createFirewallRuleExample, true)
	...
	create.AddStringFlag(config.ArgFirewallRuleIcmpType, "", "", "Define the allowed type (from 0 to 254) if the protocol ICMP is chosen. Unset option allows all types.")
	create.AddStringFlag(config.ArgFirewallRuleIcmpCode, "", "", "Define the allowed code (from 0 to 254) if protocol ICMP is chosen. Unset option allows all codes.")
	create.AddIntFlag(config.ArgFirewallRulePortRangeStart, "", 0, "Define the start range of the allowed port (from 1 to 65534) if protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd unset to allow all ports.")
	create.AddIntFlag(config.ArgFirewallRulePortRangeStop, "", 0, "Define the end range of the allowed port (from 1 to 65534) if the protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd unset to allow all ports.")
...
* Firewall Rule Id`, updateFirewallRuleExample, true)
	...
	update.AddStringFlag(config.ArgFirewallRuleIcmpType, "", "", "Redefine the allowed type (from 0 to 254) if the protocol ICMP is chosen. Unset option allows all types.")
	update.AddStringFlag(config.ArgFirewallRuleIcmpCode, "", "", "Redefine the allowed code (from 0 to 254) if protocol ICMP is chosen. Unset option allows all codes.")
	update.AddIntFlag(config.ArgFirewallRulePortRangeStart, "", 0, "Redefine the start range of the allowed port (from 1 to 65534) if protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd unset to allow all ports.")
	update.AddIntFlag(config.ArgFirewallRulePortRangeStop, "", 0, "Redefine the end range of the allowed port (from 1 to 65534) if the protocol TCP or UDP is chosen. Leave portRangeStart and portRangeEnd unset to allow all ports.")
