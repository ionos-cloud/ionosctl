...
var (
	...
	lanProperties = v6.LanProperties{
...
func TestRunLanList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Resource, config.ArgDataCenterId), testLanVar)
		rm.Lan.EXPECT().List(testLanVar).Return(ls, &testResponse, nil)
		err := RunLanList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLanGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Resource, config.ArgDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgLanId), testLanVar)
		rm.Lan.EXPECT().Get(testLanVar, testLanVar).Return(&v6.Lan{Lan: l}, &testResponse, nil)
		err := RunLanGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLanGet_Err(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Resource, config.ArgDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgLanId), testLanVar)
		rm.Lan.EXPECT().Get(testLanVar, testLanVar).Return(&v6.Lan{Lan: l}, nil, testLanErr)
		err := RunLanGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.Lan.EXPECT().Create(testLanVar, v6.LanPost{LanPost: lanPostTest}).Return(&v6.LanPost{LanPost: lp}, &testResponse, nil)
...
func TestRunLanCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPublic), publicLan)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPccId), testLanVar)
		rm.Lan.EXPECT().Create(testLanVar, v6.LanPost{LanPost: lanPostTest}).Return(&v6.LanPost{LanPost: lp}, nil, testLanErr)
		err := RunLanCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanCreateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPublic), publicLan)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPccId), testLanVar)
		rm.Lan.EXPECT().Create(testLanVar, v6.LanPost{LanPost: lanPostTest}).Return(&v6.LanPost{LanPost: lp}, nil, nil)
		err := RunLanCreate(cfg)
		assert.Error(t, err)
	})
}
