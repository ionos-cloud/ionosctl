...
func TestPreRunClusterBackupIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupId), testClusterVar)
...
func TestPreRunClusterCreate(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagVersion), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDatacenterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLanId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCidr), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbPassword), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupLocation), testClusterBackupLocation)
...
func TestPreRunClusterCreateInstancesErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbPassword), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), 10)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupLocation), testClusterBackupLocation)
		err := PreRunClusterCreate(cfg)
		assert.Error(t, err)
...
func TestPreRunClusterCreateCoresErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbPassword), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), 0)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupLocation), testClusterBackupLocation)
		err := PreRunClusterCreate(cfg)
		assert.Error(t, err)
	})
...
func TestPreRunClusterCreateRecoveryTime(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLanId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCidr), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRecoveryTime), testTimeArgVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
...
func TestPreRunClusterDelete(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagName), testClusterVar)
...
func TestRunClusterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCidr), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagVersion), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLocation), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRam), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSyncMode), strings.ToUpper(testClusterVar))
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageType), string("HDD"))
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceDay), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceTime), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagName), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbPassword), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagBackupId), testClusterVar)
...
func TestRunClusterCreateSSDPremium(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageType), "SSD_Premium")
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceDay), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceTime), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagName), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
...
func TestRunClusterCreateSSDStandard(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageType), "SSD_standard")
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceDay), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceTime), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagName), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDbUsername), testClusterVar)
...
func TestRunClusterCreateConvertErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLocation), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRam), "test")
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSyncMode), strings.ToUpper(testClusterVar))
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageType), string("HDD"))
...
func TestRunClusterCreateWaitForState(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRam), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSyncMode), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterMbVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageType), string("HDD"))
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceDay), testClusterVar)
...
func TestRunClusterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgServerUrl, constants.DefaultApiURL)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagVersion), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRam), testClusterIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testClusterIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagInstances), testClusterIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStorageSize), testClusterIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceDay), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagMaintenanceTime), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagName), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDatacenterId), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLanId), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCidr), testClusterNewVar)
		rm.CloudApiDbaasPgsqlMocks.Cluster.EXPECT().Get(testClusterVar).Return(&testClusterGet, nil, nil)
...
func TestRunClusterUpdateRemoveConnection(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgServerUrl, constants.DefaultApiURL)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRemoveConnection), true)
		rm.CloudApiDbaasPgsqlMocks.Cluster.EXPECT().Get(testClusterVar).Return(&testClusterGet, nil, nil)
