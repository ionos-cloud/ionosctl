...
func TestPreRunClusterLogsList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSince), testSinceVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagUntil), testUntilVar)
...
func TestPreRunClusterLogsListSinceErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSince), "3min")
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagUntil), testUntilVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		err := PreRunClusterLogsList(cfg)
		assert.Error(t, err)
...
func TestPreRunClusterLogsListUntilErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagSince), testUntilVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagUntil), "1min")
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		err := PreRunClusterLogsList(cfg)
		assert.Error(t, err)
	})
...
func TestRunClusterLogsGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagStartTime), testStartTimeVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagEndTime), testEndTimeVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagLimit), testLimitVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagDirection), testDirectionVar)
