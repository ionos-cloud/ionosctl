...
var locationCols = []table.Column{
	{Name: "SnapshotLocationId", JSONPath: "id", Default: true},
...
func LocationCmd() *core.Command {
	locationCmd := &core.Command{
		Command: &cobra.Command{
			...
			Short:            "In-Memory DB Snapshot Location Operations",
			Long:             "The sub-commands of `ionosctl dbaas in-memory-db-v2 snapshot location` allow you to list the supported Object Storage locations where snapshots can be stored.",
