...
func TestPreRunK8sClusterNodesIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodeId), testNodeVar)
...
func TestRunK8sNodeList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testNodeVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(testNodeVar, testNodeVar).Return(nodesTest, nil, nil)
