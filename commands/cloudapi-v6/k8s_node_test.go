...
func TestRunK8sNodeList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodeVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodeVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodesTest, &testResponse, nil)
...
func TestRunK8sNodeListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.K8sNodes{}, &testResponse, nil)
			err := RunK8sNodeList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunK8sNodeListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodesTest, nil, testNodeErr)
			err := RunK8sNodeList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodeGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodeVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodeVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodeTestGet, &testResponse, nil)
...
func TestRunK8sNodeGetWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodeTestGet, nil, testNodeErr)
			err := RunK8sNodeGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodeRecreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodeVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodeVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().RecreateNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunK8sNodeDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodeVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodeVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunK8sNodeDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodesTestList, &testResponse, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNode(
...
func TestRunK8sNodeDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodesTestList, nil, testNodeErr)
			err := RunK8sNodeDelete(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodes(
				...
				resources.K8sNodes{KubernetesNodes: ionoscloud.KubernetesNodes{Items: &[]ionoscloud.KubernetesNode{}}},
				&testResponse, nil,
			)
			err := RunK8sNodeDelete(cfg)
			assert.Error(t, err)
...
func TestRunK8sNodeDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testNodeErr)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNode(
				testNodeVar, testNodeVar, testNodeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunK8sNodeDelete(cfg)
