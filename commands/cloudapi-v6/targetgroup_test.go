...
func TestRunTargetGroupList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgQuiet, false)
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				targetGroups, nil, nil,
			)
...
func TestRunTargetGroupListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				targetGroups, nil, testTargetGroupErr,
			)
			err := RunTargetGroupList(cfg)
			assert.Error(t, err)
		},
...
func TestRunTargetGroupGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgTargetGroupId), testTargetGroupVar)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&targetGroupTestGet, nil, nil)
...
func TestRunTargetGroupGetResponse(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&targetGroupTestGet, &testResponse, nil)
			err := RunTargetGroupGet(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunTargetGroupGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&targetGroupTestGet, nil, testTargetGroupErr)
			err := RunTargetGroupGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunTargetGroupCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Create(
				targetGroupTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&targetGroupTestGet, nil, nil)
...
func TestRunTargetGroupUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Update(
				testTargetGroupVar, &targetGroupNewProperties, testQueryParamOther,
			).Return(&targetGroupNew, nil, nil)
...
func TestRunTargetGroupUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Update(
				testTargetGroupVar, &targetGroupNewProperties, testQueryParamOther,
			).Return(&targetGroupNew, nil, testTargetGroupErr)
			err := RunTargetGroupUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunTargetGroupDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgTargetGroupId), testTargetGroupVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Delete(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(nil, nil)
...
func TestRunTargetGroupDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Delete(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(nil, testTargetGroupTargetErr)
			err := RunTargetGroupDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunTargetGroupDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				targetGroups, nil, testTargetGroupTargetErr,
			)
			err := RunTargetGroupDelete(cfg)
			assert.Error(t, err)
		},
...
func TestRunTargetGroupDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Delete(
				testTargetGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testTargetGroupErr)
			err := RunTargetGroupDelete(cfg)
			assert.Error(t, err)
		},
	)
