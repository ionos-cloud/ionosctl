...
func TestPreRunDcNatGatewayLanIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testNatGatewayLanVar)
...
func TestRunNatGatewayLanAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgIps), testNatGatewayLanNewVar)
...
func TestRunNatGatewayLanAddResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgIps), []string{testNatGatewayLanNewVar})
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testNatGatewayLanNewIntVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayLanVar, testNatGatewayLanVar).Return(&natgatewayLanTest, nil, nil)
