...
func TestPreRunDcNatGatewayLanIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testNatGatewayLanVar)
...
func TestRunNatGatewayLanList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.Resource, constants.FlagCols), defaultNatGatewayLanCols)
...
func TestRunNatGatewayLanAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), testNatGatewayLanNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testNatGatewayLanNewIntVar)
...
func TestRunNatGatewayLanAddErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), []string{testNatGatewayLanNewVar})
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testNatGatewayLanNewIntVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayLanVar, testNatGatewayLanVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayLanTest, nil, nil)
