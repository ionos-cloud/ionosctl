	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(
				testNatGatewayLanVar, testNatGatewayLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTest, &testResponse, nil)
...
func TestRunNatGatewayLanListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(
				testNatGatewayLanVar, testNatGatewayLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTest, nil, testNatGatewayLanErr)
			err := RunNatGatewayLanList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunNatGatewayLanAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(
				testNatGatewayLanVar, testNatGatewayLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTest, nil, nil)
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(
				testNatGatewayLanVar, testNatGatewayLanVar, natgatewayLanTestProper,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTestUpdated, &testResponse, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(
				testNatGatewayLanVar, testNatGatewayLanVar, natgatewayLanTestProper,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTestUpdated, &testResponseErr, nil)
			err := RunNatGatewayLanAdd(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(
				testNatGatewayLanVar, testNatGatewayLanVar, natgatewayLanTestProper,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTestUpdated, nil, testNatGatewayLanErr)
			err := RunNatGatewayLanAdd(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunNatGatewayLanRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(
				testNatGatewayLanVar, testNatGatewayLanVar, natgatewayLanTestRemove,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTest, nil, nil)
...
func TestRunNatGatewayLanRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(
				testNatGatewayLanVar, testNatGatewayLanVar, natgatewayLanTestRemoveAll,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&natgatewayLanTest, nil, nil)
			err := RunNatGatewayLanRemove(cfg)
			assert.NoError(t, err)
