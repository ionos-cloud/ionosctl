...
func TestRunDataCenterLabelsList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResources, &testResponse, nil)
...
func TestRunDataCenterLabelsListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResources, nil, testLabelResourceErr)
			err := RunDataCenterLabelsList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDataCenterLabelGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterGet(
				testLabelResourceVar, testLabelResourceVar,
...
func TestRunDataCenterLabelGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterGet(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, nil, testLabelResourceErr)
			err := RunDataCenterLabelGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDatacenterLabelAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterCreate(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunDatacenterLabelRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(
				testLabelResourceVar, testLabelResourceVar,
...
func TestRunDatacenterLabelRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResourcesList, &testResponse, nil)
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(
...
func TestRunDatacenterLabelRemoveAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResourcesList, nil, testLabelResourceErr)
			err := RunDataCenterLabelRemove(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDatacenterLabelRemoveAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(resources.LabelResources{}, &testResponse, nil)
			err := RunDataCenterLabelRemove(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterList(
				...
				resources.LabelResources{LabelResources: ionoscloud.LabelResources{Items: &[]ionoscloud.LabelResource{}}},
				&testResponse, nil,
			)
			err := RunDataCenterLabelRemove(cfg)
			assert.Error(t, err)
...
func TestRunDatacenterLabelRemoveAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, testLabelResourceErr)
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
			err := RunDataCenterLabelRemove(cfg)
...
func TestRunDatacenterLabelRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().DatacenterDelete(testLabelResourceVar, testLabelResourceVar).Return(
				nil, testLabelResourceErr,
			)
			err := RunDataCenterLabelRemove(cfg)
			assert.Error(t, err)
		},
...
func TestRunIpBlockLabelsList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().IpBlockList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResources, &testResponse, nil)
...
func TestRunIpBlockLabelGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().IpBlockGet(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunIpBlockLabelAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelValue), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().IpBlockCreate(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunIpBlockLabelRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().IpBlockDelete(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
...
func TestRunIpBlockLabelRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().IpBlockDelete(testLabelResourceVar, testLabelResourceVar).Return(
				nil, testLabelResourceErr,
			)
			err := RunIpBlockLabelRemove(cfg)
			assert.Error(t, err)
...
func TestRunSnapshotLabelsList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().SnapshotList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar,
			).Return(testLabelResources, &testResponse, nil)
...
func TestRunSnapshotLabelGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgSnapshotId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().SnapshotGet(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunSnapshotLabelAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelValue), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().SnapshotCreate(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunSnapshotLabelRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgSnapshotId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().SnapshotDelete(
				testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
...
func TestRunSnapshotLabelRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgSnapshotId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().SnapshotDelete(testLabelResourceVar, testLabelResourceVar).Return(
				nil, testLabelResourceErr,
			)
			err := RunSnapshotLabelRemove(cfg)
			assert.Error(t, err)
...
func TestRunServerLabelsList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().ServerList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar, testLabelResourceVar,
			).Return(testLabelResources, &testResponse, nil)
...
func TestRunServerLabelGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().ServerGet(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunServerLabelAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelValue), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().ServerCreate(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).
				Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunServerLabelRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().ServerDelete(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
...
func TestRunServerLabelRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().ServerDelete(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(nil, testLabelResourceErr)
			err := RunServerLabelRemove(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunVolumeLabelsList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Label.EXPECT().VolumeList(
				gomock.AssignableToTypeOf(testListQueryParam), testLabelResourceVar, testLabelResourceVar,
			).Return(testLabelResources, &testResponse, nil)
...
func TestRunVolumeLabelGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgVolumeId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().VolumeGet(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunVolumeLabelAdd(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelValue), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().VolumeCreate(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).
				Return(&testLabelResourceRes, &testResponse, nil)
...
func TestRunVolumeLabelRemove(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgVolumeId), testLabelResourceVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLabelKey), testLabelResourceVar)
			rm.CloudApiV6Mocks.Label.EXPECT().VolumeDelete(
				testLabelResourceVar, testLabelResourceVar, testLabelResourceVar,
			).Return(&testResponse, nil)
