...
func ImageCmd() *core.Command {
	...
	*/
	...
	list.AddStringFlag(
		cloudapiv6.ArgType, "", "", "The type of the Image", core.DeprecatedFlagOption(deprecatedMessage),
	)
...
func getDesiredImageAfterPatch(c *core.CommandConfig) resources.ImageProperties {
	...
	c.Command.Command.Flags().VisitAll(
	...
	if c != nil {
		...
		if imgs != nil {
			...
			r.Columns = printer.GetHeaders(
				allImageCols, defaultImageCols, viper.GetStringSlice(core.GetFlagName(c.Resource, constants.ArgCols)),
			)
		}
	}
	return r
