...
func TestRunLanListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().List(
				testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(lansList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunLanListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().List(
				testLanVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.Lans{}, &testResponse, nil)
			err := RunLanList(cfg)
			assert.NoError(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Get(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Lan{Lan: l}, &testResponse, nil)
			err := RunLanGet(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunLanGet_Err(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Get(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Lan{Lan: l}, nil, testLanErr)
			err := RunLanGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLanCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Create(
				testLanVar, resources.LanPost{LanPost: lanPostTest}, testQueryParamOther,
...
func TestRunLanCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Create(
				testLanVar, resources.LanPost{LanPost: lanPostTest}, testQueryParamOther,
			).Return(&resources.LanPost{LanPost: lp}, nil, testLanErr)
			err := RunLanCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLanUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Update(
				testLanVar, testLanVar, lanProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&lanNew, &testResponse, nil)
...
func TestRunLanUpdateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Update(
				testLanVar, testLanVar, lanProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&lanNew, &testResponse, testLanErr)
			err := RunLanUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLanDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testLanVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Lan.EXPECT().Delete(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunLanDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().List(
				testLanVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(lansList, &testResponse, nil)
			rm.CloudApiV6Mocks.Lan.EXPECT().Delete(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Lan.EXPECT().Delete(
...
func TestRunLanDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().List(
				testLanVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(lansList, nil, testLanErr)
			err := RunLanDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLanDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Lan.EXPECT().Delete(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testLanErr)
			rm.CloudApiV6Mocks.Lan.EXPECT().Delete(
				testLanVar, testLanVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunLanDelete(cfg)
