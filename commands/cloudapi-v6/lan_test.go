...
func TestPreRunLansList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testLanVar)
...
func TestRunLanGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testLanVar)
...
func TestRunLanCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPccId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPublic), publicLan)
...
func TestRunLanCreateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPublic), publicLan)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPccId), testLanVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Create(testLanVar, resources.LanPost{Lan: lanPostTest}, testQueryParamOther).Return(&resources.LanPost{Lan: lp}, &testResponse, nil)
...
func TestRunLanUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testLanNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPublic), publicNewLan)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPccId), testLanNewVar)
