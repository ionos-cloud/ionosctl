...
func TestRunLanListAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testDatacenterVar, testListQueryParam).Return(lansList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunLanList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLanVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(ls, &testResponse, nil)
		err := RunLanList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLanListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLanVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(ls, nil, testLanErr)
		err := RunLanList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testLanVar, testLanVar, testQueryParamOther).Return(&resources.Lan{Lan: l}, &testResponse, nil)
		err := RunLanGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLanGet_Err(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testLanVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testLanVar, testLanVar, testQueryParamOther).Return(&resources.Lan{Lan: l}, nil, testLanErr)
		err := RunLanGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().Update(testLanVar, testLanVar, lanProperties, testQueryParamOther).Return(&lanNew, &testResponse, nil)
...
func TestRunLanUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPublic), publicNewLan)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testLanNewVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Update(testLanVar, testLanVar, lanProperties, testQueryParamOther).Return(&lanNew, nil, testLanErr)
		err := RunLanUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanUpdateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPublic), publicNewLan)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testLanNewVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Update(testLanVar, testLanVar, lanProperties, testQueryParamOther).Return(&lanNew, &testResponse, testLanErr)
		err := RunLanUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(&testResponse, nil)
...
func TestRunLanDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(lansList, &testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunLanDelete(cfg)
		assert.NoError(t, err)
...
func TestRunLanDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(lansList, nil, testLanErr)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(
...
func TestRunLanDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar, testListQueryParam).Return(lansList, &testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(&testResponse, testLanErr)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunLanDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(nil, testLanErr)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testLanVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar, testQueryParamOther).Return(nil, nil)
		err := RunLanDelete(cfg)
		assert.NoError(t, err)
	})
}
...
func TestGetLansCols(t *testing.T) {
	...
	getLansCols(core.GetGlobalFlagName("lan", config.ArgCols), core.GetFlagName("lan", cloudapiv6.ArgAll), w)
	err := w.Flush()
	assert.NoError(t, err)
}
