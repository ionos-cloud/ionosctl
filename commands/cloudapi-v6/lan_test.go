...
func TestRunLanListAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testDatacenterVar).Return(lansList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunLanListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar).Return(resources.Lans{}, &testResponse, nil)
		err := RunLanList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLanCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().Create(testLanVar, resources.LanPost{Lan: lanPostTest}).Return(&resources.LanPost{Lan: lp}, &testResponse, nil)
...
func TestRunLanDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar).Return(lansList, &testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, nil)
		err := RunLanDelete(cfg)
		assert.NoError(t, err)
...
func TestRunLanDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testLanVar).Return(lansList, &testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, testLanErr)
		rm.CloudApiV6Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, nil)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
