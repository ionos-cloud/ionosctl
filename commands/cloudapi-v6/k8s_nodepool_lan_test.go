...
func TestPreRunK8sClusterNodePoolLanIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testK8sNodePoolLanVar)
...
func TestRunK8sNodePoolLanList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testK8sNodePoolLanVar)
		viper.Set(core.GetGlobalFlagName(cfg.Resource, cloudapi_v6.ArgCols), defaultK8sNodePoolLanCols)
...
func TestRunK8sNodePoolLanAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testK8sNodePoolLanNewIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgNetwork), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgGatewayIp), testK8sNodePoolLanVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTest).Return(&k8sNodepoolLanTestUpdated, nil, nil)
...
func TestRunK8sNodePoolLanRemove(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testK8sNodePoolLanIntVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar).Return(&k8sNodepoolLanTest, nil, nil)
