...
func TestRunK8sNodePoolLanList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, &testResponse, nil)
...
func TestRunK8sNodePoolLanListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sClusterId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sNodePoolId), testK8sNodePoolLanVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, testK8sNodePoolLanErr)
		err := RunK8sNodePoolLanList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunK8sNodePoolLanListLansErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sClusterId), testK8sNodePoolLanVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sNodePoolId), testK8sNodePoolLanVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&resources.K8sNodePool{
			KubernetesNodePool: ionoscloud.KubernetesNodePool{
				Id:         &testK8sNodePoolLanVar,
				Properties: &ionoscloud.KubernetesNodePoolProperties{},
			},
...
func TestRunK8sNodePoolLanAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTest, testQueryParamOther).Return(&k8sNodepoolLanTestUpdated, &testResponse, nil)
...
func TestRunK8sNodePoolLanAddErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGatewayIp), testK8sNodePoolLanVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTest, testQueryParamOther).Return(&k8sNodepoolLanTestUpdated, nil, testK8sNodePoolLanErr)
		err := RunK8sNodePoolLanAdd(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunK8sNodePoolLanRemove(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTestRemove, testQueryParamOther).Return(&k8sNodepoolLanTestUpdatedRemove, &testResponse, nil)
...
func TestRunK8sNodePoolLanRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, &testResponse, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTestRemoveAll, testQueryParamOther).
...
func TestRunK8sNodePoolLanRemoveAsk(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testK8sNodePoolLanIntVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTestRemove, testQueryParamOther).Return(&k8sNodepoolLanTestUpdatedRemove, nil, nil)
		err := RunK8sNodePoolLanRemove(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunK8sNodePoolLanRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLanId), testK8sNodePoolLanIntVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, testQueryParamOther).Return(&k8sNodepoolLanTest, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(testK8sNodePoolLanVar, testK8sNodePoolLanVar, inputK8sNodepoolLanTestRemove, testQueryParamOther).Return(&k8sNodepoolLanTestUpdatedRemove, nil, testK8sNodePoolLanErr)
		err := RunK8sNodePoolLanRemove(cfg)
		assert.Error(t, err)
	})
}
