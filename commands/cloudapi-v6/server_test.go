...
func TestPreRunServerCreate(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCores), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgRam), testServerVar)
...
func TestPreRunServerCreateCube(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgType), testServerCubeType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgTemplateId), testServerVar)
		err := PreRunServerCreate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestPreRunServerCreateCubeImg(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgType), testServerCubeType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgTemplateId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgImageId), testServerVar)
		err := PreRunServerCreate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunServerCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCPUFamily), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgAvailabilityZone), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgType), testServerEnterpriseType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCores), cores)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgRam), strconv.Itoa(int(ram)))
...
func TestRunServerCreateCube(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgVolumeName), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgType), testServerCubeType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgBus), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgTemplateId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgAvailabilityZone), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLicenceType), testLicenceType)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
...
func TestRunServerCreateWaitState(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgType), testServerEnterpriseType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCores), cores)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgRam), ram)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForState), true)
		rm.CloudApiV6Mocks.Server.EXPECT().Create(testServerVar, serverCreate).Return(&resources.Server{Server: s}, nil, nil)
		rm.CloudApiV6Mocks.Server.EXPECT().Get(testServerVar, testServerVar).Return(&resources.Server{Server: s}, nil, nil)
...
func TestRunServerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgServerId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testServerNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCores), coresNew)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgRam), ramNew)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgAvailabilityZone), testServerNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCPUFamily), testServerNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgWaitForRequest), false)
