...
func TestRunServerListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().List(
				testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(ss, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunServerList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testServerVar)
			rm.CloudApiV6Mocks.Server.EXPECT().List(
				testServerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(ss, &testResponse, nil)
...
func TestRunServerListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().List(
				testServerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.Servers{}, &testResponse, nil)
			err := RunServerList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunServerGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			rm.CloudApiV6Mocks.Server.EXPECT().Get(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, &testResponse, nil)
...
func TestRunServerGetWait(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Get(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, nil, nil)
			rm.CloudApiV6Mocks.Server.EXPECT().Get(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, nil, nil)
			err := RunServerGet(cfg)
...
func TestRunServerGetWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Get(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, nil, testServerErr)
			err := RunServerGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunServerCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Create(
				testServerVar, serverCreate, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, &testResponse, nil)
...
func TestRunServerCreateCube(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Create(
				testServerVar, serverCubeCreate, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, nil, nil)
			err := RunServerCreate(cfg)
			assert.NoError(t, err)
		},
...
func TestRunServerCreateCubeImgAlias(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Create(
				testServerVar, serverCubeCreateImg, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Server{Server: s}, nil, nil)
			err := RunServerCreate(cfg)
			assert.NoError(t, err)
		},
...
func TestRunServerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Update(
				testServerVar, testServerVar, serverProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&serverNew, &testResponse, nil)
...
func TestRunServerUpdateWaitStateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Update(
				testServerVar, testServerVar, serverProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&serverNew, nil, nil)
			rm.CloudApiV6Mocks.Server.EXPECT().Get(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&serverNew, nil, testServerErr)
			err := RunServerUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunServerUpdateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Update(
				testServerVar, testServerVar, serverProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&serverNew, &testResponse, testServerErr)
			err := RunServerUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunServerDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Delete(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunServerDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().List(
				testServerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(ssList, &testResponse, nil)
			rm.CloudApiV6Mocks.Server.EXPECT().Delete(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Server.EXPECT().Delete(
...
func TestRunServerDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().List(
				testServerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(ssList, nil, testServerErr)
			err := RunServerDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunServerDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Server.EXPECT().Delete(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testServerErr)
			rm.CloudApiV6Mocks.Server.EXPECT().Delete(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunServerDelete(cfg)
...
func TestRunServerSuspend(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Suspend(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunServerStart(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Start(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunServerStop(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Stop(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunServerReboot(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			rm.CloudApiV6Mocks.Server.EXPECT().Reboot(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
...
func TestRunServerResume(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().Resume(
				testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
