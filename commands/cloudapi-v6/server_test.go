...
func TestPreRunServerCreateImageAlias(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCores), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagRam), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagImageAlias), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagSshKeyPaths), []string{testServerVar})
		err := PreRunServerCreate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestPreRunServerCreateCube(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagTemplateId), testServerVar)
		err := PreRunServerCreate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunServerCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testServerVar)
...
func TestRunServerCreateCube(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagVolumeName), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagType), testServerCubeType)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagBus), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagTemplateId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagAvailabilityZone), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLicenceType), testLicenceType)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForRequest), false)
...
func TestRunServerCreateCubeImgAlias(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagAvailabilityZone), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagImageAlias), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPassword), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForRequest), false)
...
func TestRunServerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testServerNewVar)
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagCdromId), testServerVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForRequest), false)
