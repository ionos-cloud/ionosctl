...
func TestRunIpConsumersList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(testIpConsumerVar, testQueryParamOther).Return(&resources.IpBlock{IpBlock: testIpConsumer}, &testResponse, nil)
...
func TestRunIpConsumersListPropertiesErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testIpConsumerVar)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(testIpConsumerVar, testQueryParamOther).Return(&resources.IpBlock{IpBlock: testIpConsumerProperties}, nil, nil)
		err := RunIpConsumersList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunIpConsumersListGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testIpConsumerVar)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(testIpConsumerVar, testQueryParamOther).Return(&resources.IpBlock{IpBlock: testIpConsumerGet}, nil, nil)
		err := RunIpConsumersList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunIpConsumersListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIpBlockId), testIpConsumerVar)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(testIpConsumerVar, testQueryParamOther).Return(&resources.IpBlock{IpBlock: testIpConsumer}, nil, testIpConsumerErr)
		err := RunIpConsumersList(cfg)
		assert.Error(t, err)
	})
}
