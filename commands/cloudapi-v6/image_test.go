...
func TestPreImageId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagImageId), testImageVar)
...
func TestRunImageList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagCols), allImageCols)
...
func TestRunImageListSort(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(constants.FlagQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLocation), testImageVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLicenceType), testImageVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagType), testImageVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLatest), 1)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagImageAlias), testImageVar)
...
func TestRunImageListSortOptionErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagType), testImageVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLatest), 1)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagImageAlias), "no alias")
		rm.CloudApiV6Mocks.Image.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(testImages, nil, nil)
		err := RunImageList(cfg)
		assert.NoError(t, err)
	})
