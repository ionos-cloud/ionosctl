...
func TestRunImageList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Image.EXPECT().List(testListQueryParam).Return(testImages, &testResponse, nil)
...
func TestRunImageListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(config.ArgQuiet, false)
		rm.CloudApiV6Mocks.Image.EXPECT().List(testListQueryParam).Return(testImages, nil, testImageErr)
		err := RunImageList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunImageListSort(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Image.EXPECT().List(testListQueryParam).Return(testImages, nil, nil)
		err := RunImageList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunImageGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgImageId), testImageVar)
		rm.CloudApiV6Mocks.Image.EXPECT().Get(testImageVar, testQueryParamOther).Return(&testImage, &testResponse, nil)
		err := RunImageGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunImageGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgImageId), testImageVar)
		rm.CloudApiV6Mocks.Image.EXPECT().Get(testImageVar, testQueryParamOther).Return(&testImage, nil, testImageErr)
		err := RunImageGet(cfg)
		assert.Error(t, err)
	})
}
