...
func TestRunLoadBalancerListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(lbList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunLoadBalancerList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLoadbalancerVar)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				testLoadbalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(loadbs, &testResponse, nil)
...
func TestRunLoadBalancerListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				testLoadbalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.Loadbalancers{}, &testResponse, nil)
			err := RunLoadBalancerList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunLoadBalancerListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				testLoadbalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(loadbs, nil, testLoadbalancerErr)
			err := RunLoadBalancerList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLoadBalancerGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testLoadbalancerVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLoadBalancerId), testLoadbalancerVar)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Get(
				testLoadbalancerVar, testLoadbalancerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Loadbalancer{Loadbalancer: loadb}, &testResponse, nil)
...
func TestRunLoadBalancerGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Get(
				testLoadbalancerVar, testLoadbalancerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Loadbalancer{Loadbalancer: loadb}, nil, testLoadbalancerErr)
			err := RunLoadBalancerGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLoadBalancerCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Create(
				testLoadbalancerVar, testLoadbalancerVar, dhcpLoadbalancer,
...
func TestRunLoadBalancerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Update(
				testLoadbalancerVar, testLoadbalancerVar, loadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&loadbalancerNew, &testResponse, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Update(
				testLoadbalancerVar, testLoadbalancerVar, loadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&loadbalancerNew, nil, testLoadbalancerErr)
			err := RunLoadBalancerUpdate(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Update(
				testLoadbalancerVar, testLoadbalancerVar, loadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&loadbalancerNew, &testResponse, testLoadbalancerErr)
			err := RunLoadBalancerUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunLoadBalancerDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgLoadBalancerId), testLoadbalancerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Delete(
				testLoadbalancerVar, testLoadbalancerVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunLoadBalancerDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				testLoadbalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(lbList, &testResponse, nil)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Delete(
				testLoadbalancerVar, testLoadbalancerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Delete(
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().List(
				...
				resources.Loadbalancers{Loadbalancers: ionoscloud.Loadbalancers{Items: &[]ionoscloud.Loadbalancer{}}},
				&testResponse, nil,
			)
			err := RunLoadBalancerDelete(cfg)
			assert.Error(t, err)
...
func TestRunLoadBalancerDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Loadbalancer.EXPECT().Delete(
				testLoadbalancerVar, testLoadbalancerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(nil, testLoadbalancerErr)
			err := RunLoadBalancerDelete(cfg)
			assert.Error(t, err)
		},
	)
