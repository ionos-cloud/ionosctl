...
func TestRunDataCenterListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.Datacenters{}, &testResponse, nil,
			)
			err := RunDataCenterList(cfg)
			assert.NoError(t, err)
		},
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Get(
				testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&res, &testResponse, nil)
...
func TestRunDataCenterGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Get(
				testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&res, nil, testDatacenterErr)
			err := RunDataCenterGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDataCenterCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Create(
				testDatacenterVar, testDatacenterVar, testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Datacenter{dc}, &testResponse, nil)
...
func TestRunDataCenterCreateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Create(
				testDatacenterVar, testDatacenterVar, testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Datacenter{Datacenter: dc}, &testResponse, nil)
...
func TestRunDataCenterCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Create(
				testDatacenterVar, testDatacenterVar, testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Datacenter{Datacenter: dc}, nil, testDatacenterErr)
			err := RunDataCenterCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDataCenterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Update(
				testDatacenterVar, dcProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&dcNew, &testResponse, nil)
...
func TestRunDataCenterUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Update(
				testDatacenterVar, dcProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&dcNew, nil, testDatacenterErr)
			err := RunDataCenterUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDataCenterUpdateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Update(
				testDatacenterVar, dcProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&dcNew, &testResponse, testDatacenterErr)
			err := RunDataCenterUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunDataCenterDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testDatacenterVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Delete(
				testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunDataCenterDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
			rm.CloudApiV6Mocks.Datacenter.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.Datacenters{Datacenters: ionoscloud.Datacenters{Items: &[]ionoscloud.Datacenter{}}},
				&testResponse, nil,
			)
			err := RunDataCenterDelete(cfg)
			assert.Error(t, err)
...
func TestRunDataCenterDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Delete(
				testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testDatacenterErr)
			rm.CloudApiV6Mocks.Datacenter.EXPECT().Delete(
				testDatacenterVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunDataCenterDelete(cfg)
