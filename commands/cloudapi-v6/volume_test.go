...
func TestRunVolumeListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().List(
				testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(vsList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunVolumeList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testVolumeVar)
			rm.CloudApiV6Mocks.Volume.EXPECT().List(
				testVolumeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(vs, &testResponse, nil)
...
func TestRunVolumeListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().List(
				testVolumeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.Volumes{}, &testResponse, nil)
			err := RunVolumeList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunVolumeGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testVolumeVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgVolumeId), testVolumeVar)
			rm.CloudApiV6Mocks.Volume.EXPECT().Get(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Volume{Volume: v}, &testResponse, nil)
...
func TestRunVolumeGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().Get(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Volume{Volume: v}, nil, testVolumeErr)
			err := RunVolumeGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunVolumeCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().Create(
				testVolumeVar, testVolume, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Volume{Volume: v}, &testResponse, nil)
...
func TestRunVolumeCreateImg(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Volume.EXPECT().Create(
				testVolumeVar, testVolumeImg, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Volume{Volume: v}, nil, nil)
			err := RunVolumeCreate(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunVolumeUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDiscVirtioHotUnplug), testVolumeBoolVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Volume.EXPECT().Update(
				testVolumeVar, testVolumeVar, volumeProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&volumeNew, &testResponse, nil)
...
func TestRunVolumeUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().Update(
				testVolumeVar, testVolumeVar, volumeProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&volumeNew, nil, testVolumeErr)
			err := RunVolumeUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunVolumeDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgVolumeId), testVolumeVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Volume.EXPECT().Delete(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunVolumeDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().List(
				testVolumeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(vsList, &testResponse, nil)
			rm.CloudApiV6Mocks.Volume.EXPECT().Delete(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Volume.EXPECT().Delete(
...
func TestRunVolumeDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().List(
				testVolumeVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(vsList, nil, testVolumeErr)
			err := RunVolumeDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunVolumeDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Volume.EXPECT().Delete(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testVolumeErr)
			rm.CloudApiV6Mocks.Volume.EXPECT().Delete(
				testVolumeVar, testVolumeVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunVolumeDelete(cfg)
...
func TestRunServerVolumeAttach(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testServerVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.Server.EXPECT().AttachVolume(
				testServerVar, testServerVar, testServerVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.Volume{Volume: v}, nil, nil)
					...
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
							rm.CloudApiV6Mocks.Server.EXPECT().ListVolumes(
								gomock.AssignableToTypeOf(testResourceVar), gomock.AssignableToTypeOf(testResourceVar),
								gomock.AssignableToTypeOf(testListQueryParam),
							).Return(vsAttached, nil, nil),
						)
					},
					ExpectedErr: false,
				},
					...
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
							rm.CloudApiV6Mocks.Server.EXPECT().ListVolumes(
								gomock.AssignableToTypeOf(testResourceVar), gomock.AssignableToTypeOf(testResourceVar),
								gomock.AssignableToTypeOf(testListQueryParam),
							).Return(vsAttached, nil, testVolumeErr),
						)
					},
					ExpectedErr: true,
				},
			...
			var tests = []core.TestCase{
				{
					...
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
							rm.CloudApiV6Mocks.Server.EXPECT().GetVolume(
								testServerVar, testServerVar, testServerVar,
			...
			var tests = []core.TestCase{
				{
					...
					Args: []core.FlagValuePair{
						...
						{core.GetFlagName(cfg.NS, constants.ArgForce), true},
					},
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
				...
				},
				{
					...
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
							rm.CloudApiV6Mocks.Server.EXPECT().ListVolumes(
								testServerVar, testServerVar, cloudapiv6.ParentResourceListQueryParams,
							).Return(vsAttachedList, nil, nil),
							rm.CloudApiV6Mocks.Server.EXPECT().DetachVolume(
								testServerVar, testServerVar, testServerVar,
								gomock.AssignableToTypeOf(testQueryParamOther),
							).Return(&testResponse, nil),
				...
				},
				{
					...
					Args: []core.FlagValuePair{
						...
						{core.GetFlagName(cfg.NS, cloudapiv6.ArgVolumeId), testServerVar},
						{core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false},
						{core.GetFlagName(cfg.NS, constants.ArgForce), false},
					},
					Calls: func(...*gomock.Call) {
						gomock.InOrder(
							rm.CloudApiV6Mocks.Server.EXPECT().DetachVolume(
