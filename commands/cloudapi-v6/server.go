...
* Server Id`,
	...
	suspend.AddBoolFlag(constants.ArgForce, constants.ArgForceShort, false, constants.DescForce)
...
* Server Id`,
	...
	start.AddBoolFlag(constants.ArgForce, constants.ArgForceShort, false, constants.DescForce)
...
* Server Id`,
	...
	stop.AddBoolFlag(constants.ArgForce, constants.ArgForceShort, false, constants.DescForce)
...
* Server Id`,
	...
	reboot.AddBoolFlag(constants.ArgForce, constants.ArgForceShort, false, constants.DescForce)
...
* Server Id`,
	...
	resume.AddBoolFlag(constants.ArgForce, constants.ArgForceShort, false, constants.DescForce)
...
func RunServerDelete(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "delete server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
...
func RunServerStart(c *core.CommandConfig) error {
	...
	queryParams := listQueryParams.QueryParams
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "start server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
		return fmt.Errorf(confirm.UserDenied)
	}
...
func RunServerStop(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "stop server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
		return fmt.Errorf(confirm.UserDenied)
	}
...
func RunServerSuspend(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "suspend cube server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
		return fmt.Errorf(confirm.UserDenied)
	}
...
func RunServerReboot(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "reboot server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
		return fmt.Errorf(confirm.UserDenied)
	}
...
func RunServerResume(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "resume cube server", viper.GetBool(core.GetFlagName(c.NS, constants.ArgForce)),
	) {
		return fmt.Errorf(confirm.UserDenied)
	}
...
func getUpdateServerInfo(c *core.CommandConfig) (*resources.ServerProperties, error) {
	...
	if viper.IsSet(core.GetFlagName(c.NS, cloudapiv6.ArgCdromId)) {
		...
		fmt.Fprintf(
			c.Command.Command.ErrOrStderr(), jsontabwriter.GenerateVerboseOutput("Property BootCdrom set: %v ", cdromId),
		)
	}
	...
	if viper.IsSet(core.GetFlagName(c.NS, constants.FlagRam)) {
		...
		fmt.Fprintf(
			c.Command.Command.ErrOrStderr(), jsontabwriter.GenerateVerboseOutput("Property Ram set: %vMB ", int32(size)),
		)
	}
...
func DeleteAllServers(c *core.CommandConfig) error {
	...
	if !confirm.FAsk(
		c.Command.Command.InOrStdin(), "delete all the Servers",
