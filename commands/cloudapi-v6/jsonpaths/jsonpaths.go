...
var ApplicationLoadBalancer = map[string]string{
...
var ApplicationLoadBalancerForwardingRule = map[string]string{
	"ForwardingRuleId":   "id",
	"Name":               "properties.name",
...
var ApplicationLoadBalancerHTTPRule = map[string]string{
	"Name":            "name",
	"Type":            "type",
...
var BackupUnit = map[string]string{
	"BackupUnitId": "id",
	"Name":         "properties.name",
...
var BackupUnitSSOUrl = map[string]string{
	"BackupUnitSsoUrl": "ssoUrl",
}

var Console = map[string]string{
...
var FirewallRule = map[string]string{
	"FirewallRuleId": "id",
	"Name":           "properties.name",
	"Protocol":       "properties.protocol",
...
var IpConsumer = map[string]string{
	"Ip":             "ip",
	"Mac":            "mac",
	"NicId":          "nicId",
	"ServerId":       "serverId",
...
var IpFailover = map[string]string{
	"NicId": "nicUuid",
	"Ip":    "ip",
}

var K8sCluster = map[string]string{
	"ClusterId":                "id",
	"Name":                     "properties.name",
...
var K8sNodepool = map[string]string{
	"NodePoolId":               "id",
	"Name":                     "properties.name",
	"K8sVersion":               "properties.k8sVersion",
...
var K8sNodePoolLan = map[string]string{
	"LanId":           "id",
	"Dhcp":            "dhcp",
...
var LoadBalancer = map[string]string{
	"LoadBalancerId": "id",
	"Name":           "properties.name",
...
var NatGateway = map[string]string{
	"NatGatewayId": "id",
	"Name":         "properties.name",
	"PublicIps":    "properties.publicIps",
	"State":        "metadata.state",
...
var NatGatewayLan = map[string]string{
	"NatGatewayLanId": "id",
	"GatewayIps":      "gatewayIps",
}

var NatGatewayRule = map[string]string{
	"NatGatewayRuleId":     "id",
	"Name":                 "properties.name",
...
var NetworkLoadBalancer = map[string]string{
...
var NetworkLoadBalancerRule = map[string]string{
	"ForwardingRuleId": "id",
	"Name":             "properties.name",
...
var NetworkLoadBalancerRuleTarget = map[string]string{
	"TargetIp":      "ip",
	"TargetPort":    "port",
	"Weight":        "weight",
...
var TargetGroup = map[string]string{
	"TargetGroupId": "id",
	"Name":          "properties.name",
	"Algorithm":     "properties.algorithm",
	"Protocol":      "properties.protocol",
...
var TargetGroupTarget = map[string]string{
	"TargetIp":           "ip",
	"TargetPort":         "port",
	"Weight":             "weight",
