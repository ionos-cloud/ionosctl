...
func TestRunK8sNodePoolGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(constants.FlagVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
...
func TestRunK8sNodePoolCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNodepoolVar)
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sVersion), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanIds), []int{int(testNodepoolIntVar)})
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDhcp), testK8sNodePoolLanBoolVar)
...
func TestRunK8sNodePoolUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanIds), []int{int(testNodepoolIntNewVar)})
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDhcp), testK8sNodePoolLanBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPublicIps), []string{testNodepoolNewVar, testNodepoolNewVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&nodepoolTestGet, nil, nil)
...
func TestRunK8sNodePoolUpdateGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgK8sMaxNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDhcp), testK8sNodePoolLanBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPublicIps), []string{testNodepoolNewVar, testNodepoolNewVar})
