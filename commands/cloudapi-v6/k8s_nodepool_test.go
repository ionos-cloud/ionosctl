...
func TestPreRunK8sClusterNodePoolIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testNodepoolVar)
...
func TestPreRunK8sClusterDcIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testNodepoolVar)
...
func TestRunK8sNodePoolList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(testNodepoolVar).Return(nodepools, nil, nil)
...
func TestRunK8sNodePoolCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodeCount), testNodepoolIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCpuFamily), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgAvailabilityZone), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgRam), testNodepoolIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgStorageType), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgStorageSize), testNodepoolIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgCores), testNodepoolIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDataCenterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sVersion), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanIds), []int{int(testNodepoolIntVar)})
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDhcp), testK8sNodePoolLanBoolVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().CreateNodePool(testNodepoolVar, nodepoolTestPost).Return(&nodepoolTest, nil, nil)
...
func TestRunK8sNodePoolUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sVersion), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaintenanceDay), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaintenanceTime), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sAnnotationKey), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sAnnotationValue), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLabelValue), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLabelKey), testNodepoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMinNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaxNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanIds), []int{int(testNodepoolIntNewVar)})
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDhcp), testK8sNodePoolLanBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgPublicIps), []string{testNodepoolNewVar, testNodepoolNewVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(testNodepoolVar, testNodepoolVar).Return(&nodepoolTestGet, nil, nil)
...
func TestRunK8sNodePoolUpdateGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaxNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodeCount), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLanId), testNodepoolIntNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgDhcp), testK8sNodePoolLanBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sNodePoolId), testNodepoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgPublicIps), []string{testNodepoolNewVar, testNodepoolNewVar})
