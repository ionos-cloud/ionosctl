...
func TestRunK8sNodePoolListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testClusterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodepoolsList, &testResponse, nil).Times(len(getK8sClusters(clustersList)))
...
func TestRunK8sNodePoolList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testNodepoolVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodepools, &testResponse, nil)
...
func TestRunK8sNodePoolListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testNodepoolVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.K8sNodePools{}, &testResponse, nil)
			err := RunK8sNodePoolList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunK8sNodePoolListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testNodepoolVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodepools, nil, testNodepoolErr)
			err := RunK8sNodePoolList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, &testResponse, nil)
...
func TestRunK8sNodePoolGetWait(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, nil, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, nil, nil)
			err := RunK8sNodePoolGet(cfg)
...
func TestRunK8sNodePoolGetWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, nil, testNodepoolErr)
			err := RunK8sNodePoolGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().CreateNodePool(
				testNodepoolVar, nodepoolTestPost, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTest, &testResponse, nil)
...
func TestRunK8sNodePoolPrivateCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().CreateNodePool(
				testNodepoolVar, nodepoolTestPrivatePost, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestPrivate, &testResponse, nil)
			err := RunK8sNodePoolCreate(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunK8sNodePoolCreateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestId, nil, testNodepoolErr)
			err := RunK8sNodePoolCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().CreateNodePool(
				testNodepoolVar, nodepoolTestPost, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTest, nil, testNodepoolErr)
			err := RunK8sNodePoolCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
			viper.Set(
				core.GetFlagName(cfg.NS, cloudapiv6.ArgPublicIps), []string{testNodepoolNewVar, testNodepoolNewVar},
			)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, nil, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(
				testNodepoolVar, testNodepoolVar, nodepoolTestUpdateNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestNew, &testResponse, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGetNew, nil, nil)
...
func TestRunK8sNodePoolUpdateWait(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(
				testNodepoolVar, testNodepoolVar, nodepoolTestUpdateNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestNew, nil, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGetNew, nil, nil)
			err := RunK8sNodePoolUpdate(cfg)
...
func TestRunK8sNodePoolUpdateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGetNew, nil, testNodepoolErr)
			err := RunK8sNodePoolUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolUpdateOldUser(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(
				testNodepoolVar, testNodepoolVar, nodepoolTestUpdateOld, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestOld, nil, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().GetNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestGet, nil, nil)
			err := RunK8sNodePoolUpdate(cfg)
...
func TestRunK8sNodePoolUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().UpdateNodePool(
				testNodepoolVar, testNodepoolVar, nodepoolTestUpdateNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&nodepoolTestNew, nil, testNodepoolErr)
			err := RunK8sNodePoolUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunK8sNodePoolDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagNodepoolId), testNodepoolVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testNodepoolVar)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunK8sNodePoolDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testNodepoolVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodepoolsList, &testResponse, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNodePool(
...
func TestRunK8sNodePoolDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				testNodepoolVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(nodepoolsList, nil, testNodepoolErr)
			err := RunK8sNodePoolDelete(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().ListNodePools(
				...
				resources.K8sNodePools{KubernetesNodePools: ionoscloud.KubernetesNodePools{Items: &[]ionoscloud.KubernetesNodePool{}}},
				&testResponse, nil,
			)
			err := RunK8sNodePoolDelete(cfg)
			assert.Error(t, err)
...
func TestRunK8sNodePoolDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testNodepoolErr)
			rm.CloudApiV6Mocks.K8s.EXPECT().DeleteNodePool(
				testNodepoolVar, testNodepoolVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunK8sNodePoolDelete(cfg)
