	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				groupsList, &testResponse, nil,
			)
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testGroupVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(sharesList, &testResponse, nil).Times(len(getGroups(groupsList)))
...
func TestRunShareList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testShareVar)
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testShareVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(shares, &testResponse, nil)
...
func TestRunShareListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testShareVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(shares, nil, testShareErr)
			err := RunShareList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testShareVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgResourceId), testShareVar)
			rm.CloudApiV6Mocks.Group.EXPECT().GetShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTestGet, &testResponse, nil)
			err := RunShareGet(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunShareGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().GetShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTestGet, nil, testShareErr)
			err := RunShareGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testShareVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgResourceId), testShareVar)
			rm.CloudApiV6Mocks.Group.EXPECT().AddShare(
				testShareVar, testShareVar, shareTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTest, &testResponse, nil)
...
func TestRunShareCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().AddShare(
				testShareVar, testShareVar, shareTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTest, &testResponse, testShareErr)
			err := RunShareCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().AddShare(
				testShareVar, testShareVar, shareTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTest, nil, testShareErr)
			err := RunShareCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().GetShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareTest, nil, nil)
			rm.CloudApiV6Mocks.Group.EXPECT().UpdateShare(
				testShareVar, testShareVar, shareNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareNew, &testResponse, nil)
...
func TestRunShareUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().UpdateShare(
				testShareVar, testShareVar, shareNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&shareNew, nil, testShareErr)
			err := RunShareUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testShareVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgResourceId), testShareVar)
			rm.CloudApiV6Mocks.Group.EXPECT().RemoveShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunShareDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testShareVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(sharesList, &testResponse, nil)
			rm.CloudApiV6Mocks.Group.EXPECT().RemoveShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.Group.EXPECT().RemoveShare(
...
func TestRunShareDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testShareVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(sharesList, nil, testShareErr)
			err := RunShareDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunShareDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				testShareVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.GroupShares{}, &testResponse, nil)
			err := RunShareDelete(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().ListShares(
				...
				resources.GroupShares{GroupShares: ionoscloud.GroupShares{Items: &[]ionoscloud.GroupShare{}}},
				&testResponse, nil,
			)
			err := RunShareDelete(cfg)
			assert.Error(t, err)
...
func TestRunShareDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().RemoveShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testShareErr)
			rm.CloudApiV6Mocks.Group.EXPECT().RemoveShare(
				testShareVar, testShareVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunShareDelete(cfg)
