...
func TestPreRunGroupResourceIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagGroupId), testShareVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagResourceId), testShareVar)
...
func TestRunShareUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagGroupId), testShareVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagResourceId), testShareVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagEditPrivilege), testShareBoolNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagSharePrivilege), testShareBoolNewVar)
