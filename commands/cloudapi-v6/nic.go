...
* NIC Id`,
	...
	_ = attachNic.Command.RegisterFlagCompletionFunc(
		...
		func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
			return completer.ServersIds(
				os.Stderr, viper.GetString(core.GetFlagName(attachNic.NS, cloudapiv6.ArgDataCenterId)),
			), cobra.ShellCompDirectiveNoFileComp
		},
	)
	...
	*/
	...
	_ = listNics.Command.RegisterFlagCompletionFunc(
		...
		func(cmd *cobra.Command, ags []string, toComplete string) ([]string, cobra.ShellCompDirective) {
			return completer.LoadbalancersIds(
				os.Stderr, viper.GetString(core.GetFlagName(listNics.NS, cloudapiv6.ArgDataCenterId)),
			), cobra.ShellCompDirectiveNoFileComp
		},
	)
	...
	*/
	...
	_ = getNicCmd.Command.RegisterFlagCompletionFunc(
		...
		func(cmd *cobra.Command, ags []string, toComplete string) ([]string, cobra.ShellCompDirective) {
			return completer.LoadbalancersIds(
				os.Stderr, viper.GetString(core.GetFlagName(getNicCmd.NS, cloudapiv6.ArgDataCenterId)),
			), cobra.ShellCompDirectiveNoFileComp
		},
	)
...
* NIC Id`,
	...
	_ = detachNic.Command.RegisterFlagCompletionFunc(
		...
		func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
			return completer.AttachedNicsIds(
				os.Stderr, viper.GetString(core.GetFlagName(detachNic.NS, cloudapiv6.ArgDataCenterId)),
...
var (
	...
	allNicCols     = []string{
		"NicId", "Name", "Dhcp", "LanId", "Ips", "State", "FirewallActive", "FirewallType", "DeviceNumber", "PciSlot",
		"Mac",
	}
)
	...
	if c != nil {
		...
		if nics != nil {
			...
			r.Columns = printer.GetHeaders(
				allNicCols, defaultNicCols, viper.GetStringSlice(core.GetFlagName(c.Resource, constants.ArgCols)),
			)
		}
	}
	return r
