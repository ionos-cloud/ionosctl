...
func TestRunPccGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccTestGet, &testResponse, nil)
		err := RunPccGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccTestGet, nil, testPccErr)
		err := RunPccGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, resources.QueryParams{}).Return(&pccTest, &testResponse, nil)
...
func TestRunPccCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, resources.QueryParams{}).Return(&pccTest, &testResponse, testPccErr)
		err := RunPccCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, resources.QueryParams{}).Return(&pccTest, nil, testPccErr)
		err := RunPccCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccTest, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, resources.QueryParams{}).Return(&pccNew, &testResponse, nil)
...
func TestRunPccUpdateOldUser(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccNew, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, resources.QueryParams{}).Return(&pccNew, nil, nil)
		err := RunPccUpdate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccNewVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccTest, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, resources.QueryParams{}).Return(&pccNew, nil, testPccErr)
		err := RunPccUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccUpdateGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, resources.QueryParams{}).Return(&pccTest, nil, testPccErr)
		err := RunPccUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, resources.QueryParams{}).Return(&testResponse, nil)
...
func TestRunPccDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(resources.ListQueryParams{}).Return(pccsList, nil, testPccErr)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(resources.ListQueryParams{}).Return(resources.PrivateCrossConnects{}, &testResponse, nil)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(resources.ListQueryParams{}).Return(
...
func TestRunPccDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(resources.ListQueryParams{}).Return(pccsList, &testResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, resources.QueryParams{}).Return(&testResponse, testPccErr)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, resources.QueryParams{}).Return(&testResponse, nil)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunPccDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, resources.QueryParams{}).Return(nil, testPccErr)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, resources.QueryParams{}).Return(nil, nil)
		err := RunPccDelete(cfg)
		assert.NoError(t, err)
	})
}
