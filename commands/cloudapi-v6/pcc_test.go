...
func TestPreRunPccId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagQuiet, false)
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPccId), testPccVar)
		err := PreRunPccId(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagVerbose, false)
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDescription), testPccVar)
...
func TestRunPccUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPccId), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testPccNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDescription), testPccNewVar)
