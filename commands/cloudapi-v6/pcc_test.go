...
func TestRunPccListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.PrivateCrossConnects{}, &testResponse, nil,
			)
			err := RunPccList(cfg)
			assert.NoError(t, err)
		},
...
func TestRunPccGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
			rm.CloudApiV6Mocks.Pcc.EXPECT().Get(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccTestGet, &testResponse, nil)
			err := RunPccGet(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunPccGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().Get(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccTestGet, nil, testPccErr)
			err := RunPccGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunPccPeersList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
			rm.CloudApiV6Mocks.Pcc.EXPECT().GetPeers(testPccVar).Return(
				&[]resources.Peer{pccPeerTest}, &testResponse, nil,
			)
...
func TestRunPccCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().Create(
				pccTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccTest, &testResponse, nil)
...
func TestRunPccCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().Create(
				pccTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccTest, &testResponse, testPccErr)
			err := RunPccCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunPccUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().Get(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccTest, nil, nil)
			rm.CloudApiV6Mocks.Pcc.EXPECT().Update(
				testPccVar, pccProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&pccNew, &testResponse, nil)
...
func TestRunPccDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
			rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunPccDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
			rm.CloudApiV6Mocks.Pcc.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.PrivateCrossConnects{PrivateCrossConnects: ionoscloud.PrivateCrossConnects{Items: &[]ionoscloud.PrivateCrossConnect{}}},
				&testResponse, nil,
			)
			err := RunPccDelete(cfg)
			assert.Error(t, err)
...
func TestRunPccDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testPccErr)
			rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(
				testPccVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunPccDelete(cfg)
