...
func TestRunPccListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(testListQueryParam).Return(pccs, nil, testPccErr)
		err := RunPccList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccTestGet, &testResponse, nil)
		err := RunPccGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccTestGet, nil, testPccErr)
		err := RunPccGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, testQueryParamOther).Return(&pccTest, &testResponse, nil)
...
func TestRunPccCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, testQueryParamOther).Return(&pccTest, &testResponse, testPccErr)
		err := RunPccCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest, testQueryParamOther).Return(&pccTest, nil, testPccErr)
		err := RunPccCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccTest, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, testQueryParamOther).Return(&pccNew, &testResponse, nil)
...
func TestRunPccUpdateOldUser(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccNew, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, testQueryParamOther).Return(&pccNew, nil, nil)
		err := RunPccUpdate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccNewVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccTest, nil, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Update(testPccVar, pccProperties, testQueryParamOther).Return(&pccNew, nil, testPccErr)
		err := RunPccUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccUpdateGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testPccVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDescription), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar, testQueryParamOther).Return(&pccTest, nil, testPccErr)
		err := RunPccUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(&testResponse, nil)
...
func TestRunPccDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(testListQueryParam).Return(pccsList, &testResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunPccDelete(cfg)
		assert.NoError(t, err)
...
func TestRunPccDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(testListQueryParam).Return(pccsList, nil, testPccErr)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(testListQueryParam).Return(
...
func TestRunPccDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List(testListQueryParam).Return(pccsList, &testResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(&testResponse, testPccErr)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunPccDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPccId), testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(nil, testPccErr)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar, testQueryParamOther).Return(nil, nil)
		err := RunPccDelete(cfg)
		assert.NoError(t, err)
	})
}
