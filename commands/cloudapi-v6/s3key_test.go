...
func TestRunUserS3KeyList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testS3keyVar)
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			rm.CloudApiV6Mocks.S3Key.EXPECT().List(
				testS3keyVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(s3keys, &testResponse, nil)
...
func TestRunUserS3KeyListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().List(
				testS3keyVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(s3keys, nil, testS3keyErr)
			err := RunUserS3KeyList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testS3keyVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgS3KeyId), testS3keyVar)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Get(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyTestGet, &testResponse, nil)
...
func TestRunUserS3KeyGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Get(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyTestGet, nil, testS3keyErr)
			err := RunUserS3KeyGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testS3keyVar)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Create(
				testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyTest, &testResponse, nil)
...
func TestRunUserS3KeyCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Create(
				testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyTest, &testResponse, testS3keyErr)
			err := RunUserS3KeyCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Create(
				testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyTest, nil, testS3keyErr)
			err := RunUserS3KeyCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Update(
				testS3keyVar, testS3keyVar, s3keyNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyNew, &testResponse, nil)
...
func TestRunUserS3KeyUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Update(
				testS3keyVar, testS3keyVar, s3keyNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&s3keyNew, nil, testS3keyErr)
			err := RunUserS3KeyUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testS3keyVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgS3KeyId), testS3keyVar)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Delete(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunUserS3KeyDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().List(
				testS3keyVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(s3keysList, &testResponse, nil)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Delete(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Delete(
...
func TestRunUserS3KeyDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().List(
				testS3keyVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(s3keysList, nil, testS3keyErr)
			err := RunUserS3KeyDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().List(
				testS3keyVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.S3Keys{}, &testResponse, nil)
			err := RunUserS3KeyDelete(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunUserS3KeyDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.S3Key.EXPECT().Delete(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testS3keyErr)
			rm.CloudApiV6Mocks.S3Key.EXPECT().Delete(
				testS3keyVar, testS3keyVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunUserS3KeyDelete(cfg)
