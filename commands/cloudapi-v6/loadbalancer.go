...
func getLoadbalancerPrint(
	resp *resources.Response, c *core.CommandConfig, lbs []resources.Loadbalancer,
) printer.Result {
	r := printer.Result{}
	if c != nil {
		if resp != nil {
		...
		if lbs != nil {
			...
			r.Columns = printer.GetHeadersListAll(
				allLoadbalancerCols, defaultLoadbalancerCols, "DatacenterId",
