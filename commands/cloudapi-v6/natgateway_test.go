...
func TestPreRunNATGatewayList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
...
func TestPreRunDcIdsNatGatewayProperties(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), testNatGatewayVar)
...
func TestPreRunDcNatGatewayIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
...
func TestRunNatGatewayListAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgatewaysList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunNatGatewayList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.Resource, constants.FlagCols), defaultNatGatewayCols)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgateways, &testResponse, nil)
...
func TestRunNatGatewayListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(resources.NatGateways{}, &testResponse, nil)
		err := RunNatGatewayList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunNatGatewayListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgateways, nil, testNatGatewayErr)
		err := RunNatGatewayList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTestGet, &testResponse, nil)
...
func TestRunNatGatewayGetWait(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTestGet, nil, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTestGet, nil, nil)
		err := RunNatGatewayGet(cfg)
		assert.NoError(t, err)
	})
...
func TestRunNatGatewayGetWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForState), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTestGet, nil, testNatGatewayErr)
		err := RunNatGatewayGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), []string{testNatGatewayVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTest, &testResponse, nil)
...
func TestRunNatGatewayCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), []string{testNatGatewayVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTest, &testResponse, testNatGatewayErr)
		err := RunNatGatewayCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), []string{testNatGatewayVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayTest, nil, testNatGatewayErr)
		err := RunNatGatewayCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNatGatewayNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), testNatGatewayNewVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(testNatGatewayVar, testNatGatewayVar, natgatewayProperties, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayNew, &testResponse, nil)
...
func TestRunNatGatewayUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNatGatewayNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), []string{testNatGatewayNewVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(testNatGatewayVar, testNatGatewayVar, natgatewayProperties, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&natgatewayNew, nil, testNatGatewayErr)
		err := RunNatGatewayUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testResponse, nil)
...
func TestRunNatGatewayDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgatewaysList, &testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testResponse, nil)
		err := RunNatGatewayDelete(cfg)
		assert.NoError(t, err)
...
func TestRunNatGatewayDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgatewaysList, nil, testNatGatewayErr)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgatewaysList, &testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testResponse, testNatGatewayErr)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testResponse, nil)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunNatGatewayDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(nil, testNatGatewayErr)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(nil, nil)
		err := RunNatGatewayDelete(cfg)
		assert.NoError(t, err)
	})
}
