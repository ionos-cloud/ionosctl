...
func TestRunNatGatewayListAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testDatacenterVar, testListQueryParam).Return(natgatewaysList, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunNatGatewayList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, testListQueryParam).Return(natgateways, &testResponse, nil)
...
func TestRunNatGatewayListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, testListQueryParam).Return(natgateways, nil, testNatGatewayErr)
		err := RunNatGatewayList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, testListQueryParam).Return(natgatewaysList, &testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunNatGatewayDelete(cfg)
		assert.NoError(t, err)
...
func TestRunNatGatewayDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, testListQueryParam).Return(natgatewaysList, nil, testNatGatewayErr)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, testListQueryParam).Return(
