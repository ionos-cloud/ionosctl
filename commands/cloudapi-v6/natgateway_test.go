...
func TestRunNatGatewayGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&natgatewayTestGet, &testResponse, nil)
...
func TestRunNatGatewayGetWait(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&natgatewayTestGet, nil, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&natgatewayTestGet, nil, nil)
		err := RunNatGatewayGet(cfg)
		assert.NoError(t, err)
	})
...
func TestRunNatGatewayGetWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNatGatewayId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForState), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Get(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&natgatewayTestGet, nil, testNatGatewayErr)
		err := RunNatGatewayGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, testQueryParamOther).Return(&natgatewayTest, &testResponse, nil)
...
func TestRunNatGatewayCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIps), []string{testNatGatewayVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, testQueryParamOther).Return(&natgatewayTest, &testResponse, testNatGatewayErr)
		err := RunNatGatewayCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgName), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgIps), []string{testNatGatewayVar})
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Create(testNatGatewayVar, natgatewayTest, testQueryParamOther).Return(&natgatewayTest, nil, testNatGatewayErr)
		err := RunNatGatewayCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(testNatGatewayVar, testNatGatewayVar, natgatewayProperties, testQueryParamOther).Return(&natgatewayNew, &testResponse, nil)
...
func TestRunNatGatewayUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Update(testNatGatewayVar, testNatGatewayVar, natgatewayProperties, testQueryParamOther).Return(&natgatewayNew, nil, testNatGatewayErr)
		err := RunNatGatewayUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&testResponse, nil)
...
func TestRunNatGatewayDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().List(testNatGatewayVar, gomock.AssignableToTypeOf(testListQueryParam)).Return(natgatewaysList, &testResponse, nil)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&testResponse, testNatGatewayErr)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(&testResponse, nil)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunNatGatewayDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testNatGatewayVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNatGatewayId), testNatGatewayVar)
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(nil, testNatGatewayErr)
		err := RunNatGatewayDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNatGatewayDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NatGateway.EXPECT().Delete(testNatGatewayVar, testNatGatewayVar, testQueryParamOther).Return(nil, nil)
		err := RunNatGatewayDelete(cfg)
		assert.NoError(t, err)
	})
}
