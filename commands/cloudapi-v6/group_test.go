...
func TestRunGroupCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Group.EXPECT().Create(groupTest).Return(&groupTest, &testResponse, nil)
...
func TestRunGroupUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Group.EXPECT().Update(testGroupVar, groupTestNew).Return(&groupNew, &testResponse, nil)
