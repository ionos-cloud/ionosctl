...
func TestRunGroupListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.Groups{}, &testResponse, nil,
			)
			err := RunGroupList(cfg)
			assert.NoError(t, err)
		},
...
func TestRunGroupGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
			rm.CloudApiV6Mocks.Group.EXPECT().Get(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTestGet, &testResponse, nil)
			err := RunGroupGet(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunGroupGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Get(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTestGet, nil, testGroupErr)
			err := RunGroupGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunGroupCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Create(
				groupTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTest, &testResponse, nil)
...
func TestRunGroupUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Get(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTestNew, nil, nil)
			rm.CloudApiV6Mocks.Group.EXPECT().Update(
				testGroupVar, groupTestNew, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupNew, &testResponse, nil)
...
func TestRunGroupUpdateOld(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Get(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTest, nil, nil)
			rm.CloudApiV6Mocks.Group.EXPECT().Update(
				testGroupVar, groupTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTest, nil, nil)
			err := RunGroupUpdate(cfg)
			assert.NoError(t, err)
		},
...
func TestRunGroupUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Update(
				testGroupVar, groupTest, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&groupTest, nil, testGroupErr)
			err := RunGroupUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunGroupDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgVerbose, false)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
			rm.CloudApiV6Mocks.Group.EXPECT().Delete(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunGroupDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.Group.EXPECT().Delete(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testGroupErr)
			rm.CloudApiV6Mocks.Group.EXPECT().Delete(
				testGroupVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
			err := RunGroupDelete(cfg)
