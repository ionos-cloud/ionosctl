...
func TestPreRunApplicationLoadBalancerRuleHttpRule(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagApplicationLoadBalancerId), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagRuleId), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testAlbRuleHttpRuleVar)
...
func TestRunAlbRuleHttpRuleAddForward(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagTargetGroupId), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagCondition), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagConditionType), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagConditionValue), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNegate), testAlbRuleHttpRuleBoolVar)
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().GetForwardingRule(testAlbRuleHttpRuleVar, testAlbRuleHttpRuleVar, testAlbRuleHttpRuleVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&testAlbRuleHttpRuleGet, nil, nil)
...
func TestRunAlbRuleHttpRuleAddStatic(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagStatusCode), testAlbRuleHttpRuleIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagMessage), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagContentType), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagCondition), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagConditionType), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagConditionValue), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNegate), testAlbRuleHttpRuleBoolVar)
...
func TestRunAlbRuleHttpRuleAddRedirect(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagQuery), testAlbRuleHttpRuleBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLocation), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagStatusCode), testAlbRuleHttpRuleIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagContentType), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagCondition), testAlbRuleHttpRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagConditionType), testAlbRuleHttpRuleVar)
