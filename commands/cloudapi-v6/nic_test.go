...
func TestPreRunNicList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testNicVar)
...
func TestRunNicGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testNicVar)
...
func TestRunNicCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIps), ipsNic)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDhcp), dhcpNic)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), lanNicId)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagFirewallType), testNicVar)
...
func TestRunNicUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testNicVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testNicNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDhcp), dhcpNewNic)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagLanId), lanNewNicId)
		rm.CloudApiV6Mocks.Nic.EXPECT().Get(testNicVar, testNicVar, testNicVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&resources.Nic{Nic: n}, &testResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testNicVar, lanNicIdString, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&lanNic, &testResponse, nil)
...
func TestPreRunDcNicLoadBalancerIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testLoadbalancerVar)
