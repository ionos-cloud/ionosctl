...
func TestPreRunBackupUnitListFormatErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagQuiet, false)
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		cfg.Command.Command.Flags().Set(cloudapiv6.FlagFilters, testBackupUnitVar)
		err := PreRunBackupUnitList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestPreRunBackupUnitId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagQuiet, false)
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagBackupUnitId), testBackupUnitVar)
...
func TestPreRunBackupUnitNameEmailPwd(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.FlagQuiet, false)
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagEmail), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPassword), testBackupUnitVar)
...
func TestRunBackupUnitCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagEmail), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagPassword), testBackupUnitVar)
...
func TestRunBackupUnitUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagOutput, constants.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagBackupUnitId), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagPassword), testBackupUnitNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagEmail), testBackupUnitNewVar)
...
func TestRunBackupUnitUpdateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForRequest), true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagBackupUnitId), testBackupUnitVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPassword), testBackupUnitNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagEmail), testBackupUnitNewVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Update(testBackupUnitVar, backupUnitProperties, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&backupUnitNew, &testResponse, nil)
		// Note: in #487 we no longer expect a status check when using -w , as backupunits are not registered on /requests
		err := RunBackupUnitUpdate(cfg)
