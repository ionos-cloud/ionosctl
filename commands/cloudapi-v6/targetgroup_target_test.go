	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupTargetVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testTargetGroupTargetGetUpdated, nil, nil)
...
func TestRunTargetGroupTargetListResponse(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupTargetVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testTargetGroupTargetGetUpdated, &testResponse, nil)
			err := RunTargetGroupTargetList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunTargetGroupTargetListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupTargetVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testTargetGroupTargetGetUpdated, nil, testTargetGroupTargetErr)
			err := RunTargetGroupTargetList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunTargetGroupTargetListGetPropertiesErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(
				testTargetGroupTargetVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resources.TargetGroup{}, nil, nil)
			err := RunTargetGroupTargetList(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Update(
				testTargetGroupTargetVar, &testTargetGroupTargetProperties, testQueryParamOther,
			).Return(&testTargetGroupTargetGetUpdated, nil, nil)
...
func TestRunTargetGroupTargetRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.TargetGroup.EXPECT().Update(
				testTargetGroupTargetVar, gomock.AssignableToTypeOf(&testTargetGroupTargetProperties),
