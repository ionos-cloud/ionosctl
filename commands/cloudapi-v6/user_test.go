...
func TestPreRunUserNameEmailPwd(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgFirstName), testUserVar)
...
func TestRunUserList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		rm.CloudApiV6Mocks.User.EXPECT().List().Return(users, nil, nil)
		err := RunUserList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunUserCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgEmail), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPassword), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Create(userTest).Return(&userTestGet, nil, nil)
...
func TestRunUserUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgUserId), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgFirstName), testUserNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgLastName), testUserNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgEmail), testUserNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgForceSecAuth), testUserBoolVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgAdmin), testUserBoolVar)
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar).Return(&userTestGet, nil, nil)
...
func TestRunGroupUserList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar).Return(groupUsersTest, nil, nil)
...
func TestRunGroupUserAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().AddUser(testGroupVar, groupUserTest).Return(&userTestGet, nil, nil)
