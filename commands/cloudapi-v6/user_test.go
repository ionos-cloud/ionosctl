...
func TestRunUserGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar, resources.QueryParams{}).Return(&userTestGet, &testResponse, nil)
		err := RunUserGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunUserGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar, resources.QueryParams{}).Return(&userTestGet, nil, testUserErr)
		err := RunUserGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgEmail), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPassword), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Create(userTest, resources.QueryParams{}).Return(&userTestGet, &testResponse, nil)
...
func TestRunUserCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgEmail), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPassword), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Create(userTest, resources.QueryParams{}).Return(&userTestGet, &testResponse, testUserErr)
		err := RunUserCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgEmail), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgPassword), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Create(userTest, resources.QueryParams{}).Return(&userTestGet, nil, testUserErr)
		err := RunUserCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar, resources.QueryParams{}).Return(&userTestGet, nil, nil)
		rm.CloudApiV6Mocks.User.EXPECT().Update(testUserVar, userNewPut, resources.QueryParams{}).Return(&userNew, &testResponse, nil)
...
func TestRunUserUpdateOldUser(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgPassword), testUserNewVar)
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar, resources.QueryParams{}).Return(&userNew, nil, nil)
		rm.CloudApiV6Mocks.User.EXPECT().Update(testUserVar, userNewPut, resources.QueryParams{}).Return(&userNew, nil, nil)
		err := RunUserUpdate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunUserUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgEmail), testUserNewVar)
		rm.CloudApiV6Mocks.User.EXPECT().Get(testUserVar, resources.QueryParams{}).Return(&userTestGet, nil, nil)
		rm.CloudApiV6Mocks.User.EXPECT().Update(testUserVar, userNewPut, resources.QueryParams{}).Return(&userNew, nil, testUserErr)
		err := RunUserUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgVerbose, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Delete(testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
...
func TestRunUserDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.User.EXPECT().List(resources.ListQueryParams{}).Return(usersList, &testResponse, nil)
		rm.CloudApiV6Mocks.User.EXPECT().Delete(testUserVar, resources.QueryParams{}).Return(&testResponse, testUserErr)
		rm.CloudApiV6Mocks.User.EXPECT().Delete(testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
		err := RunUserDelete(cfg)
		assert.Error(t, err)
	})
...
func TestRunUserDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgForce, true)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.User.EXPECT().Delete(testUserVar, resources.QueryParams{}).Return(nil, testUserErr)
		err := RunUserDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.User.EXPECT().Delete(testUserVar, resources.QueryParams{}).Return(nil, nil)
		err := RunUserDelete(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunGroupUserList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(groupUsersTest, &testResponse, nil)
...
func TestRunGroupUserListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(groupUsersTest, nil, testGroupErr)
		err := RunGroupUserList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().AddUser(testGroupVar, groupUserTest, resources.QueryParams{}).Return(&userTestGet, &testResponse, nil)
...
func TestRunGroupUserAddErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().AddUser(testGroupVar, groupUserTest, resources.QueryParams{}).Return(&userTestGet, nil, testUserErr)
		err := RunGroupUserAdd(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserAddResponse(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().AddUser(testGroupVar, groupUserTest, resources.QueryParams{}).Return(&userTestGet, &testResponse, testUserErr)
		err := RunGroupUserAdd(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserRemove(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
...
func TestRunGroupUserRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(groupUsersTestList, &testResponse, nil)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
		err := RunGroupUserRemove(cfg)
		assert.NoError(t, err)
...
func TestRunGroupUserRemoveAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(groupUsersTestList, nil, testUserErr)
		err := RunGroupUserRemove(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserRemoveAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(resources.GroupMembers{}, &testResponse, nil)
		err := RunGroupUserRemove(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserRemoveAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(
...
func TestRunGroupUserRemoveAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
		rm.CloudApiV6Mocks.Group.EXPECT().ListUsers(testGroupVar, resources.ListQueryParams{}).Return(groupUsersTestList, &testResponse, nil)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(&testResponse, testUserErr)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(&testResponse, nil)
		err := RunGroupUserRemove(cfg)
		assert.Error(t, err)
	})
...
func TestRunGroupUserRemoveErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgUserId), testUserVar)
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(nil, testUserErr)
		err := RunGroupUserRemove(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunGroupUserRemoveAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgGroupId), testGroupVar)
		cfg.Stdin = bytes.NewReader([]byte("YES\n"))
		rm.CloudApiV6Mocks.Group.EXPECT().RemoveUser(testGroupVar, testUserVar, resources.QueryParams{}).Return(nil, nil)
		err := RunGroupUserRemove(cfg)
		assert.NoError(t, err)
	})
}
