...
func TestPreRunDcServerNicIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDataCenterId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testFirewallRuleVar)
...
func TestPreRunDcServerNicIdsFRuleProtocol(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagProtocol), testFirewallRuleVar)
...
func TestPreRunDcServerNicFRuleIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagFirewallRuleId), testFirewallRuleVar)
...
func TestRunFirewallRuleCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagNicId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagProtocol), testFirewallRuleProtocol)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPortRangeStart), testFirewallRulePortRangeStart)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagPortRangeEnd), testFirewallRulePortRangeEnd)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagSourceIp), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagSourceMac), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIcmpCode), testFirewallRuleIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagIcmpType), testFirewallRuleIntVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDestinationIp), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagDirection), testFirewallRuleType)
...
func TestRunFirewallRuleDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.FlagVerbose, false)
		viper.Set(constants.FlagServerUrl, constants.DefaultApiURL)
		viper.Set(core.GetFlagName(cfg.Resource, cloudapiv6.FlagDataCenterId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.Resource, cloudapiv6.FlagServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.Resource, cloudapiv6.FlagNicId), testFirewallRuleVar)
