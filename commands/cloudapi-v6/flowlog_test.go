...
func TestRunFlowLogList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgServerId), testFlowLogVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNicId), testFlowLogVar)
			rm.CloudApiV6Mocks.FlowLog.EXPECT().List(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, gomock.AssignableToTypeOf(testListQueryParam),
...
func TestRunFlowLogListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().List(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(resources.FlowLogs{}, &testResponse, nil)
			err := RunFlowLogList(cfg)
			assert.NoError(t, err)
		},
	)
...
func TestRunFlowLogListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().List(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(testFlowLogs, nil, testFlowLogErr)
			err := RunFlowLogList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunFlowLogGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgNicId), testFlowLogVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgFlowLogId), testFlowLogVar)
			rm.CloudApiV6Mocks.FlowLog.EXPECT().Get(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, testFlowLogVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testFlowLog, nil, testFlowLogErr)
...
func TestRunFlowLogCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().Create(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, testInputFlowLog,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testInputFlowLog, &testResponse, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().Create(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, testInputFlowLog,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testInputFlowLog, &testResponse, testFlowLogErr)
			err := RunFlowLogCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunFlowLogDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgFlowLogId), testFlowLogVar)
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.FlowLog.EXPECT().Delete(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, testFlowLogVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunFlowLogDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().List(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(testFlowLogsList, &testResponse, nil)
			rm.CloudApiV6Mocks.FlowLog.EXPECT().Delete(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, testFlowLogVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunFlowLogDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.FlowLog.EXPECT().List(
				testFlowLogVar, testFlowLogVar, testFlowLogVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(testFlowLogsList, &testResponse, testFlowLogErr)
			err := RunFlowLogDelete(cfg)
			assert.Error(t, err)
		},
	)
