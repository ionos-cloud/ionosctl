...
You can wait for the Request to be executed using ` + "`" + `--wait-for-request` + "`" + ` option.`,
	...
	create.AddIntFlag(config.ArgDepth, config.ArgDepthShort, cloudapiv6.DefaultCreateDepth, cloudapiv6.ArgDepthDescription)
...
* Data Center Id`,
	...
	update.AddIntFlag(config.ArgDepth, config.ArgDepthShort, cloudapiv6.DefaultUpdateDepth, cloudapiv6.ArgDepthDescription)
...
* Data Center Id`,
	...
	deleteCmd.AddIntFlag(config.ArgDepth, config.ArgDepthShort, cloudapiv6.DefaultDeleteDepth, cloudapiv6.ArgDepthDescription)
