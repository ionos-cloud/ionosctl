...
func TestRunIpBlockListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				resources.IpBlocks{}, &testResponse, nil,
			)
			err := RunIpBlockList(cfg)
			assert.NoError(t, err)
		},
...
func TestRunIpBlockListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(constants.ArgQuiet, false)
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				testIpBlocks, nil, testIpBlockErr,
			)
			err := RunIpBlockList(cfg)
			assert.Error(t, err)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resTestIpBlock, &testResponse, nil)
...
func TestRunIpBlockGetErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resTestIpBlock, nil, testIpBlockErr)
			err := RunIpBlockGet(cfg)
			assert.Error(t, err)
			assert.True(t, err == testIpBlockErr)
		},
...
func TestRunIpBlockCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Create(
				testIpBlockVar, testIpBlockLocation, testIpBlockSize, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resTestIpBlock, &testResponse, nil)
...
func TestRunIpBlockCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Create(
				testIpBlockVar, testIpBlockLocation, testIpBlockSize, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&resTestIpBlock, &testResponse, testIpBlockErr)
			err := RunIpBlockCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunIpBlockUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Update(
				testIpBlockVar, newTestIpBlockProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&newTestIpBlock, &testResponse, nil)
...
func TestRunIpBlockUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Update(
				testIpBlockVar, newTestIpBlockProperties, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&newTestIpBlock, nil, testIpBlockErr)
			err := RunIpBlockUpdate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunIpBlockDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
...
func TestRunIpBlockDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				testIpBlocksList, &testResponse, nil,
			)
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, nil)
...
func TestRunIpBlockDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, constants.ArgWaitForRequest), false)
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().List(gomock.AssignableToTypeOf(testListQueryParam)).Return(
				testIpBlocksList, nil, testIpBlockErr,
			)
			err := RunIpBlockDelete(cfg)
			assert.Error(t, err)
		},
...
func TestRunIpBlockDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testIpBlockErr)
			rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(
				testIpBlockVar, gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&testResponse, testIpBlockErr)
			err := RunIpBlockDelete(cfg)
