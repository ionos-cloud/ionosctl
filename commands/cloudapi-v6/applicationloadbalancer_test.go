...
func TestRunApplicationLoadBalancerListAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().List(testDatacenterVar).Return(applicationloadbalancers, &testResponse, nil).Times(len(getDataCenters(dcs)))
