...
func TestRunApplicationLoadBalancerListAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgAll), true)
			rm.CloudApiV6Mocks.Datacenter.EXPECT().List(cloudapiv6.ParentResourceListQueryParams).Return(
				dcs, &testResponse, nil,
			)
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().List(
				testDatacenterVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(applicationloadbalancers, &testResponse, nil).Times(len(getDataCenters(dcs)))
...
func TestRunApplicationLoadBalancerList(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testApplicationLoadBalancerVar)
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().List(
				testApplicationLoadBalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(applicationloadbalancers, &testResponse, nil)
...
func TestRunApplicationLoadBalancerListErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().List(
				testApplicationLoadBalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(applicationloadbalancers, nil, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerList(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunApplicationLoadBalancerGet(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testApplicationLoadBalancerVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgApplicationLoadBalancerId), testApplicationLoadBalancerVar)
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Get(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTestGet, nil, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Get(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTestGet, &testResponse, nil)
			err := RunApplicationLoadBalancerGet(cfg)
			assert.NoError(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Get(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTestGet, nil, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerGet(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunApplicationLoadBalancerCreate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Create(
				testApplicationLoadBalancerVar, applicationloadbalancerTest,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTest, nil, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Create(
				testApplicationLoadBalancerVar, applicationloadbalancerTest,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTest, &testResponse, nil)
			err := RunApplicationLoadBalancerCreate(cfg)
			assert.NoError(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Create(
				testApplicationLoadBalancerVar, applicationloadbalancerTest,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerTest, nil, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerCreate(cfg)
			assert.Error(t, err)
		},
	)
...
func TestRunApplicationLoadBalancerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Update(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar, applicationloadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerNew, nil, nil)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Update(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar, applicationloadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerNew, nil, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerUpdate(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Update(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar, applicationloadbalancerProperties,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(&applicationloadbalancerNew, &testResponse, nil)
			rm.CloudApiV6Mocks.Request.EXPECT().GetStatus(testRequestIdVar).Return(
				&testRequestStatus, nil, testRequestErr,
			)
			err := RunApplicationLoadBalancerUpdate(cfg)
...
func TestRunApplicationLoadBalancerDelete(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgDataCenterId), testApplicationLoadBalancerVar)
			viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.ArgApplicationLoadBalancerId), testApplicationLoadBalancerVar)
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Delete(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(nil, nil)
...
func TestRunApplicationLoadBalancerDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().List(
				testApplicationLoadBalancerVar, gomock.AssignableToTypeOf(testListQueryParam),
			).Return(applicationloadbalancers, &testResponse, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerDelete(cfg)
			assert.Error(t, err)
		},
	)
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().Delete(
				testApplicationLoadBalancerVar, testApplicationLoadBalancerVar,
				gomock.AssignableToTypeOf(testQueryParamOther),
			).Return(nil, testApplicationLoadBalancerErr)
			err := RunApplicationLoadBalancerDelete(cfg)
			assert.Error(t, err)
		},
	)
