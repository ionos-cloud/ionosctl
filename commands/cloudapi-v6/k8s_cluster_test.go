...
func TestRunK8sClusterList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListClusters().Return(clusters, nil, nil)
...
func TestRunK8sClusterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sVersion), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgPublic), testClusterBoolVar)
...
func TestRunK8sClusterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sClusterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgName), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sVersion), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaintenanceTime), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgK8sMaintenanceDay), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgS3Bucket), testClusterNewVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapi_v6.ArgApiSubnets), []string{testClusterNewVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().GetCluster(testClusterVar).Return(&clusterTestGet, nil, nil)
