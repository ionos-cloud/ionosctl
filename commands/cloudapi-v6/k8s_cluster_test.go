...
func TestRunK8sClusterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testClusterVar)
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagApiSubnets), []string{testClusterVar})
...
func TestRunK8sClusterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagWaitForState), false)
		viper.Set(core.GetFlagName(cfg.NS, constants.FlagClusterId), testClusterVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagName), testClusterNewVar)
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv6.FlagApiSubnets), []string{testClusterNewVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().GetCluster(testClusterVar, gomock.AssignableToTypeOf(testQueryParamOther)).Return(&clusterTestGet, nil, nil)
