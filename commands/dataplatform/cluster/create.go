...
func ClusterCreateCmd() *core.Command {
	...
	cmd.AddStringVarFlag(
		createProperties.Name, constants.FlagName, constants.FlagNameShort, "", "The name of your cluster",
	)
	...
	cmd.AddStringVarFlag(
		createProperties.DataPlatformVersion, constants.FlagVersion, "", "22.11", "The version of your cluster",
	)
	cmd.AddStringVarFlag(
		createProperties.DatacenterId, constants.FlagDatacenterId, constants.FlagIdShort, "",
		"The ID of the connected datacenter",
	)
	_ = cmd.Command.RegisterFlagCompletionFunc(
