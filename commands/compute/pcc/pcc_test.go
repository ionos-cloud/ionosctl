...
func TestPreRunPccId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgPccId, testPccVar)
		err := PreRunPccId(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List().Return(pccs, &testutil.TestResponse, nil)
		err := RunPccList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().List().Return(resources.PrivateCrossConnects{}, &testutil.TestResponse, nil)
		err := RunPccList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgPccId, testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Get(testPccVar).Return(&pccTestGet, &testutil.TestResponse, nil)
		err := RunPccGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunPccPeersList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgPccId, testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().GetPeers(testPccVar).Return(&[]resources.Peer{pccPeerTest}, &testutil.TestResponse, nil)
...
func TestRunPccCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgName, testPccVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testPccVar)
...
func TestRunPccCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgName, testPccVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testPccVar)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Create(pccTest).Return(&pccTest, &testutil.TestResponse, testPccErr)
		err := RunPccCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgPccId, testPccVar)
		cfg.SetFlag(cloudapiv6.ArgName, testPccNewVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testPccNewVar)
...
func TestRunPccDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().List().Return(pccsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar).Return(&testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar).Return(&testutil.TestResponse, nil)
		err := RunPccDelete(cfg)
		assert.NoError(t, err)
...
func TestRunPccDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Pcc.EXPECT().List().Return(
			resources.PrivateCrossConnects{PrivateCrossConnects: ionoscloud.PrivateCrossConnects{Items: &[]ionoscloud.PrivateCrossConnect{}}}, &testutil.TestResponse, nil)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunPccDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Pcc.EXPECT().List().Return(pccsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar).Return(&testutil.TestResponse, testPccErr)
		rm.CloudApiV6Mocks.Pcc.EXPECT().Delete(testPccVar).Return(&testutil.TestResponse, nil)
		err := RunPccDelete(cfg)
		assert.Error(t, err)
	})
