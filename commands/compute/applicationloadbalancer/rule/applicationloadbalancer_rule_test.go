...
func TestPreRunApplicationLoadBalancerForwardingRuleCreate(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testAlbForwardingRuleIntVar)
...
func TestPreRunApplicationLoadBalancerForwardingRuleDelete(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testAlbForwardingRuleVar)
...
func TestRunApplicationLoadBalancerForwardingRuleList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testAlbForwardingRuleVar)
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().ListForwardingRules(testAlbForwardingRuleVar, testAlbForwardingRuleVar).Return(testAlbForwardingRules, &testutil.TestResponse, nil)
...
func TestRunApplicationLoadBalancerForwardingRuleCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgName, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgProtocol, testAlbForwardingRuleProtocol)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testAlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgClientTimeout, testAlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgServerCertificates, testAlbForwardingRuleServerCerts)
...
func TestRunApplicationLoadBalancerForwardingRuleCreateResponse(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgClientTimeout, testAlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgServerCertificates, testAlbForwardingRuleServerCerts)
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().CreateForwardingRule(testAlbForwardingRuleVar, testAlbForwardingRuleVar, testInputAlbForwardingRule).Return(&testAlbForwardingRuleGet, &testutil.TestResponse, nil)
		err := RunApplicationLoadBalancerForwardingRuleCreate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunApplicationLoadBalancerForwardingRuleUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testAlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgName, testAlbForwardingRuleNewVar)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testAlbForwardingRuleNewVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testAlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgClientTimeout, testAlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgServerCertificates, testAlbForwardingRuleServerNewCerts)
...
func TestRunApplicationLoadBalancerForwardingRuleDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().ListForwardingRules(testAlbForwardingRuleVar, testAlbForwardingRuleVar).Return(testAlbForwardingRules, nil, nil)
		rm.CloudApiV6Mocks.ApplicationLoadBalancer.EXPECT().DeleteForwardingRule(testAlbForwardingRuleVar, testAlbForwardingRuleVar, testAlbForwardingRuleVar).Return(&testutil.TestResponse, testApplicationLoadBalancerForwardingRuleErr)
		cfg.Command.Command.SetIn(bytes.NewReader([]byte("YES\n")))
		err := RunApplicationLoadBalancerForwardingRuleDelete(cfg)
		assert.Error(t, err)
	})
