...
func TestPreRunDcApplicationLoadBalancerIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testApplicationLoadBalancerVar)
...
func TestRunApplicationLoadBalancerCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgName, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgIps, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgPrivateIps, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgTargetLan, testApplicationLoadBalancerIntVar)
		cfg.SetFlag(cloudapiv6.ArgListenerLan, testApplicationLoadBalancerIntVar)
...
func TestRunApplicationLoadBalancerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgApplicationLoadBalancerId, testApplicationLoadBalancerVar)
		cfg.SetFlag(cloudapiv6.ArgName, testApplicationLoadBalancerNewVar)
		cfg.SetFlag(cloudapiv6.ArgIps, testApplicationLoadBalancerNewVar)
		cfg.SetFlag(cloudapiv6.ArgPrivateIps, testApplicationLoadBalancerNewVar)
		cfg.SetFlag(cloudapiv6.ArgTargetLan, testApplicationLoadBalancerNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgListenerLan, testApplicationLoadBalancerNewIntVar)
