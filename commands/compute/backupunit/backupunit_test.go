...
func TestPreRunBackupUnitId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testBackupUnitVar)
...
func TestPreRunBackupUnitNameEmailPwd(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgName, testBackupUnitVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testBackupUnitVar)
		cfg.SetFlag(cloudapiv6.ArgPassword, testBackupUnitVar)
...
func TestRunBackupUnitListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(constants.FlagOrderBy, testQueryParamVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(resources.BackupUnits{}, nil, nil)
		err := RunBackupUnitList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunBackupUnitGetSsoUrl(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testBackupUnitVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().GetSsoUrl(testBackupUnitVar).Return(&backupUnitTestGetSSO, &testutil.TestResponse, nil)
...
func TestRunBackupUnitCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgName, testBackupUnitVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testBackupUnitVar)
		cfg.SetFlag(constants.ArgPassword, testBackupUnitVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Create(backupUnitTest).Return(&backupUnitTest, &testutil.TestResponse, nil)
...
func TestRunBackupUnitCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgEmail, testBackupUnitVar)
		cfg.SetFlag(cloudapiv6.ArgPassword, testBackupUnitVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Create(backupUnitTest).Return(&backupUnitTest, &testutil.TestResponseErr, testBackupUnitErr)
		err := RunBackupUnitCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunBackupUnitUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testBackupUnitVar)
		cfg.SetFlag(constants.ArgPassword, testBackupUnitNewVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testBackupUnitNewVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Update(testBackupUnitVar, backupUnitProperties).Return(&backupUnitNew, &testutil.TestResponse, nil)
...
func TestRunBackupUnitUpdateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, true)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testBackupUnitVar)
		cfg.SetFlag(cloudapiv6.ArgPassword, testBackupUnitNewVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testBackupUnitNewVar)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Update(testBackupUnitVar, backupUnitProperties).Return(&backupUnitNew, &testutil.TestResponse, nil)
		// Note: in #487 we no longer expect a status check when using -w , as backupunits are not registered on /requests
		err := RunBackupUnitUpdate(cfg)
...
func TestRunBackupUnitDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(backupUnitsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Delete(testBackUnitId).Return(&testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Delete(testBackUnitId).Return(&testutil.TestResponse, nil)
		err := RunBackupUnitDelete(cfg)
		assert.NoError(t, err)
	})
...
func TestRunBackupUnitDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgForce, true)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(backupUnitsList, nil, testBackupUnitErr)
		err := RunBackupUnitDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunBackupUnitDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgForce, true)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(resources.BackupUnits{}, &testutil.TestResponse, nil)
		err := RunBackupUnitDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunBackupUnitDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgForce, true)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(
			resources.BackupUnits{BackupUnits: ionoscloud.BackupUnits{Items: &[]ionoscloud.BackupUnit{}}}, &testutil.TestResponse, nil)
		err := RunBackupUnitDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunBackupUnitDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().List().Return(backupUnitsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Delete(testBackUnitId).Return(&testutil.TestResponse, testBackupUnitErr)
		rm.CloudApiV6Mocks.BackupUnit.EXPECT().Delete(testBackUnitId).Return(&testutil.TestResponse, nil)
		err := RunBackupUnitDelete(cfg)
		assert.Error(t, err)
	})
