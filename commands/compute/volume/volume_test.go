...
func TestPreRunVolumeList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testVolumeVar)
...
func TestPreRunDcVolumeIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgVolumeId, testVolumeVar)
...
func TestRunVolumeCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgName, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgSize, "12")
		cfg.SetFlag(cloudapiv6.ArgLicenceType, testVolumeVar)
		cfg.SetFlag(constants.FlagType, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgBus, testVolumeVar)
		cfg.SetFlag(constants.FlagAvailabilityZone, zoneVolume)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgUserData, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgCpuHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgRamHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotUnplug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscVirtioHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscVirtioHotUnplug, testVolumeBoolVar)
...
func TestRunVolumeCreateImg(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgName, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgSize, "12")
		cfg.SetFlag(cloudapiv6.ArgImageId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgImageAlias, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgPassword, testVolumeVar)
		cfg.SetFlag(constants.FlagType, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgBus, testVolumeVar)
		cfg.SetFlag(constants.FlagAvailabilityZone, zoneVolume)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testVolumeVar)
...
func TestRunVolumeCreateSshKeyErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgImageId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgImageAlias, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgSshKeyPaths, []string{testVolumeVar})
		cfg.SetFlag(constants.FlagType, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgBus, testVolumeVar)
		cfg.SetFlag(constants.FlagAvailabilityZone, zoneVolume)
		cfg.SetFlag(cloudapiv6.ArgBackupUnitId, testVolumeVar)
...
func TestRunVolumeUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgVolumeId, testVolumeVar)
		cfg.SetFlag(cloudapiv6.ArgName, testVolumeNewVar)
		cfg.SetFlag(cloudapiv6.ArgSize, "12")
		cfg.SetFlag(cloudapiv6.ArgBus, testVolumeNewVar)
		cfg.SetFlag(cloudapiv6.ArgCpuHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgRamHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotPlug, testVolumeBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotUnplug, testVolumeBoolVar)
