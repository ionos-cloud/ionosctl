...
func TestPreRunNetworkLoadBalancerRuleTarget(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, testNlbRuleTargetIntVar)
...
func TestRunNlbRuleTargetList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar).
			Return(&testNlbRuleTargetGetUpdated, &testutil.TestResponse, nil)
...
func TestRunNlbRuleTargetAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgIp, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, testNlbRuleTargetIntVar)
		cfg.SetFlag(cloudapiv6.ArgWeight, testNlbRuleTargetIntVar)
		cfg.SetFlag(cloudapiv6.ArgCheckInterval, testNlbRuleTargetIntVar)
		cfg.SetFlag(cloudapiv6.ArgCheck, testNlbRuleTargetBoolVar)
		cfg.SetFlag(cloudapiv6.ArgMaintenance, testNlbRuleTargetBoolVar)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar).Return(&testNlbRuleTargetGet, nil, nil)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().UpdateForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar, &testRuleTargetProperties).
			Return(&testNlbRuleTargetGetUpdated, &testutil.TestResponse, nil)
...
func TestRunNlbRuleTargetAddResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgMaintenance, testNlbRuleTargetBoolVar)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar).Return(&testNlbRuleTargetGet, nil, nil)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().UpdateForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar, &testRuleTargetProperties).Return(&testNlbRuleTargetGetUpdated, &testutil.TestResponse, testNlbRuleTargetErr)
		err := RunNlbRuleTargetAdd(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNlbRuleTargetRemoveIpErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgIp, "x.x.x.x")
		cfg.SetFlag(cloudapiv6.ArgPort, testNlbRuleTargetIntVar)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar).Return(&testNlbRuleTargetGetUpdated, nil, nil)
		err := RunNlbRuleTargetRemove(cfg)
		assert.Error(t, err)
...
func TestRunNlbRuleTargetRemovePortErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgRuleId, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testNlbRuleTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, int32(2))
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbRuleTargetVar, testNlbRuleTargetVar, testNlbRuleTargetVar).Return(&testNlbRuleTargetGetUpdated, nil, nil)
		err := RunNlbRuleTargetRemove(cfg)
		assert.Error(t, err)
	})
