...
func TestPreRunNetworkLoadBalancerRuleList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbForwardingRuleVar)
...
func TestPreRunNetworkLoadBalancerForwardingRuleCreate(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testNlbForwardingRuleIntVar)
...
func TestPreRunDcNetworkLoadBalancerForwardingRuleIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testNlbForwardingRuleVar)
...
func TestRunNetworkLoadBalancerForwardingRuleList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).
			Return(testNlbForwardingRules, &testutil.TestResponse, nil)
...
func TestRunNetworkLoadBalancerForwardingRuleListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).
			Return(resources.NetworkLoadBalancerForwardingRules{}, &testutil.TestResponse, nil)
		err := RunNetworkLoadBalancerForwardingRuleList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunNetworkLoadBalancerForwardingRuleCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testNlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgAlgorithm, testNlbForwardingRuleAlgorithm)
		cfg.SetFlag(cloudapiv6.ArgClientTimeout, testNlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgConnectionTimeout, testNlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgTargetTimeout, testNlbForwardingRuleIntVar)
		cfg.SetFlag(cloudapiv6.ArgRetries, testNlbForwardingRuleIntVar)
...
func TestRunNetworkLoadBalancerForwardingRuleUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgNetworkLoadBalancerId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgRuleId, testNlbForwardingRuleVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNlbForwardingRuleNewVar)
		cfg.SetFlag(cloudapiv6.ArgListenerIp, testNlbForwardingRuleNewVar)
		cfg.SetFlag(cloudapiv6.ArgListenerPort, testNlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgClientTimeout, testNlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgConnectionTimeout, testNlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgTargetTimeout, testNlbForwardingRuleNewIntVar)
		cfg.SetFlag(cloudapiv6.ArgRetries, testNlbForwardingRuleNewIntVar)
...
func TestRunNetworkLoadBalancerForwardingRuleDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).
			Return(testNlbForwardingRulesList, &testutil.TestResponse, nil)
...
func TestRunNetworkLoadBalancerForwardingRuleDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).
			Return(resources.NetworkLoadBalancerForwardingRules{NetworkLoadBalancerForwardingRules: ionoscloud.NetworkLoadBalancerForwardingRules{Items: &[]ionoscloud.NetworkLoadBalancerForwardingRule{}}}, &testutil.TestResponse, nil)
		err := RunNetworkLoadBalancerForwardingRuleDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNetworkLoadBalancerForwardingRuleDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().DeleteForwardingRule(testNlbForwardingRuleVar,
			...
			Return(&testutil.TestResponse, testNetworkLoadBalancerForwardingRuleErr)
		rm.CloudApiV6Mocks.NetworkLoadBalancer.EXPECT().DeleteForwardingRule(testNlbForwardingRuleVar,
			testNlbForwardingRuleVar, testNlbForwardingRuleVar,
		).
			Return(&testutil.TestResponse, nil)
