...
func NetworkLoadBalancerGetCmd() *core.Command {
	cmd := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		LongDesc:   "Use this command to get information about a specified Network Load Balancer, including its listener/target LANs, IP addresses, and provisioning state.\n\nUse --wait (-w) to block until the resource reaches AVAILABLE state.\n\nRequired values to run command:\n\n* Data Center Id\n* Network Load Balancer Id",
