...
func TestRunLoadBalancerCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgName, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgDhcp, dhcpLoadbalancer)
...
func TestRunLoadBalancerUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgLoadBalancerId, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgName, testLoadbalancerNewVar)
		cfg.SetFlag(cloudapiv6.ArgDhcp, dhcpLoadbalancerNew)
		cfg.SetFlag(cloudapiv6.ArgIp, testLoadbalancerNewVar)
		viper.Set(constants.ArgWait, false)
