...
func ServerGpuGetCmd() *core.Command {
	getGpuCmd := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		Verb:       "get",
		Aliases:    []string{"g"},
		ShortDesc:  "Get details of a GPU attached to a GPU Server",
		LongDesc:   "Use this command to retrieve the details (vendor, model, type, state) of a single GPU card attached to a Server of type GPU. Find the GPU Id first with `server gpu list`.\n\nRequired values to run command:\n\n* Data Center Id\n* Server Id\n* GPU Id",
