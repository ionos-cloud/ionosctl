...
func ServerGetCmd() *core.Command {
	get := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		Verb:       "get",
		Aliases:    []string{"g"},
		ShortDesc:  "Get details of a Server",
		LongDesc:   "Use this command to retrieve the full details of a Server in a Virtual Data Center, including its type, sizing (cores/RAM), CPU family, availability zone, boot volume/CD-ROM and lifecycle state.\n\nUse --wait (-w) to block until the resource reaches AVAILABLE state (useful right after a create/update).\n\nRequired values to run command:\n\n* Data Center Id\n* Server Id",
