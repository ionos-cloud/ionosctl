...
import (
	...
	lbnic "github.com/ionos-cloud/ionosctl/v6/commands/compute/loadbalancer/nic"
...
func TestPreRunNicList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgServerId, testNicVar)
...
func TestRunNicList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgServerId, testNicVar)
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(ns, &testutil.TestResponse, nil)
		err := RunNicList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunNicListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(resources.Nics{}, &testutil.TestResponse, nil)
		err := RunNicList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunNicGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgServerId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgNicId, testNicVar)
...
func TestRunNicCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgServerId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgIps, ipsNic)
		cfg.SetFlag(cloudapiv6.ArgDhcp, dhcpNic)
		cfg.SetFlag(cloudapiv6.ArgLanId, lanNicId)
		cfg.SetFlag(cloudapiv6.ArgFirewallType, testNicVar)
...
func TestRunNicUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgServerId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgNicId, testNicVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNicNewVar)
		cfg.SetFlag(cloudapiv6.ArgDhcp, dhcpNewNic)
		cfg.SetFlag(cloudapiv6.ArgLanId, lanNewNicId)
		rm.CloudApiV6Mocks.Nic.EXPECT().Get(testNicVar, testNicVar, testNicVar).Return(&resources.Nic{Nic: n}, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testNicVar, lanNicIdString).Return(&lanNic, &testutil.TestResponse, nil)
...
func TestRunNicDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(nicsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Nic.EXPECT().Delete(testNicVar, testNicVar, testNicVar).Return(&testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Nic.EXPECT().Delete(testNicVar, testNicVar, testNicVar).Return(&testutil.TestResponse, nil)
		err := RunNicDelete(cfg)
		assert.NoError(t, err)
...
func TestRunNicDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(nicsList, nil, testNicErr)
		err := RunNicDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNicDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(
			resources.Nics{Nics: ionoscloud.Nics{Items: &[]ionoscloud.Nic{}}}, &testutil.TestResponse, nil)
		err := RunNicDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNicDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Nic.EXPECT().List(testNicVar, testNicVar).Return(nicsList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Nic.EXPECT().Delete(testNicVar, testNicVar, testNicVar).Return(&testutil.TestResponse, testNicErr)
		rm.CloudApiV6Mocks.Nic.EXPECT().Delete(testNicVar, testNicVar, testNicVar).Return(&testutil.TestResponse, nil)
		err := RunNicDelete(cfg)
		assert.Error(t, err)
	})
...
func TestPreRunDcNicLoadBalancerIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgLoadBalancerId, testLoadbalancerVar)
		cfg.SetFlag(cloudapiv6.ArgNicId, testLoadbalancerVar)
...
func TestRunLoadBalancerNicDetachAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().ListNics(testLoadbalancerVar, testLoadbalancerVar).Return(balancedNicsList, nil, nil)
...
func TestRunLoadBalancerNicDetachAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().ListNics(testLoadbalancerVar, testLoadbalancerVar).Return(balancedNicsList, nil, testNicErr)
		err := RunLoadBalancerNicDetach(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLoadBalancerNicDetachAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().ListNics(testLoadbalancerVar, testLoadbalancerVar).Return(resources.BalancedNics{}, nil, nil)
		err := RunLoadBalancerNicDetach(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLoadBalancerNicDetachAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().ListNics(testLoadbalancerVar, testLoadbalancerVar).Return(
...
func TestRunLoadBalancerNicDetachAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().ListNics(testLoadbalancerVar, testLoadbalancerVar).Return(balancedNicsList, nil, nil)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().DetachNic(testLoadbalancerVar, testLoadbalancerVar, testLoadbalancerVar).Return(&testutil.TestResponse, testNicErr)
		rm.CloudApiV6Mocks.Loadbalancer.EXPECT().DetachNic(testLoadbalancerVar, testLoadbalancerVar, testLoadbalancerVar).Return(&testutil.TestResponse, nil)
		err := RunLoadBalancerNicDetach(cfg)
		assert.Error(t, err)
	})
