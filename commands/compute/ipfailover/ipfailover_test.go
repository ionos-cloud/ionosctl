...
func TestPreRunDcLanIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgLanId, testIpFailoverVar)
...
func TestPreRunDcLanServerNicIdsIp(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgServerId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgNicId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgLanId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testIpFailoverVar)
...
func TestRunIpFailoverList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgLanId, testIpFailoverVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testIpFailoverVar, testIpFailoverVar).Return(&testLanIpFailover, &testutil.TestResponse, nil)
...
func TestRunIpFailoverAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgNicId, testIpFailoverVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testIpFailoverVar)
		rm.CloudApiV6Mocks.Lan.EXPECT().Update(testIpFailoverVar, testIpFailoverVar, testLanPropertiesIpFailover).Return(&testLanIpFailover, &testutil.TestResponse, nil)
...
func TestRunIpFailoverRemoveAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Lan.EXPECT().List(testIpFailoverVar).Return(lansIpFailover, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Get(testIpFailoverVar, testIpFailoverVar).Return(&testLanIpFailover, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Lan.EXPECT().Update(testIpFailoverVar, testIpFailoverVar, resources.LanProperties{
			LanProperties: ionoscloud.LanProperties{
				IpFailover: &[]ionoscloud.IPFailover{},
...
func TestRunIpFailoverRemoveResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		).Return(&testLanIpFailoverRemove, &testutil.TestResponse, testIpFailoverErr)
		err := RunIpFailoverRemove(cfg)
		assert.Error(t, err)
	})
}
