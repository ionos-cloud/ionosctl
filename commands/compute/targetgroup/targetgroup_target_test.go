...
func TestPreRunTargetGroupIdTargetIpPort(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgTargetGroupId, testTargetGroupTargetVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testTargetGroupTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, int(testTargetGroupTargetIntVar))
...
func TestRunTargetGroupTargetAdd(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgIp, testTargetGroupTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, int(testTargetGroupTargetIntVar))
		cfg.SetFlag(cloudapiv6.ArgWeight, int(testTargetGroupTargetIntVar))
		cfg.SetFlag(cloudapiv6.ArgMaintenanceEnabled, testTargetGroupTargetBoolVar)
		cfg.SetFlag(cloudapiv6.ArgHealthCheckEnabled, testTargetGroupTargetBoolVar)
		rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(testTargetGroupTargetVar).Return(&testTargetGroupTargetGet, nil, nil)
...
func TestRunTargetGroupTargetRemovePortErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgTargetGroupId, testTargetGroupTargetVar)
		cfg.SetFlag(cloudapiv6.ArgIp, testTargetGroupTargetVar)
		cfg.SetFlag(cloudapiv6.ArgPort, int(2))
		rm.CloudApiV6Mocks.TargetGroup.EXPECT().Get(testTargetGroupTargetVar).Return(&testTargetGroupTargetGetUpdated, nil, nil)
		err := RunTargetGroupTargetRemove(cfg)
		assert.Error(t, err)
	})
