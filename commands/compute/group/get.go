...
func GroupGetCmd() *core.Command {
	cmd := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		Verb:       "get",
		Aliases:    []string{"g"},
		ShortDesc:  "Get a Group and its privileges",
		LongDesc:   "Retrieve a single Group by ID, including the full set of privilege flags currently enabled for it. Use `--cols` to reveal every privilege column.\n\nRequired values to run command:\n\n* Group Id",
