...
func TestPreRunIpBlockId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgIpBlockId, testIpBlockVar)
...
func TestRunIpBlockList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().List().Return(testIpBlocks, &testutil.TestResponse, nil)
...
func TestRunIpBlockListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().List().Return(resources.IpBlocks{}, &testutil.TestResponse, nil)
		err := RunIpBlockList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunIpBlockGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgIpBlockId, testIpBlockVar)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Get(testIpBlockVar).Return(&resTestIpBlock, &testutil.TestResponse, nil)
...
func TestRunIpBlockCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgName, testIpBlockVar)
		cfg.SetFlag(cloudapiv6.ArgLocation, testIpBlockLocation)
		cfg.SetFlag(cloudapiv6.ArgSize, testIpBlockSize)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Create(testIpBlockVar, testIpBlockLocation, testIpBlockSize).Return(&resTestIpBlock, &testutil.TestResponse, nil)
...
func TestRunIpBlockCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgLocation, testIpBlockLocation)
		cfg.SetFlag(cloudapiv6.ArgSize, testIpBlockSize)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Create(testIpBlockVar, testIpBlockLocation, testIpBlockSize).Return(&resTestIpBlock, &testutil.TestResponse, testIpBlockErr)
		err := RunIpBlockCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunIpBlockUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgIpBlockId, testIpBlockVar)
		cfg.SetFlag(cloudapiv6.ArgName, newTestIpBlockVar)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Update(testIpBlockVar, newTestIpBlockProperties).Return(&newTestIpBlock, &testutil.TestResponse, nil)
...
func TestRunIpBlockDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(testIpBlockVar).Return(&testutil.TestResponse, nil)
...
func TestRunIpBlockDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgIpBlockId, testIpBlockVar)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().List().Return(testIpBlocksList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(testIpBlockVar).Return(&testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(testIpBlockVar).Return(&testutil.TestResponse, nil)
		err := RunIpBlockDelete(cfg)
		assert.NoError(t, err)
...
func TestRunIpBlockDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().List().Return(
			resources.IpBlocks{IpBlocks: ionoscloud.IpBlocks{Items: &[]ionoscloud.IpBlock{}}}, &testutil.TestResponse, nil)
		err := RunIpBlockDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunIpBlockDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().List().Return(testIpBlocksList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(testIpBlockVar).Return(&testutil.TestResponse, testIpBlockErr)
		rm.CloudApiV6Mocks.IpBlocks.EXPECT().Delete(testIpBlockVar).Return(&testutil.TestResponse, testIpBlockErr)
		err := RunIpBlockDelete(cfg)
		assert.Error(t, err)
	})
