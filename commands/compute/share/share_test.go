...
func TestPreRunGroupResourceIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgGroupId, testShareVar)
		cfg.SetFlag(cloudapiv6.ArgResourceId, testShareVar)
...
func TestRunShareUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgGroupId, testShareVar)
		cfg.SetFlag(cloudapiv6.ArgResourceId, testShareVar)
		cfg.SetFlag(cloudapiv6.ArgEditPrivilege, testShareBoolNewVar)
		cfg.SetFlag(cloudapiv6.ArgSharePrivilege, testShareBoolNewVar)
