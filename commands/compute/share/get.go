...
func ShareGetCmd() *core.Command {
	cmd := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		Verb:       "get",
		Aliases:    []string{"g"},
		ShortDesc:  "Get one share (a Group's access to a resource)",
		LongDesc:   "Retrieve the details of a single Share - the access a specific Group has to a specific resource - including its edit and re-share permission bits.\n\nRequired values to run command:\n\n* Group Id\n* Resource Id",
