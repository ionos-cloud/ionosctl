...
func TestPreRunUserId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgUserId, testUserVar)
...
func TestPreRunUserNameEmailPwd(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgFirstName, testUserVar)
		cfg.SetFlag(cloudapiv6.ArgLastName, testUserVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testUserVar)
		cfg.SetFlag(constants.ArgPassword, testUserVar)
...
func TestRunUserUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgUserId, testUserVar)
		cfg.SetFlag(cloudapiv6.ArgFirstName, testUserNewVar)
		cfg.SetFlag(cloudapiv6.ArgLastName, testUserNewVar)
		cfg.SetFlag(cloudapiv6.ArgPassword, testUserNewVar)
		cfg.SetFlag(cloudapiv6.ArgEmail, testUserNewVar)
		cfg.SetFlag(cloudapiv6.ArgForceSecAuth, testUserBoolVar)
		cfg.SetFlag(cloudapiv6.ArgAdmin, testUserBoolVar)
