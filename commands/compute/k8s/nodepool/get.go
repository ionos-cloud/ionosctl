...
func K8sNodePoolGetCmd() *core.Command {
	cmd := core.NewCommand(context.TODO(), nil, core.CommandBuilder{
		...
		LongDesc:   "Use this command to retrieve details about a specific NodePool from an existing Kubernetes Cluster. Use `--wait` (`-w`) to wait for the resource to reach AVAILABLE state.\n\nRequired values to run command:\n\n* K8s Cluster Id\n* K8s NodePool Id",
