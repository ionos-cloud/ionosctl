...
* K8s Cluster Id
* K8s NodePool Id`,
		Example:    "ionosctl compute k8s nodepool update --cluster-id CLUSTER_ID --nodepool-id NODEPOOL_ID",
	...
	cmd.AddBoolFlag(constants.ArgWaitForState, "", constants.DefaultWait, "Wait for the new NodePool to be in ACTIVE state")
