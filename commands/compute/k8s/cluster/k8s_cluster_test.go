...
func TestPreRunK8sClusterId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(constants.FlagClusterId, testClusterVar)
...
func TestRunK8sClusterList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListClusters().Return(clusters, &testutil.TestResponse, nil)
...
func TestRunK8sClusterGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(constants.FlagClusterId, testClusterVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().GetCluster(testClusterVar).Return(&clusterTestGet, &testutil.TestResponse, nil)
...
func TestRunK8sClusterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		viper.Set(constants.ArgWait, false)
		cfg.SetFlag(cloudapiv6.ArgName, testClusterVar)
		cfg.SetFlag(cloudapiv6.ArgK8sVersion, testClusterVar)
		cfg.SetFlag(cloudapiv6.ArgS3Bucket, testClusterVar)
		cfg.SetFlag(cloudapiv6.ArgApiSubnets, []string{testClusterVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().CreateCluster(clusterTestPost).Return(&clusterTest, &testutil.TestResponse, nil)
...
func TestRunK8sClusterCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgS3Bucket, testClusterVar)
		cfg.SetFlag(cloudapiv6.ArgApiSubnets, []string{testClusterVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().CreateCluster(clusterTestPost).Return(&clusterTest, &testutil.TestResponse, testClusterErr)
		err := RunK8sClusterCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunK8sClusterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgWait, false)
		cfg.SetFlag(constants.FlagClusterId, testClusterVar)
		cfg.SetFlag(cloudapiv6.ArgName, testClusterNewVar)
		cfg.SetFlag(cloudapiv6.ArgK8sVersion, testClusterNewVar)
		cfg.SetFlag(cloudapiv6.ArgK8sMaintenanceTime, testClusterNewVar)
		cfg.SetFlag(cloudapiv6.ArgK8sMaintenanceDay, testClusterNewVar)
		cfg.SetFlag(cloudapiv6.ArgS3Bucket, testClusterNewVar)
		cfg.SetFlag(cloudapiv6.ArgApiSubnets, []string{testClusterNewVar})
		rm.CloudApiV6Mocks.K8s.EXPECT().GetCluster(testClusterVar).Return(&clusterTestGet, nil, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().UpdateCluster(testClusterVar, clusterNewTestPut).Return(&clusterNew, &testutil.TestResponse, nil)
...
func TestRunK8sClusterDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(constants.FlagClusterId, testClusterVar)
		rm.CloudApiV6Mocks.K8s.EXPECT().DeleteCluster(testClusterVar).Return(&testutil.TestResponse, nil)
...
func TestRunK8sClusterDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgForce, true)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListClusters().Return(resources.K8sClusters{}, &testutil.TestResponse, nil)
		err := RunK8sClusterDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunK8sClusterDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListClusters().Return(
			resources.K8sClusters{KubernetesClusters: ionoscloud.KubernetesClusters{Items: &[]ionoscloud.KubernetesCluster{}}}, &testutil.TestResponse, nil)
		err := RunK8sClusterDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunK8sClusterDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.K8s.EXPECT().ListClusters().Return(clustersList, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.K8s.EXPECT().DeleteCluster(testClusterVar).Return(&testutil.TestResponse, testClusterErr)
		rm.CloudApiV6Mocks.K8s.EXPECT().DeleteCluster(testClusterVar).Return(&testutil.TestResponse, nil)
		err := RunK8sClusterDelete(cfg)
		assert.Error(t, err)
	})
