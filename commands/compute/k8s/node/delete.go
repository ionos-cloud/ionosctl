...
* K8s NodePool Id
* K8s Node Id`,
		Example:    "ionosctl k8s node delete --cluster-id CLUSTER_ID --nodepool-id NODEPOOL_ID --node-id NODE_ID",
		PreCmdRun:  cloudapiv6cmds.PreRunK8sClusterNodesIdsAll,
		CmdRun:     cloudapiv6cmds.RunK8sNodeDelete,
		InitClient: true,
	})
