...
func TestPreRunSnapshotId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgSnapshotId, testSnapshotVar)
...
func TestPreRunSnapshotIdDcIdVolumeId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgSnapshotId, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgVolumeId, testSnapshotVar)
...
func TestRunSnapshotListSort(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgLicenceType, testSnapshotVar)
...
func TestRunSnapshotCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgName, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgVolumeId, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgLicenceType, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgName, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgSecAuthProtection, false)
...
func TestRunSnapshotUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgSnapshotId, testSnapshotVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testSnapshotNewVar)
		cfg.SetFlag(cloudapiv6.ArgName, testSnapshotNewVar)
		cfg.SetFlag(cloudapiv6.ArgCpuHotPlug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgCpuHotUnplug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgRamHotPlug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgRamHotUnplug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotPlug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgNicHotUnplug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscVirtioHotPlug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscVirtioHotUnplug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscScsiHotPlug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgDiscScsiHotUnplug, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgSecAuthProtection, testSnapshotBoolVar)
		cfg.SetFlag(cloudapiv6.ArgLicenceType, testSnapshotVar)
		viper.Set(constants.ArgWait, false)
