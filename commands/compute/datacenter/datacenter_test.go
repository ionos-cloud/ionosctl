...
func TestPreRunDataCenterId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testDatacenterVar)
...
func TestRunDataCenterList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().List().Return(dcs, &testutil.TestResponse, nil)
...
func TestRunDataCenterListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Datacenter.EXPECT().List().Return(resources.Datacenters{}, &testutil.TestResponse, nil)
		err := RunDataCenterList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunDataCenterGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV6Mocks.Datacenter.EXPECT().Get(testDatacenterVar).Return(&res, &testutil.TestResponse, nil)
...
func TestRunDataCenterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgName, testDatacenterVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testDatacenterVar)
		cfg.SetFlag(cloudapiv6.ArgLocation, testDatacenterVar)
		viper.Set(constants.ArgWait, false)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().Create(testDatacenterVar, testDatacenterVar, testDatacenterVar).Return(&resources.Datacenter{dc}, &testutil.TestResponse, nil)
...
func TestRunDataCenterUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgQuiet, false)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testDatacenterVar)
		cfg.SetFlag(cloudapiv6.ArgDescription, testDatacenterNewVar)
		cfg.SetFlag(cloudapiv6.ArgName, testDatacenterNewVar)
		viper.Set(constants.ArgWait, false)
...
func TestRunDataCenterDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgServerUrl, constants.DefaultApiURL)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().List().Return(resources.Datacenters{}, nil, nil)
		err := RunDataCenterDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunDataCenterDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgServerUrl, constants.DefaultApiURL)
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().List().Return(
			resources.Datacenters{Datacenters: ionoscloud.Datacenters{Items: &[]ionoscloud.Datacenter{}}}, &testutil.TestResponse, nil)
		err := RunDataCenterDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunDataCenterDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgAll, true)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().List().Return(dcs, &testutil.TestResponse, nil)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().Delete(testDatacenterVar).Return(&testutil.TestResponse, testDatacenterErr)
		rm.CloudApiV6Mocks.Datacenter.EXPECT().Delete(testDatacenterVar).Return(&testutil.TestResponse, nil)
		err := RunDataCenterDelete(cfg)
		assert.Error(t, err)
	})
