...
func TestPreRunNATGatewayList(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNatGatewayVar)
...
func TestPreRunDcIdsNatGatewayProperties(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgIps, []string{testNatGatewayVar})
...
func TestPreRunDcNatGatewayIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgNatGatewayId, testNatGatewayVar)
...
func TestRunNatGatewayCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(constants.ArgOutput, constants.DefaultOutputFormat)
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgIps, []string{testNatGatewayVar})
...
func TestRunNatGatewayUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		cfg.SetFlag(cloudapiv6.ArgDataCenterId, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgNatGatewayId, testNatGatewayVar)
		cfg.SetFlag(cloudapiv6.ArgName, testNatGatewayNewVar)
		cfg.SetFlag(cloudapiv6.ArgIps, []string{testNatGatewayNewVar})
