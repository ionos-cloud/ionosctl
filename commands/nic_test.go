...
func TestPreRunGlobalDcServerIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgDataCenterId), testNicVar)
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgServerId), testNicVar)
