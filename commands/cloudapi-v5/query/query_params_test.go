...
func TestValidateFilters(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"test=test"})
...
func TestValidateFiltersFormatErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"test"})
		err := ValidateFilters(cfg, testFiltersVar, "")
		assert.Error(t, err)
	})
}
...
func TestValidateFiltersInvalidsErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"name=test", "location=test"})
		err := ValidateFilters(cfg, testFiltersVar, "")
		assert.Error(t, err)
	})
}
...
func TestValidateFiltersInvalidErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"name=test"})
		err := ValidateFilters(cfg, testFiltersVar, "")
		assert.Error(t, err)
	})
}
...
func TestGetListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"name=test", "location=test"})
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgOrderBy), testFilterVar)
...
func TestGetListQueryParamsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgFilters), []string{"name"})
