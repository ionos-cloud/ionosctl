...
func GroupCmd() *core.Command {
	...
	*/
	...
	create.AddBoolFlag(cloudapiv5.ArgCreateDc, "", false, "The group will be allowed to create Data Centers")
	create.AddBoolFlag(cloudapiv5.ArgCreateSnapshot, "", false, "The group will be allowed to create Snapshots")
	create.AddBoolFlag(cloudapiv5.ArgReserveIp, "", false, "The group will be allowed to reserve IP addresses")
	create.AddBoolFlag(cloudapiv5.ArgAccessLog, "", false, "The group will be allowed to access the activity log")
	create.AddBoolFlag(cloudapiv5.ArgCreatePcc, "", false, "The group will be allowed to create PCCs")
	create.AddBoolFlag(cloudapiv5.ArgS3Privilege, "", false, "The group will be allowed to manage S3")
	create.AddBoolFlag(cloudapiv5.ArgCreateBackUpUnit, "", false, "The group will be able to manage Backup Units")
	create.AddBoolFlag(cloudapiv5.ArgCreateNic, "", false, "The group will be allowed to create NICs")
	create.AddBoolFlag(cloudapiv5.ArgCreateK8s, "", false, "The group will be allowed to create K8s Clusters")
...
* Group Id`,
	...
	update.AddBoolFlag(cloudapiv5.ArgCreateDc, "", false, "The group will be allowed to create Data Centers")
	update.AddBoolFlag(cloudapiv5.ArgCreateSnapshot, "", false, "The group will be allowed to create Snapshots")
	update.AddBoolFlag(cloudapiv5.ArgReserveIp, "", false, "The group will be allowed to reserve IP addresses")
	update.AddBoolFlag(cloudapiv5.ArgAccessLog, "", false, "The group will be allowed to access the activity log")
	update.AddBoolFlag(cloudapiv5.ArgCreatePcc, "", false, "The group will be allowed to create PCCs")
	update.AddBoolFlag(cloudapiv5.ArgS3Privilege, "", false, "The group will be allowed to manage S3")
	update.AddBoolFlag(cloudapiv5.ArgCreateBackUpUnit, "", false, "The group will be able to manage Backup Units")
	update.AddBoolFlag(cloudapiv5.ArgCreateNic, "", false, "The group will be allowed to create NICs")
	update.AddBoolFlag(cloudapiv5.ArgCreateK8s, "", false, "The group will be allowed to create K8s Clusters")
