...
func TestRunUserS3KeyList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		rm.CloudApiV5Mocks.S3Key.EXPECT().List(testS3keyVar).Return(s3keys, &testResponse, nil)
...
func TestRunUserS3KeyListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().List(testS3keyVar).Return(s3keys, nil, testS3keyErr)
		err := RunUserS3KeyList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Get(testS3keyVar, testS3keyVar).Return(&s3keyTestGet, &testResponse, nil)
...
func TestRunUserS3KeyGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Get(testS3keyVar, testS3keyVar).Return(&s3keyTestGet, nil, testS3keyErr)
		err := RunUserS3KeyGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Create(testS3keyVar).Return(&s3keyTest, &testResponse, nil)
...
func TestRunUserS3KeyCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Create(testS3keyVar).Return(&s3keyTest, &testResponseErr, nil)
		err := RunUserS3KeyCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyCreateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Create(testS3keyVar).Return(&s3keyTest, nil, testS3keyErr)
		err := RunUserS3KeyCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyActive), testS3keyBoolNewVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Update(testS3keyVar, testS3keyVar, s3keyNew).Return(&s3keyNew, &testResponse, nil)
...
func TestRunUserS3KeyUpdateOld(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyActive), testS3keyBoolNewVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Update(testS3keyVar, testS3keyVar, s3keyNew).Return(&s3keyNew, nil, nil)
		err := RunUserS3KeyUpdate(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunUserS3KeyUpdateErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyActive), testS3keyBoolNewVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Update(testS3keyVar, testS3keyVar, s3keyNew).Return(&s3keyNew, nil, testS3keyErr)
		err := RunUserS3KeyUpdate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyDeleteAll(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.S3Key.EXPECT().List(testS3keyVar).Return(s3keysList, &testResponse, nil)
...
func TestRunUserS3KeyDeleteErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgUserId), testS3keyVar)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgS3KeyId), testS3keyVar)
		rm.CloudApiV5Mocks.S3Key.EXPECT().Delete(testS3keyVar, testS3keyVar).Return(nil, testS3keyErr)
		err := RunUserS3KeyDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunUserS3KeyDeleteAskForConfirm(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV5Mocks.S3Key.EXPECT().Delete(testS3keyVar, testS3keyVar).Return(nil, nil)
		err := RunUserS3KeyDelete(cfg)
		assert.NoError(t, err)
	})
}
