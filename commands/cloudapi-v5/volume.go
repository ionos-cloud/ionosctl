...
func RunVolumeList(c *core.CommandConfig) error {
	...
	volumes, resp, err := c.CloudApiV5Services.Volumes().List(viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgDataCenterId)))
	if resp != nil {
...
func RunServerVolumesList(c *core.CommandConfig) error {
	...
	attachedVols, _, err := c.CloudApiV5Services.Servers().ListVolumes(dcId, serverId)
	if err != nil {
		return err
	}
