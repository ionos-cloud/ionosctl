...
func TestPreLocationId(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgLocationId), testLocationVar)
...
func TestRunLocationList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV5Mocks.Location.EXPECT().List(resources.ListQueryParams{}).Return(locations, &testResponse, nil)
...
func TestRunLocationListQueryParams(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV5Mocks.Location.EXPECT().List(testListQueryParam).Return(resources.Locations{}, &testResponse, nil)
		err := RunLocationList(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunLocationListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(config.ArgQuiet, false)
		rm.CloudApiV5Mocks.Location.EXPECT().List(resources.ListQueryParams{}).Return(locations, nil, testLocationErr)
		err := RunLocationList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLocationGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		rm.CloudApiV5Mocks.Location.EXPECT().GetByRegionAndLocationId(testIds[0], testIds[1]).Return(&loc, &testResponse, nil)
...
func TestRunLocationGetErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgLocationId), testLocationVar)
		testIds := strings.Split(testLocationVar, "/")
		rm.CloudApiV5Mocks.Location.EXPECT().GetByRegionAndLocationId(testIds[0], testIds[1]).Return(&loc, nil, testLocationErr)
		err := RunLocationGet(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLocationGetLocationErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(config.ArgQuiet, false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgLocationId), "us")
		err := RunLocationGet(cfg)
		assert.Error(t, err)
	})
}
