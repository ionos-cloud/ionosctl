...
func TestPreRunLanDelete(t *testing.T) {
	var b bytes.Buffer
	w := bufio.NewWriter(&b)
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		viper.Reset()
		...
		err := PreRunLanDelete(cfg)
		assert.NoError(t, err)
	})
}

func TestPreRunLanDeleteAll(t *testing.T) {
	var b bytes.Buffer
	w := bufio.NewWriter(&b)
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		viper.Reset()
...
func TestRunLanDeleteAllListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgAll), true)
		rm.CloudApiV5Mocks.Lan.EXPECT().List(testLanVar, resources.ListQueryParams{}).Return(lansList, &testResponse, testLanErr)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanDeleteAllItemsErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgAll), true)
		rm.CloudApiV5Mocks.Lan.EXPECT().List(testLanVar, resources.ListQueryParams{}).Return(resources.Lans{}, &testResponse, nil)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunLanDeleteAllLenErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgWaitForRequest), false)
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgAll), true)
		rm.CloudApiV5Mocks.Lan.EXPECT().List(testLanVar, resources.ListQueryParams{}).Return(
...
func TestRunLanDeleteAllErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
		...
		viper.Set(core.GetFlagName(cfg.NS, cloudapiv5.ArgAll), true)
		rm.CloudApiV5Mocks.Lan.EXPECT().List(testLanVar, resources.ListQueryParams{}).Return(lansList, &testResponse, nil)
		rm.CloudApiV5Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, testLanErr)
		rm.CloudApiV5Mocks.Lan.EXPECT().Delete(testLanVar, testLanVar).Return(&testResponse, testLanErr)
		err := RunLanDelete(cfg)
		assert.Error(t, err)
	})
