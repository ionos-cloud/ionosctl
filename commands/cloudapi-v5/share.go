...
func ShareCmd() *core.Command {
	...
	*/
	...
	list.AddStringFlag(cloudapiv5.ArgGroupId, "", "", cloudapiv5.GroupId, core.RequiredFlagOption())
	_ = list.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgGroupId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
	...
	*/
	...
	get.AddStringFlag(cloudapiv5.ArgGroupId, "", "", cloudapiv5.GroupId, core.RequiredFlagOption())
	...
	get.AddStringFlag(cloudapiv5.ArgResourceId, cloudapiv5.ArgIdShort, "", cloudapiv5.ResourceId, core.RequiredFlagOption())
	_ = get.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgResourceId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		return completer.GroupResourcesIds(os.Stderr, viper.GetString(core.GetFlagName(get.NS, cloudapiv5.ArgGroupId))), cobra.ShellCompDirectiveNoFileComp
	})
...
* Resource Id`,
	...
	create.AddStringFlag(cloudapiv5.ArgGroupId, "", "", cloudapiv5.GroupId, core.RequiredFlagOption())
	_ = create.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgGroupId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		return completer.GroupsIds(os.Stderr), cobra.ShellCompDirectiveNoFileComp
	})
	create.AddStringFlag(cloudapiv5.ArgResourceId, cloudapiv5.ArgIdShort, "", cloudapiv5.ResourceId, core.RequiredFlagOption())
	_ = create.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgResourceId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		return completer.ResourcesIds(os.Stderr), cobra.ShellCompDirectiveNoFileComp
	})
	create.AddBoolFlag(cloudapiv5.ArgEditPrivilege, "", false, "Set the group's permission to edit privileges on resource")
	create.AddBoolFlag(cloudapiv5.ArgSharePrivilege, "", false, "Set the group's permission to share resource")
...
* Resource Id`,
	...
	update.AddStringFlag(cloudapiv5.ArgGroupId, "", "", cloudapiv5.GroupId, core.RequiredFlagOption())
	...
	update.AddStringFlag(cloudapiv5.ArgResourceId, cloudapiv5.ArgIdShort, "", cloudapiv5.ResourceId, core.RequiredFlagOption())
	_ = update.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgResourceId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
		return completer.GroupResourcesIds(os.Stderr, viper.GetString(core.GetFlagName(update.NS, cloudapiv5.ArgGroupId))), cobra.ShellCompDirectiveNoFileComp
	})
	update.AddBoolFlag(cloudapiv5.ArgEditPrivilege, "", false, "Update the group's permission to edit privileges on resource")
	update.AddBoolFlag(cloudapiv5.ArgSharePrivilege, "", false, "Update the group's permission to share resource")
...
* Group Id`,
	...
	deleteCmd.AddStringFlag(cloudapiv5.ArgGroupId, "", "", cloudapiv5.GroupId, core.RequiredFlagOption())
	...
	deleteCmd.AddStringFlag(cloudapiv5.ArgResourceId, cloudapiv5.ArgIdShort, "", cloudapiv5.ResourceId, core.RequiredFlagOption())
	_ = deleteCmd.Command.RegisterFlagCompletionFunc(cloudapiv5.ArgResourceId, func(cmd *cobra.Command, args []string, toComplete string) ([]string, cobra.ShellCompDirective) {
...
func PreRunGroupResourceIds(c *core.PreCommandConfig) error {
	return core.CheckRequiredFlags(c.Command, c.NS, cloudapiv5.ArgGroupId, cloudapiv5.ArgResourceId)
}
...
func RunShareList(c *core.CommandConfig) error {
	shares, resp, err := c.CloudApiV5Services.Groups().ListShares(viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)))
	if resp != nil {
...
func RunShareGet(c *core.CommandConfig) error {
	...
	s, resp, err := c.CloudApiV5Services.Groups().GetShare(
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)),
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)),
	)
	if resp != nil {
...
func RunShareCreate(c *core.CommandConfig) error {
	editPrivilege := viper.GetBool(core.GetFlagName(c.NS, cloudapiv5.ArgEditPrivilege))
	sharePrivilege := viper.GetBool(core.GetFlagName(c.NS, cloudapiv5.ArgSharePrivilege))
	...
	c.Printer.Verbose("Adding Share for Resource ID: %v from Group with ID: %v...",
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)),
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)))
	shareAdded, resp, err := c.CloudApiV5Services.Groups().AddShare(
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)),
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)),
		input,
	)
...
func RunShareUpdate(c *core.CommandConfig) error {
	s, _, err := c.CloudApiV5Services.Groups().GetShare(viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)), viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)))
	if err != nil {
		return err
	}
	...
	c.Printer.Verbose("Updating Share for Resource ID: %v from Group with ID: %v...",
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)),
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)))
	shareUpdated, resp, err := c.CloudApiV5Services.Groups().UpdateShare(
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgGroupId)),
		viper.GetString(core.GetFlagName(c.NS, cloudapiv5.ArgResourceId)),
		newShare,
	)
...
func getShareUpdateInfo(oldShare *resources.GroupShare, c *core.CommandConfig) *resources.GroupShareProperties {
	...
	if properties, ok := oldShare.GetPropertiesOk(); ok && properties != nil {
		if viper.IsSet(core.GetFlagName(c.NS, cloudapiv5.ArgEditPrivilege)) {
			editPrivilege = viper.GetBool(core.GetFlagName(c.NS, cloudapiv5.ArgEditPrivilege))
		...
		if viper.IsSet(core.GetFlagName(c.NS, cloudapiv5.ArgSharePrivilege)) {
			sharePrivilege = viper.GetBool(core.GetFlagName(c.NS, cloudapiv5.ArgSharePrivilege))
...
func DeleteAllShares(c *core.CommandConfig) error {
	...
	groupShares, _, err := c.CloudApiV5Services.Groups().ListShares(groupId)
	if err != nil {
		return err
	}
