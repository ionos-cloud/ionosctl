...
var (
	...
	testInputFirewallRuleProperties = v6.FirewallRuleProperties{
...
func TestPreRunDcServerNicIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgDataCenterId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgServerId), testFirewallRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgNicId), testFirewallRuleVar)
