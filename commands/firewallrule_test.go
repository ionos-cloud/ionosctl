...
func TestPreRunGlobalDcServerNicIds(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgDataCenterId), testFirewallRuleVar)
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgServerId), testFirewallRuleVar)
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgNicId), testFirewallRuleVar)
...
func TestPreRunGlobalDcServerNicIdsErr(t *testing.T) {
	...
	core.PreCmdConfigTest(t, w, func(cfg *core.PreCommandConfig) {
		...
		viper.Set(core.GetGlobalFlagName(cfg.Namespace, config.ArgNicId), "")
		err := PreRunGlobalDcServerNicIds(cfg)
		assert.Error(t, err)
	})
}
