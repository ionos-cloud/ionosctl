...
func APIVersionCmd() *core.Command {
	...
	*/
	core.NewCommand(ctx, apiversionCmd, core.CommandBuilder{
		...
		Verb:       "list",
		Aliases:    []string{"l", "ls"},
		ShortDesc:  "List DBaaS Postgres API Versions",
		LongDesc:   "Use this command to retrieve all available DBaaS Postgres API versions.",
	...
	*/
	core.NewCommand(ctx, apiversionCmd, core.CommandBuilder{
		...
		Verb:       "get",
		Aliases:    []string{"g"},
		ShortDesc:  "Get current version of DBaaS Postgres API",
		LongDesc:   "Use this command to get the current version of DBaaS Postgres API.",
