...
func TestRunK8sNodeList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sClusterId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sNodePoolId), testNodeVar)
		rm.K8s.EXPECT().ListNodes(testNodeVar, testNodeVar).Return(nodesTest, &testResponse, nil)
...
func TestRunK8sNodeGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sNodePoolId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sClusterId), testNodeVar)
		rm.K8s.EXPECT().GetNode(testNodeVar, testNodeVar, testNodeVar).Return(&nodeTestGet, &testResponse, nil)
...
func TestRunK8sNodeRecreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sNodePoolId), testNodeVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgK8sClusterId), testNodeVar)
		rm.K8s.EXPECT().RecreateNode(testNodeVar, testNodeVar, testNodeVar).Return(&testResponse, nil)
