...
func TestRunShareList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(config.ArgOutput, config.DefaultOutputFormat)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgGroupId), testShareVar)
		rm.Group.EXPECT().ListShares(testShareVar).Return(shares, &testResponse, nil)
...
func TestRunShareGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgGroupId), testShareVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgResourceId), testShareVar)
		rm.Group.EXPECT().GetShare(testShareVar, testShareVar).Return(&shareTestGet, &testResponse, nil)
		err := RunShareGet(cfg)
		assert.NoError(t, err)
	})
}
...
func TestRunShareUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.Group.EXPECT().UpdateShare(testShareVar, testShareVar, shareNew).Return(&shareNew, &testResponse, nil)
