...
func TestRunTokenDeleteTokenId(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgTokenId), testTokenVar)
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgContractNo), testTokenContractNo)
			rm.AuthV1Mocks.Token.EXPECT().DeleteByID(testTokenVar, testTokenContractNo).Return(
				&testDeleteResponse, nil, nil,
			)
			err := RunTokenDelete(cfg)
			assert.NoError(t, err)
		},
...
func TestRunTokenDeleteCriteriaExpired(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgExpired), true)
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgContractNo), testTokenContractNo)
			rm.AuthV1Mocks.Token.EXPECT().DeleteByCriteria("EXPIRED", testTokenContractNo).Return(
				&testDeleteResponse, nil, nil,
			)
			err := RunTokenDelete(cfg)
			assert.NoError(t, err)
...
func TestRunTokenDeleteCriteriaAll(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgAll), true)
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgContractNo), testTokenContractNo)
			rm.AuthV1Mocks.Token.EXPECT().DeleteByCriteria("ALL", testTokenContractNo).Return(
				&testDeleteResponse, nil, nil,
			)
			err := RunTokenDelete(cfg)
			assert.NoError(t, err)
...
func TestRunTokenDeleteByIdErr(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgContractNo), testTokenContractNo)
			rm.AuthV1Mocks.Token.EXPECT().DeleteByID(testTokenVar, testTokenContractNo).Return(
				&testDeleteResponse, nil, testTokenErr,
			)
			err := RunTokenDeleteById(cfg)
			assert.Error(t, err)
		},
...
func TestRunTokenDeleteCurrent(t *testing.T) {
	...
	core.CmdConfigTest(
		t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocksTest) {
			...
			viper.Set(core.GetFlagName(cfg.NS, authv1.ArgContractNo), testTokenContractNo)
			viper.Set(constants.Token, testTokenVar)
			rm.AuthV1Mocks.Token.EXPECT().DeleteByCriteria("CURRENT", testTokenContractNo).Return(
				&testDeleteResponse, nil, nil,
			)
