...
func TestRunDataCenterGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.Datacenter.EXPECT().Get(testDatacenterVar).Return(&res, &testResponse, nil)
...
func TestRunDataCenterCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.Datacenter.EXPECT().Create(testDatacenterVar, testDatacenterVar, testDatacenterVar).Return(&v5.Datacenter{dc}, &testResponse, nil)
