...
func CertListCmd() *core.Command {
	cmd := core.NewCommand(context.Background(), nil, core.CommandBuilder{
		...
		Verb:       "list",
		Aliases:    []string{"l"},
		ShortDesc:  "List all uploaded certificates",
		LongDesc:   "List all uploaded certificates across every region your account can reach. Each row shows the certificate's ID, display name, validity dates, and whether it has expired. Private keys are never included.",
		Example:    "ionosctl certmanager certificate list",
