...
func TestRunNetworkLoadBalancerForwardingRuleList(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgDataCenterId), testNlbForwardingRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgNetworkLoadBalancerId), testNlbForwardingRuleVar)
		rm.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).Return(testNlbForwardingRules, &testResponse, nil)
...
func TestRunNetworkLoadBalancerForwardingRuleListErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgDataCenterId), testNlbForwardingRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgNetworkLoadBalancerId), testNlbForwardingRuleVar)
		rm.NetworkLoadBalancer.EXPECT().ListForwardingRules(testNlbForwardingRuleVar, testNlbForwardingRuleVar).
			Return(testNlbForwardingRules, nil, testNetworkLoadBalancerForwardingRuleErr)
		err := RunNetworkLoadBalancerForwardingRuleList(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNetworkLoadBalancerForwardingRuleGet(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgNetworkLoadBalancerId), testNlbForwardingRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgRuleId), testNlbForwardingRuleVar)
		rm.NetworkLoadBalancer.EXPECT().GetForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testNlbForwardingRuleVar).
...
func TestRunNetworkLoadBalancerForwardingRuleCreate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.NetworkLoadBalancer.EXPECT().CreateForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testInputForwardingRule).
			Return(&testNlbForwardingRuleGet, &testResponse, nil)
...
func TestRunNetworkLoadBalancerForwardingRuleCreateResponseErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgRetries), testNlbForwardingRuleIntVar)
		rm.NetworkLoadBalancer.EXPECT().CreateForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testInputForwardingRule).
			Return(&testNlbForwardingRuleGet, &testResponseErr, nil)
		err := RunNetworkLoadBalancerForwardingRuleCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNetworkLoadBalancerForwardingRuleCreateWaitErr(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgRetries), testNlbForwardingRuleIntVar)
		rm.NetworkLoadBalancer.EXPECT().CreateForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testInputForwardingRule).
			Return(&testNlbForwardingRuleGet, nil, nil)
		err := RunNetworkLoadBalancerForwardingRuleCreate(cfg)
		assert.Error(t, err)
	})
}
...
func TestRunNetworkLoadBalancerForwardingRuleUpdate(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		rm.NetworkLoadBalancer.EXPECT().UpdateForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testNlbForwardingRuleVar, &testNlbForwardingRulePropertiesNew).
...
func TestRunNetworkLoadBalancerForwardingRuleDelete(t *testing.T) {
	...
	core.CmdConfigTest(t, w, func(cfg *core.CommandConfig, rm *core.ResourcesMocks) {
		...
		viper.Set(core.GetFlagName(cfg.NS, config.ArgNetworkLoadBalancerId), testNlbForwardingRuleVar)
		viper.Set(core.GetFlagName(cfg.NS, config.ArgRuleId), testNlbForwardingRuleVar)
		rm.NetworkLoadBalancer.EXPECT().DeleteForwardingRule(testNlbForwardingRuleVar, testNlbForwardingRuleVar, testNlbForwardingRuleVar).Return(&testResponse, nil)
