...
func (m *MockK8sService) CreateCluster(u v6.K8sClusterForPost) (*v6.K8sCluster, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateCluster", u)
	ret0, _ := ret[0].(*v6.K8sCluster)
...
func (m *MockK8sService) CreateNodePool(clusterId string, nodepool v6.K8sNodePool) (*v6.K8sNodePool, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) DeleteCluster(clusterId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) DeleteNode(clusterId, nodepoolId, nodeId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) DeleteNodePool(clusterId, nodepoolId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) GetCluster(clusterId string) (*v6.K8sCluster, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) GetNode(clusterId, nodepoolId, nodeId string) (*v6.K8sNode, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNode", clusterId, nodepoolId, nodeId)
	ret0, _ := ret[0].(*v6.K8sNode)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockK8sService) GetNodePool(clusterId, nodepoolId string) (*v6.K8sNodePool, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) GetVersion() (string, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) ListClusters() (v6.K8sClusters, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListClusters")
	ret0, _ := ret[0].(v6.K8sClusters)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockK8sService) ListNodePools(clusterId string) (v6.K8sNodePools, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNodePools", clusterId)
	ret0, _ := ret[0].(v6.K8sNodePools)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockK8sService) ListNodes(clusterId, nodepoolId string) (v6.K8sNodes, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNodes", clusterId, nodepoolId)
	ret0, _ := ret[0].(v6.K8sNodes)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockK8sService) ListVersions() ([]string, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) ReadKubeConfig(clusterId string) (string, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) RecreateNode(clusterId, nodepoolId, nodeId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockK8sService) UpdateCluster(clusterId string, input v6.K8sClusterForPut) (*v6.K8sCluster, *v6.Response, error) {
	m.ctrl.T.Helper()
