...
func (m *MockClustersService) Create(input resources.CreateClusterRequest) (*resources.Cluster, *resources.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockClustersService) List() (resources.ClusterList, *resources.Response, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClustersServiceMockRecorder) List() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockClustersService)(nil).List))
}
