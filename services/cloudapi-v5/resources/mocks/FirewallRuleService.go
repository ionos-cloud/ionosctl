...
func (m *MockFirewallRulesService) List(datacenterId, serverId, nicId string, param resources.ListQueryParams) (resources.FirewallRules, *resources.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId, serverId, nicId, param)
...
func (mr *MockFirewallRulesServiceMockRecorder) List(datacenterId, serverId, nicId, param interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockFirewallRulesService)(nil).List), datacenterId, serverId, nicId, param)
}
