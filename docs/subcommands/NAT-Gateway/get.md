...
Use this command to get information about a specified NAT Gateway from a Virtual Data Center. Use `--wait` (`-w`) to wait for the resource to reach AVAILABLE state.
