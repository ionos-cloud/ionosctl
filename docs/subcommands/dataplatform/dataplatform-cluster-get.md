---
description: Get a Data Platform Cluster
---
...
Use this command to retrieve details about a Data Platform Cluster by using its ID.
...
```text
ionosctl dataplatform cluster get -i CLUSTER_ID
```
