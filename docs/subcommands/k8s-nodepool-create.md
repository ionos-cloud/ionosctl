...
```text
  ...
  -q, --quiet                      Quiet output
      --ram string                 The amount of memory for the node in MB, e.g. 2048 or 2048MB. Size must be specified in multiples of 1024 MB (1 GB) with a minimum of 2048 MB (default "2048")
