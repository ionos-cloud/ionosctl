...
```text
  ...
  -f, --force                    Force command to execute without user input
      --ftp-pass string          Override password for FTP server. If unset, defaults to API password
      --ftp-url string           URL of FTP server, with %s flag if location is embedded into url (default "ftp-%s.ionos.com")
      --ftp-user string          Override username for FTP server. If unset, defaults to API username
  -h, --help                     Print usage
