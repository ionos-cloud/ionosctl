...
```text
  -u, --api-url string            Override default host url (default "https://api.ionos.com")
      --cidr string               The IP and subnet for the cluster. Note the following unavailable IP ranges: 10.233.64.0/18, 10.233.0.0/18, 10.233.114.0/24. Example: 192.168.1.100/24
  ...
  -I, --instances int             The number of instances in your cluster. Minimum: 0. Maximum: 5
      --lan-id string             The unique ID of the LAN to connect your cluster to
  ...
  -q, --quiet                     Quiet output
      --ram string                The amount of memory per instance. Size must be specified in multiples of 1024. Minimum: 2048. The default unit is MB. e.g. --ram 2048 or --ram 2048MB
