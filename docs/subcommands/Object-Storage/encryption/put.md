...
# ObjectStorageEncryptionPut

## Usage

```text
ionosctl object-storage encryption put [flags]
```
...
```text
ionosctl object-storage encryption put --name my-bucket --json-properties encryption.json
