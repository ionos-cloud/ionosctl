...
```text
  ...
  -q, --quiet                Quiet output
      ...
      --timeout int          Timeout option for Request for Resource Share deletion [seconds] (default 60)
      --wait-for-request     Wait for the Request for Resource Share deletion to be executed
```
