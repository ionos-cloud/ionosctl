...
Use this command to get information about a specified Network Load Balancer from a Virtual Data Center. Use `--wait` (`-w`) to wait for the resource to reach AVAILABLE state.
