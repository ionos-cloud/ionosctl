...
Use this command to retrieve details about a specific NodePool from an existing Kubernetes Cluster. Use `--wait` (`-w`) to wait for the resource to reach AVAILABLE state.
