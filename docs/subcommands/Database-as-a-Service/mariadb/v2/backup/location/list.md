---
description: "List MariaDB Backup Locations"
---

# DbaasMariadbV2BackupLocationList

## Usage

```text
ionosctl dbaas mariadb-v2 backup location list [flags]
```
...
Use this command to retrieve a list of Object Storage locations where backups can be stored.
...
```text
ionosctl dbaas mariadb-v2 backup location list
```
