---
description: "Get a MariaDB Backup Location"
---

# DbaasMariadbV2BackupLocationGet

## Usage

```text
ionosctl dbaas mariadb-v2 backup location get [flags]
```
...
Use this command to retrieve details about a MariaDB Backup Location by using its ID.
...
```text
ionosctl dbaas mariadb-v2 backup location get --backup-location-id <backup-location-id>
```
