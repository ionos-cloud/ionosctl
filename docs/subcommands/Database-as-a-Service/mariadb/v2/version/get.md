---
description: "Get a MariaDB Version"
---

# DbaasMariadbV2VersionGet

## Usage

```text
ionosctl dbaas mariadb-v2 version get [flags]
```
...
Use this command to retrieve details about a MariaDB Version by using its ID.
...
```text
  ...
  -i, --version-id string   The ID of the MariaDB Version (required)
...
```text
ionosctl dbaas mariadb-v2 version get --version-id <version-id>
```
