---
description: "List MariaDB Versions"
---

# DbaasMariadbV2VersionList

## Usage

```text
ionosctl dbaas mariadb-v2 version list [flags]
```
...
Use this command to retrieve a list of available MariaDB Versions.
...
```text
ionosctl dbaas mariadb-v2 version list
```
