...
```text
  ...
  -l, --location string           The physical location where the cluster will be created. (defaults to the location of the connected datacenter)
      ...
      --maintenance-time string   Time for the MaintenanceWindows. The MaintenanceWindow is a weekly 4 hour-long windows, during which maintenance might occur. e.g.: 16:30:59Defaults to a random day of the week, during the hours 10:00-16:00 (default "16:00:00")
