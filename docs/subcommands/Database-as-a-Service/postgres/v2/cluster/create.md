...
```text
  ...
  -B, --backup-location string      The Object Storage location where the backups will be stored (default "eu-central-4")
      --backup-retention-days int   Configures how many days cluster backups are retained. Minimum: 1, Maximum: 365 (default 30)
  ...
  -c, --config string               Configuration file used for authentication (default "$XDG_CONFIG_HOME/ionosctl/config.yaml")
      --connection-pooler string    Connection pooling mode. Can be one of: DISABLED, TRANSACTION, SESSION (default "DISABLED")
      --cores int                   The number of CPU cores per instance. Minimum: 1, Maximum: 62 (default 2)
      --database string             The name of the initial database to be created (required)
  ...
  -l, --location string             Location of the resource to operate on. When unset, list commands query all locations. Can be one of: de/txl, de/fra, es/vit, fr/par, gb/lhr, gb/bhx, us/las, us/mci, us/ewr. A facility inside one of these metro regions (e.g. de/fra/1) is also accepted and served by its metro region's endpoint
  ...
  -q, --quiet                       Quiet output
      --ram string                  The amount of memory per instance in GB. Minimum: 4, Maximum: 240. e.g. --ram 4, --ram 4GB (default "4GB")
...
```text
ionosctl dbaas postgres-v2 cluster create --datacenter-id <datacenter-id> --lan-id <lan-id> --cidr <cidr> --db-username <username> --db-password <password> --database <database> --version <version>
```
