...
```text
  ...
  -B, --backup-location string      The Object Storage location where the backups will be stored
      --backup-retention-days int   Configures how many days cluster backups are retained. Minimum: 1, Maximum: 365
