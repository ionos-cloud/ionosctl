---
description: "Get an In-Memory DB Version"
---

# DbaasInMemoryDbV2VersionGet

## Usage

```text
ionosctl dbaas in-memory-db-v2 version get [flags]
```
...
Use this command to retrieve details about an In-Memory DB Version by using its ID.
...
```text
  ...
  -i, --version-id string   The ID of the In-Memory DB Version (required)
...
```text
ionosctl dbaas in-memory-db-v2 version get --version-id <version-id>
```
