---
description: "Get an In-Memory DB Cluster"
---

# DbaasInMemoryDbV2ClusterGet

## Usage

```text
ionosctl dbaas in-memory-db-v2 cluster get [flags]
```
...
Use this command to retrieve details about an In-Memory DB Cluster by using its ID.
...
```text
ionosctl dbaas in-memory-db-v2 cluster get --cluster-id <cluster-id>
```
