...
```text
  -a, --all              Delete all records. Required or --zone and --record
  ...
  -r, --record string    The ID or name of the DNS record. Required together with --zone or -a
...
```text
ionosctl dns r delete --zone ZONE --record-id RECORD
