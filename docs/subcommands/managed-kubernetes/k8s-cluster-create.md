...
```text
  ...
  -p, --public                The indicator if the cluster is public or private. Immutable property. Be aware that setting it to false is currently in beta phase. E.g.: --public=true, --public=false (default true)
