...
- [Remove an Application Load Balancer](#datacentersapplicationloadbalancersdelete)
- [Retrieve an Application Load Balancer](#datacentersapplicationloadbalancersfindbyapplicationloadbalancerid)
- [Remove Flow Log from Application Load Balancer](#datacentersapplicationloadbalancersflowlogsdelete)
- [Retrieve a Flow Log of the Application Load Balancer](#datacentersapplicationloadbalancersflowlogsfindbyflowlogid)
- [List Application Load Balancer Flow Logs](#datacentersapplicationloadbalancersflowlogsget)
- [Partially modify a Flow Log of the Application Load Balancer](#datacentersapplicationloadbalancersflowlogspatch)
- [Add a Application Load Balancer Flow Log](#datacentersapplicationloadbalancersflowlogspost)
- [Modify a Flow Log of the Application Load Balancer](#datacentersapplicationloadbalancersflowlogsput)
- [Remove Forwarding Rule from Application Load Balancer](#datacentersapplicationloadbalancersforwardingrulesdelete)
- [Retrieve a Forwarding Rule of the Application Load Balancer](#datacentersapplicationloadbalancersforwardingrulesfindbyforwardingruleid)
- [List Application Load Balancer Forwarding Rules](#datacentersapplicationloadbalancersforwardingrulesget)
- [Partially modify a forwarding rule of the Application Load Balancer](#datacentersapplicationloadbalancersforwardingrulespatch)
- [Add an Application Load Balancer Forwarding Rule](#datacentersapplicationloadbalancersforwardingrulespost)
- [Modify a forwarding rule of the Application Load Balancer](#datacentersapplicationloadbalancersforwardingrulesput)
- [List Application Load Balancers](#datacentersapplicationloadbalancersget)
- [Partially update an Application Load Balancer](#datacentersapplicationloadbalancerspatch)
- [Create an Application Load Balancer](#datacentersapplicationloadbalancerspost)
- [Update an Application Load Balancer](#datacentersapplicationloadbalancersput)
...
- [Remove a Target Group](#targetgroupsdelete)
- [Retrieve a Target Group](#targetgroupsfindbytargetgroupid)
- [List Target Groups](#targetgroupsget)
- [Partially update a Target Group](#targetgroupspatch)
- [Add a Target Group](#targetgroupspost)
- [Update a Target Group](#targetgroupsput)
...
Method | HTTP request | Description
------------- | ------------- | -------------
[**DatacentersApplicationloadbalancersDelete**](#DatacentersApplicationloadbalancersDelete) | **Delete** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId} | Remove an Application Load Balancer
[**DatacentersApplicationloadbalancersFindByApplicationLoadBalancerId**](#DatacentersApplicationloadbalancersFindByApplicationLoadBalancerId) | **Get** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId} | Retrieve an Application Load Balancer
[**DatacentersApplicationloadbalancersFlowlogsDelete**](#DatacentersApplicationloadbalancersFlowlogsDelete) | **Delete** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs/{flowLogId} | Remove Flow Log from Application Load Balancer
[**DatacentersApplicationloadbalancersFlowlogsFindByFlowLogId**](#DatacentersApplicationloadbalancersFlowlogsFindByFlowLogId) | **Get** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs/{flowLogId} | Retrieve a Flow Log of the Application Load Balancer
[**DatacentersApplicationloadbalancersFlowlogsGet**](#DatacentersApplicationloadbalancersFlowlogsGet) | **Get** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs | List Application Load Balancer Flow Logs
[**DatacentersApplicationloadbalancersFlowlogsPatch**](#DatacentersApplicationloadbalancersFlowlogsPatch) | **Patch** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs/{flowLogId} | Partially modify a Flow Log of the Application Load Balancer
[**DatacentersApplicationloadbalancersFlowlogsPost**](#DatacentersApplicationloadbalancersFlowlogsPost) | **Post** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs | Add a Application Load Balancer Flow Log
[**DatacentersApplicationloadbalancersFlowlogsPut**](#DatacentersApplicationloadbalancersFlowlogsPut) | **Put** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/flowlogs/{flowLogId} | Modify a Flow Log of the Application Load Balancer
[**DatacentersApplicationloadbalancersForwardingrulesDelete**](#DatacentersApplicationloadbalancersForwardingrulesDelete) | **Delete** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules/{forwardingRuleId} | Remove Forwarding Rule from Application Load Balancer
[**DatacentersApplicationloadbalancersForwardingrulesFindByForwardingRuleId**](#DatacentersApplicationloadbalancersForwardingrulesFindByForwardingRuleId) | **Get** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules/{forwardingRuleId} | Retrieve a Forwarding Rule of the Application Load Balancer
[**DatacentersApplicationloadbalancersForwardingrulesGet**](#DatacentersApplicationloadbalancersForwardingrulesGet) | **Get** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules | List Application Load Balancer Forwarding Rules
[**DatacentersApplicationloadbalancersForwardingrulesPatch**](#DatacentersApplicationloadbalancersForwardingrulesPatch) | **Patch** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules/{forwardingRuleId} | Partially modify a forwarding rule of the Application Load Balancer
[**DatacentersApplicationloadbalancersForwardingrulesPost**](#DatacentersApplicationloadbalancersForwardingrulesPost) | **Post** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules | Add an Application Load Balancer Forwarding Rule
[**DatacentersApplicationloadbalancersForwardingrulesPut**](#DatacentersApplicationloadbalancersForwardingrulesPut) | **Put** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId}/forwardingrules/{forwardingRuleId} | Modify a forwarding rule of the Application Load Balancer
[**DatacentersApplicationloadbalancersGet**](#DatacentersApplicationloadbalancersGet) | **Get** /datacenters/{datacenterId}/applicationloadbalancers | List Application Load Balancers
[**DatacentersApplicationloadbalancersPatch**](#DatacentersApplicationloadbalancersPatch) | **Patch** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId} | Partially update an Application Load Balancer
[**DatacentersApplicationloadbalancersPost**](#DatacentersApplicationloadbalancersPost) | **Post** /datacenters/{datacenterId}/applicationloadbalancers | Create an Application Load Balancer
[**DatacentersApplicationloadbalancersPut**](#DatacentersApplicationloadbalancersPut) | **Put** /datacenters/{datacenterId}/applicationloadbalancers/{applicationLoadBalancerId} | Update an Application Load Balancer



## DatacentersApplicationloadbalancersDelete

> DatacentersApplicationloadbalancersDelete(ctx, datacenterIdapplicationLoadBalancerIdoptional)
 ...
 **optional** | ***DatacentersApplicationloadbalancersDeleteOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersDeleteOpts struct
...
> ApplicationLoadBalancer DatacentersApplicationloadbalancersFindByApplicationLoadBalancerId(ctx, datacenterIdapplicationLoadBalancerIdoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
 **optional** | ***DatacentersApplicationloadbalancersFindByApplicationLoadBalancerIdOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFindByApplicationLoadBalancerIdOpts struct
...
> DatacentersApplicationloadbalancersFlowlogsDelete(ctx, datacenterIdapplicationLoadBalancerIdflowLogIdoptional)
 ...
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsDeleteOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsDeleteOpts struct
...
> FlowLog DatacentersApplicationloadbalancersFlowlogsFindByFlowLogId(ctx, datacenterIdapplicationLoadBalancerIdflowLogIdoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**flowLogId** | **string**| The unique ID of the Flow Log | 
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsFindByFlowLogIdOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsFindByFlowLogIdOpts struct
...
> FlowLogs DatacentersApplicationloadbalancersFlowlogsGet(ctx, datacenterIdapplicationLoadBalancerIdoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsGetOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsGetOpts struct
...
> FlowLog DatacentersApplicationloadbalancersFlowlogsPatch(ctx, datacenterIdapplicationLoadBalancerIdflowLogIdapplicationLoadBalancerFlowLogPropertiesoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**flowLogId** | **string**| The unique ID of the Flow Log | 
**applicationLoadBalancerFlowLogProperties** | [**FlowLogProperties**](#FlowLog)| Properties of a Flow Log to be updated | 
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsPatchOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsPatchOpts struct
...
> FlowLog DatacentersApplicationloadbalancersFlowlogsPost(ctx, datacenterIdapplicationLoadBalancerIdapplicationLoadBalancerFlowLogoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**applicationLoadBalancerFlowLog** | [**FlowLog**](#FlowLog)| Flow Log to add | 
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsPostOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsPostOpts struct
...
> FlowLog DatacentersApplicationloadbalancersFlowlogsPut(ctx, datacenterIdapplicationLoadBalancerIdflowLogIdapplicationLoadBalancerFlowLogoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**flowLogId** | **string**| The unique ID of the Flow Log | 
**applicationLoadBalancerFlowLog** | [**FlowLogPut**](#FlowLog)| Modified Application Load Balancer Flow Log | 
 **optional** | ***DatacentersApplicationloadbalancersFlowlogsPutOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersFlowlogsPutOpts struct
...
> DatacentersApplicationloadbalancersForwardingrulesDelete(ctx, datacenterIdapplicationLoadBalancerIdforwardingRuleIdoptional)
 ...
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesDeleteOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesDeleteOpts struct
...
> ApplicationLoadBalancerForwardingRule DatacentersApplicationloadbalancersForwardingrulesFindByForwardingRuleId(ctx, datacenterIdapplicationLoadBalancerIdforwardingRuleIdoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**forwardingRuleId** | **string**| The unique ID of the forwarding rule | 
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesFindByForwardingRuleIdOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesFindByForwardingRuleIdOpts struct
...
> ApplicationLoadBalancerForwardingRules DatacentersApplicationloadbalancersForwardingrulesGet(ctx, datacenterIdapplicationLoadBalancerIdoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesGetOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesGetOpts struct
...
[**ApplicationLoadBalancerForwardingRules**](#ApplicationLoadBalancerForwardingRules)
...
> ApplicationLoadBalancerForwardingRule DatacentersApplicationloadbalancersForwardingrulesPatch(ctx, datacenterIdapplicationLoadBalancerIdforwardingRuleIdapplicationLoadBalancerForwardingRulePropertiesoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**forwardingRuleId** | **string**| The unique ID of the forwarding rule | 
**applicationLoadBalancerForwardingRuleProperties** | [**ApplicationLoadBalancerForwardingRuleProperties**](#ApplicationLoadBalancerForwardingRule)| Properties of a forwarding rule to be updated | 
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesPatchOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesPatchOpts struct
...
> ApplicationLoadBalancerForwardingRule DatacentersApplicationloadbalancersForwardingrulesPost(ctx, datacenterIdapplicationLoadBalancerIdapplicationLoadBalancerForwardingRuleoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**applicationLoadBalancerForwardingRule** | [**ApplicationLoadBalancerForwardingRule**](#ApplicationLoadBalancerForwardingRule)| forwarding rule to add | 
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesPostOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesPostOpts struct
...
> ApplicationLoadBalancerForwardingRule DatacentersApplicationloadbalancersForwardingrulesPut(ctx, datacenterIdapplicationLoadBalancerIdforwardingRuleIdapplicationLoadBalancerForwardingRuleoptional)
...
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**forwardingRuleId** | **string**| The unique ID of the forwarding rule | 
**applicationLoadBalancerForwardingRule** | [**ApplicationLoadBalancerForwardingRulePut**](#ApplicationLoadBalancerForwardingRule)| Modified Application Load Balancer Forwarding Rule | 
 **optional** | ***DatacentersApplicationloadbalancersForwardingrulesPutOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersForwardingrulesPutOpts struct
...
> ApplicationLoadBalancers DatacentersApplicationloadbalancersGet(ctx, datacenterIdoptional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**datacenterId** | **string**| The unique ID of the datacenter | 
 **optional** | ***DatacentersApplicationloadbalancersGetOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersGetOpts struct
...
> ApplicationLoadBalancer DatacentersApplicationloadbalancersPatch(ctx, datacenterIdapplicationLoadBalancerIdapplicationLoadBalancerPropertiesoptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**applicationLoadBalancerProperties** | [**ApplicationLoadBalancerProperties**](#ApplicationLoadBalancer)| Application Load Balancer properties to be updated | 
 **optional** | ***DatacentersApplicationloadbalancersPatchOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersPatchOpts struct
...
> ApplicationLoadBalancer DatacentersApplicationloadbalancersPost(ctx, datacenterIdapplicationLoadBalanceroptional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancer** | [**ApplicationLoadBalancer**](#ApplicationLoadBalancer)| Application Load Balancer to be created | 
 **optional** | ***DatacentersApplicationloadbalancersPostOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersPostOpts struct
...
> ApplicationLoadBalancer DatacentersApplicationloadbalancersPut(ctx, datacenterIdapplicationLoadBalancerIdapplicationLoadBalanceroptional)
...
**datacenterId** | **string**| The unique ID of the datacenter | 
**applicationLoadBalancerId** | **string**| The unique ID of the Application Load Balancer | 
**applicationLoadBalancer** | [**ApplicationLoadBalancerPut**](#ApplicationLoadBalancer)| Modified Application Load Balancer | 
 **optional** | ***DatacentersApplicationloadbalancersPutOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a DatacentersApplicationloadbalancersPutOpts struct
...
Method | HTTP request | Description
------------- | ------------- | -------------
[**TargetGroupsDelete**](#TargetGroupsDelete) | **Delete** /targetgroups/{targetGroupId} | Remove a Target Group
[**TargetgroupsFindByTargetGroupId**](#TargetgroupsFindByTargetGroupId) | **Get** /targetgroups/{targetGroupId} | Retrieve a Target Group
[**TargetgroupsGet**](#TargetgroupsGet) | **Get** /targetgroups | List Target Groups
[**TargetgroupsPatch**](#TargetgroupsPatch) | **Patch** /targetgroups/{targetGroupId} | Partially update a Target Group
[**TargetgroupsPost**](#TargetgroupsPost) | **Post** /targetgroups | Add a Target Group
[**TargetgroupsPut**](#TargetgroupsPut) | **Put** /targetgroups/{targetGroupId} | Update a Target Group



## TargetGroupsDelete

> TargetGroupsDelete(ctx, targetGroupIdoptional)
 ...
 **optional** | ***TargetGroupsDeleteOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetGroupsDeleteOpts struct
...
> TargetGroup TargetgroupsFindByTargetGroupId(ctx, targetGroupIdoptional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**targetGroupId** | **string**| The unique ID of the Target Group | 
 **optional** | ***TargetgroupsFindByTargetGroupIdOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetgroupsFindByTargetGroupIdOpts struct
...
> TargetGroups TargetgroupsGet(ctx, optional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
 **optional** | ***TargetgroupsGetOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetgroupsGetOpts struct
...
> TargetGroup TargetgroupsPatch(ctx, targetGroupIdtargetGroupPropertiesoptional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**targetGroupId** | **string**| The unique ID of the Target Group | 
**targetGroupProperties** | [**TargetGroupProperties**](#TargetGroup)| Target Group properties to be updated | 
 **optional** | ***TargetgroupsPatchOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetgroupsPatchOpts struct
...
> TargetGroup TargetgroupsPost(ctx, targetGroupoptional)
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**targetGroup** | [**TargetGroup**](#TargetGroup)| Target Group to add | 
 **optional** | ***TargetgroupsPostOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetgroupsPostOpts struct
...
> TargetGroup TargetgroupsPut(ctx, targetGroupIdtargetGroupoptional)
...
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**targetGroupId** | **string**| The unique ID of the Target Group | 
**targetGroup** | [**TargetGroupPut**](#TargetGroup)| Modified Target Group | 
 **optional** | ***TargetgroupsPutOpts** | optional parameters | nil if no parameters

### Optional Parameters

Optional parameters are passed through a pointer to a TargetgroupsPutOpts struct
...
## Documentation For Models
 ...
 - [ApplicationLoadBalancer](#ApplicationLoadBalancer)
 - [ApplicationLoadBalancerEntities](#ApplicationLoadBalancerEntities)
 - [ApplicationLoadBalancerForwardingRule](#ApplicationLoadBalancerForwardingRule)
 - [ApplicationLoadBalancerForwardingRuleHealthCheck](#ApplicationLoadBalancerForwardingRuleHealthCheck)
 - [ApplicationLoadBalancerForwardingRuleProperties](#ApplicationLoadBalancerForwardingRuleProperties)
 - [ApplicationLoadBalancerForwardingRulePut](#ApplicationLoadBalancerForwardingRulePut)
 - [ApplicationLoadBalancerForwardingRules](#ApplicationLoadBalancerForwardingRules)
 - [ApplicationLoadBalancerHttpRule](#ApplicationLoadBalancerHttpRule)
 - [ApplicationLoadBalancerHttpRuleCondition](#ApplicationLoadBalancerHttpRuleCondition)
 - [ApplicationLoadBalancerProperties](#ApplicationLoadBalancerProperties)
 - [ApplicationLoadBalancerPut](#ApplicationLoadBalancerPut)
 - [ApplicationLoadBalancers](#ApplicationLoadBalancers)
 - [AttachedVolumes](#AttachedVolumes)
 - [BackupUnit](#BackupUnit)
 ...
 - [TargetGroupHttpHealthCheck](#TargetGroupHttpHealthCheck)
 - [TargetGroupProperties](#TargetGroupProperties)
 - [TargetGroupPut](#TargetGroupPut)
 - [TargetGroupTarget](#TargetGroupTarget)
 - [TargetGroupTargetHealthCheck](#TargetGroupTargetHealthCheck)
 - [TargetGroups](#TargetGroups)
...
**Entities** | [**ApplicationLoadBalancerEntities**](#ApplicationLoadBalancerEntities) |  | [optional] 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Forwardingrules** | [**ApplicationLoadBalancerForwardingRules**](#ApplicationLoadBalancerForwardingRules) |  | [optional] 
...
**Href** | **string** | URL to the object representation (absolute path) | [optional] [readonly] 
**Metadata** | [**DatacenterElementMetadata**](#DatacenterElementMetadata) |  | [optional] 
**Properties** | [**ApplicationLoadBalancerForwardingRuleProperties**](#ApplicationLoadBalancerForwardingRuleProperties) |  | 

[[Back to API list]](#documentation-for-api-endpoints) [[Back to Model list]](#documentation-for-models)

# ApplicationLoadBalancerForwardingRuleHealthCheck
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Name** | **string** | A name of that Application Load Balancer forwarding rule | 
...
**HealthCheck** | [**ApplicationLoadBalancerForwardingRuleHealthCheck**](#ApplicationLoadBalancerForwardingRuleHealthCheck) |  | [optional] 
**ServerCertificates** | **[]string** | Array of items in that collection | [optional] 
**HttpRules** | [**[]ApplicationLoadBalancerHttpRule**](#ApplicationLoadBalancerHttpRule) | Array of items in that collection | [optional] 
...
**Type** | [**Type**](#Type) | The type of object that has been created | [optional] 
**Href** | **string** | URL to the object representation (absolute path) | [optional] [readonly] 
**Items** | [**[]ApplicationLoadBalancerForwardingRule**](#ApplicationLoadBalancerForwardingRule) | Array of items in that collection | [optional] [readonly] 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Name** | **string** | The name of a Application Load Balancer http rule; unique per forwarding rule | 
**Type** | **string** | Type of the Http Rule. | 
**TargetGroup** | **string** | The UUID of the target group; mandatory and only valid for FORWARD action. | [optional] 
**DropQuery** | **bool** | Default is false; valid only for REDIRECT action. | [optional] 
**Location** | **string** | The location for redirecting; mandatory and valid only for REDIRECT action. | [optional] 
**StatusCode** | **int32** | Valid only for action REDIRECT and STATIC; on REDIRECT action default is 301 and it can take the values 301, 302, 303, 307, 308; on STATIC action default is 503 and it can take a value between 200 and 599 | [optional] 
**ResponseMessage** | **string** | The response message of the request; mandatory for STATIC action | [optional] 
**ContentType** | **string** | Valid only for action STATIC | [optional] 
**Conditions** | [**[]ApplicationLoadBalancerHttpRuleCondition**](#ApplicationLoadBalancerHttpRuleCondition) | Array of items in that collection | 
...
**Negate** | **bool** | Specifies whether the condition is negated or not; default: false | [optional] 
**Key** | **string** | Must be null when type is PATH, METHOD, HOST or SOURCE_IP. Key can only be set when type is COOKIES, HEADER, QUERY. | [optional] 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Name** | **string** | A name of that Application Load Balancer | 
**ListenerLan** | **int32** | Id of the listening LAN. (inbound) | 
**Ips** | **[]string** | Collection of IP addresses of the Application Load Balancer. (inbound and outbound) IP of the listenerLan must be a customer reserved IP for the public load balancer and private IP for the private load balancer. | [optional] 
**TargetLan** | **int32** | Id of the balanced private target LAN. (outbound) | 
**LbPrivateIps** | **[]string** | Collection of private IP addresses with subnet mask of the Application Load Balancer. IPs must contain valid subnet mask. If user will not provide any IP then the system will generate one IP with /24 subnet. | [optional] 
...
**Type** | [**Type**](#Type) | The type of object that has been created | [optional] 
**Href** | **string** | URL to the object representation (absolute path) | [optional] [readonly] 
**Items** | [**[]ApplicationLoadBalancer**](#ApplicationLoadBalancer) | Array of items in that collection | [optional] [readonly] 
**Offset** | **float32** | the offset (if specified in the request) | [optional] 
**Limit** | **float32** | the limit (if specified in the request) | [optional] 
**Links** | [**PaginationLinks**](#PaginationLinks) |  | [optional] 
...
**Href** | **string** | URL to the object representation (absolute path) | [optional] [readonly] 
**Metadata** | [**DatacenterElementMetadata**](#DatacenterElementMetadata) |  | [optional] 
**Properties** | [**TargetGroupProperties**](#TargetGroupProperties) |  | 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**CheckTimeout** | **int32** | It specifies the time (in milliseconds) for a target VM in this pool to answer the check. If a target VM has CheckInterval set and CheckTimeout is set too, then the smaller value of the two is used after the TCP connection is established. | [optional] 
**ConnectTimeout** | **int32** | It specifies the maximum time (in milliseconds) to wait for a connection attempt to a target VM to succeed. If unset, the default of 5 seconds will be used. | [optional] 
**TargetTimeout** | **int32** | TargetTimeout specifies the maximum inactivity time (in milliseconds) on the target VM side. If unset, the default of 50 seconds will be used. | [optional] 
**Retries** | **int32** | Retries specifies the number of retries to perform on a target VM after a connection failure. If unset, the default value of 3 will be used. (valid range: [0, 65535]) | [optional] 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Path** | **string** | The path for the HTTP health check; default: /. | [optional] 
**Method** | **string** | The method for the HTTP health check. | [optional] 
**MatchType** | **string** |  | 
**Response** | **string** | The response returned by the request | 
**Regex** | **bool** |  | [optional] 
...
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**Name** | **string** | A name of that Target Group | 
**Algorithm** | **string** | Algorithm for the balancing. | 
**Protocol** | **string** | Protocol of the balancing. | 
**Targets** | [**[]TargetGroupTarget**](#TargetGroupTarget) | Array of items in that collection | [optional] 
**HealthCheck** | [**TargetGroupHealthCheck**](#TargetGroupHealthCheck) |  | [optional] 
**HttpHealthCheck** | [**TargetGroupHttpHealthCheck**](#TargetGroupHttpHealthCheck) |  | [optional] 
...
**Port** | **int32** | Port of the balanced target service. (range: 1 to 65535) | 
**Weight** | **int32** | Weight parameter is used to adjust the target VM&#39;s weight relative to other target VMs. All target VMs will receive a load proportional to their weight relative to the sum of all weights, so the higher the weight, the higher the load. The default weight is 1, and the maximal value is 256. A value of 0 means the target VM will not participate in load-balancing but will still accept persistent connections. If this parameter is used to distribute the load according to target VM&#39;s capacity, it is recommended to start with values which can both grow and shrink, for instance between 10 and 100 to leave enough room above and below for later adjustments. | 
**HealthCheck** | [**TargetGroupTargetHealthCheck**](#TargetGroupTargetHealthCheck) |  | [optional] 
...
**Type** | [**Type**](#Type) | The type of object that has been created | [optional] 
**Href** | **string** | URL to the object representation (absolute path) | [optional] [readonly] 
**Items** | [**[]TargetGroup**](#TargetGroup) | Array of items in that collection | [optional] [readonly] 
**Offset** | **float32** | the offset (if specified in the request) | [optional] 
**Limit** | **float32** | the limit (if specified in the request) | [optional] 
**Links** | [**PaginationLinks**](#PaginationLinks) |  | [optional] 
