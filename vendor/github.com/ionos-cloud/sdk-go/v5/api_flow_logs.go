...
func (r ApiDatacentersServersNicsFlowlogsDeleteRequest) Execute() (map[string]interface{}, *APIResponse, error) {
 ...
 */
func (a *FlowLogsApiService) DatacentersServersNicsFlowlogsDeleteExecute(r ApiDatacentersServersNicsFlowlogsDeleteRequest) (map[string]interface{}, *APIResponse, error) {
	var (
