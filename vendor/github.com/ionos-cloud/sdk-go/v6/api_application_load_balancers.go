...
func (r ApiDatacentersApplicationloadbalancersPutRequest) Offset(offset int32) ApiDatacentersApplicationloadbalancersPutRequest {
	r.offset = &offset
	return r
}
func (r ApiDatacentersApplicationloadbalancersPutRequest) Limit(limit int32) ApiDatacentersApplicationloadbalancersPutRequest {
	r.limit = &limit
	return r
}
