...
func (o *CreateClusterProperties) GetInstances() *float32 {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateClusterProperties) GetInstancesOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateClusterProperties) SetInstances(v float32) {
...
// If the value is explicit nil, the zero value for float32 will be returned
func (o *CreateClusterProperties) GetCores() *float32 {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateClusterProperties) GetCoresOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateClusterProperties) SetCores(v float32) {
