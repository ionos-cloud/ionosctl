...
func (o *PatchClusterProperties) GetCores() *float32 {
	if o == nil {
		return nil
	}
...
func (o *PatchClusterProperties) GetCoresOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchClusterProperties) SetCores(v float32) {
...
// If the value is explicit nil, the zero value for float32 will be returned
func (o *PatchClusterProperties) GetInstances() *float32 {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchClusterProperties) GetInstancesOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchClusterProperties) SetInstances(v float32) {
