...
func (a *BackupsApiService) ClusterBackupsGetExecute(r ApiClusterBackupsGetRequest) (ClusterBackupList, *APIResponse, error) {
	...
	localVarPath := localBasePath + "/postgres/clusters/{clusterId}/backups"
...
func (a *BackupsApiService) ClustersBackupsFindByIdExecute(r ApiClustersBackupsFindByIdRequest) (ClusterBackup, *APIResponse, error) {
	...
	localVarPath := localBasePath + "/postgres/clusters/backups/{backupId}"
...
func (a *BackupsApiService) ClustersBackupsGetExecute(r ApiClustersBackupsGetRequest) (ClusterBackupList, *APIResponse, error) {
	...
	localVarPath := localBasePath + "/postgres/clusters/backups"
