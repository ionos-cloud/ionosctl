...
func (a *VolumesApiService) DatacentersVolumesCreateSnapshotPostExecute(r ApiDatacentersVolumesCreateSnapshotPostRequest) (Snapshot, *shared.APIResponse, error) {
	...
	if r.secAuthProtection != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "secAuthProtection", r.secAuthProtection, "")
	}
	if r.licenceType != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "licenceType", r.licenceType, "")
	}
	if r.ctx != nil {
...
func (a *VolumesApiService) DatacentersVolumesRestoreSnapshotPostExecute(r ApiDatacentersVolumesRestoreSnapshotPostRequest) (*shared.APIResponse, error) {
	...
	if r.snapshotId != nil {
		parameterAddToHeaderOrQuery(localVarFormParams, "snapshotId", r.snapshotId, "")
	}
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(shared.ContextAPIKeys).(map[string]shared.APIKey); ok {
