...
// If the value is explicit nil, the zero value for string will be returned
func (o *Cluster) GetCurrentDataPlatformVersion() *string {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Cluster) GetCurrentDataPlatformVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Cluster) SetCurrentDataPlatformVersion(v string) {
...
func (o *Cluster) HasCurrentDataPlatformVersion() bool {
...
func (o *Cluster) GetCurrentDataPlatformRevision() *int64 {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Cluster) GetCurrentDataPlatformRevisionOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Cluster) SetCurrentDataPlatformRevision(v int64) {
...
func (o *Cluster) HasCurrentDataPlatformRevision() bool {
...
// If the value is explicit nil, the zero value for []string will be returned
func (o *Cluster) GetAvailableUpgradeVersions() *[]string {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Cluster) GetAvailableUpgradeVersionsOk() (*[]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Cluster) SetAvailableUpgradeVersions(v []string) {
...
func (o *Cluster) HasAvailableUpgradeVersions() bool {
