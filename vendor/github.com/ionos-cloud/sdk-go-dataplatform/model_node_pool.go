...
// If the value is explicit nil, the zero value for string will be returned
func (o *NodePool) GetCurrentDataPlatformVersion() *string {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodePool) GetCurrentDataPlatformVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodePool) SetCurrentDataPlatformVersion(v string) {
...
func (o *NodePool) HasCurrentDataPlatformVersion() bool {
...
func (o *NodePool) GetCurrentDataPlatformRevision() *int64 {
	if o == nil {
		return nil
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *NodePool) GetCurrentDataPlatformRevisionOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NodePool) SetCurrentDataPlatformRevision(v int64) {
...
func (o *NodePool) HasCurrentDataPlatformRevision() bool {
