...
// PatchClusterProperties Properties of the payload to change a cluster: - instances can only be increased (3, 5, 7), - storageSize can only be increased, - ram and cores can be both increased and decreased.
