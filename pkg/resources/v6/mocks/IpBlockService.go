...
func (m *MockIpBlocksService) Create(name, location string, size int32) (*v6.IpBlock, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, location, size)
	ret0, _ := ret[0].(*v6.IpBlock)
...
func (m *MockIpBlocksService) Delete(ipBlockId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockIpBlocksService) Get(IpBlockId string) (*v6.IpBlock, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockIpBlocksService) List() (v6.IpBlocks, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.IpBlocks)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockIpBlocksService) Update(ipBlockId string, input v6.IpBlockProperties) (*v6.IpBlock, *v6.Response, error) {
	m.ctrl.T.Helper()
