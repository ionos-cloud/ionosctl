...
func (m *MockRequestsService) Get(requestId string) (*v6.Request, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", requestId)
	ret0, _ := ret[0].(*v6.Request)
...
func (m *MockRequestsService) GetStatus(requestId string) (*v6.RequestStatus, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStatus", requestId)
	ret0, _ := ret[0].(*v6.RequestStatus)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockRequestsService) List() (v6.Requests, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.Requests)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockRequestsService) Wait(requestId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
