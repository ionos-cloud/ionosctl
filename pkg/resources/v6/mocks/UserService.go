...
func (m *MockUsersService) Create(u v6.UserPost) (*v6.User, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Delete(userId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Get(userId string) (*v6.User, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) GetResourceByTypeAndId(resourceType, resourceId string) (*v6.Resource, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourceByTypeAndId", resourceType, resourceId)
	ret0, _ := ret[0].(*v6.Resource)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) GetResourcesByType(resourceType string) (v6.Resources, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourcesByType", resourceType)
	ret0, _ := ret[0].(v6.Resources)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) List() (v6.Users, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.Users)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) ListResources() (v6.Resources, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Update(userId string, input v6.UserPut) (*v6.User, *v6.Response, error) {
	m.ctrl.T.Helper()
