...
func (m *MockImagesService) Delete(imageId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockImagesService) Get(imageId string) (*v6.Image, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockImagesService) List() (v6.Images, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.Images)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockImagesService) Update(imageId string, imgProp v6.ImageProperties) (*v6.Image, *v6.Response, error) {
	m.ctrl.T.Helper()
