...
func (m *MockLoadbalancersService) AttachNic(datacenterId, loadbalancerId, nicId string) (*v6.Nic, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) Create(datacenterId, name string, dhcp bool) (*v6.Loadbalancer, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", datacenterId, name, dhcp)
	ret0, _ := ret[0].(*v6.Loadbalancer)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) Delete(datacenterId, loadbalancerId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) DetachNic(datacenterId, loadbalancerId, nicId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) Get(datacenterId, loadbalancerId string) (*v6.Loadbalancer, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) GetNic(datacenterId, loadbalancerId, nicId string) (*v6.Nic, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) List(datacenterId string) (v6.Loadbalancers, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId)
	ret0, _ := ret[0].(v6.Loadbalancers)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) ListNics(datacenterId, loadbalancerId string) (v6.BalancedNics, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNics", datacenterId, loadbalancerId)
	ret0, _ := ret[0].(v6.BalancedNics)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) Update(datacenterId, loadbalancerId string, input v6.LoadbalancerProperties) (*v6.Loadbalancer, *v6.Response, error) {
	m.ctrl.T.Helper()
