...
func (m *MockTemplatesService) Get(templateId string) (*v6.Template, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", templateId)
	ret0, _ := ret[0].(*v6.Template)
...
func (m *MockTemplatesService) List() (v6.Templates, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.Templates)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
