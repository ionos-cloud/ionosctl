...
func (m *MockNicsService) Create(datacenterId, serverId string, input v6.Nic) (*v6.Nic, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) Delete(datacenterId, serverId, nicId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) Get(datacenterId, serverId, nicId string) (*v6.Nic, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) List(datacenterId, serverId string) (v6.Nics, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId, serverId)
	ret0, _ := ret[0].(v6.Nics)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockNicsService) Update(datacenterId, serverId, nicId string, input v6.NicProperties) (*v6.Nic, *v6.Response, error) {
	m.ctrl.T.Helper()
