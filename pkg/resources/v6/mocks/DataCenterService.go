...
func (m *MockDatacentersService) Create(name, description, region string) (*v6.Datacenter, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, description, region)
	ret0, _ := ret[0].(*v6.Datacenter)
...
func (m *MockDatacentersService) Delete(datacenterId string) (*v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatacentersService) Get(datacenterId string) (*v6.Datacenter, *v6.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockDatacentersService) List() (v6.Datacenters, *v6.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v6.Datacenters)
	ret1, _ := ret[1].(*v6.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockDatacentersService) Update(datacenterId string, input v6.DatacenterProperties) (*v6.Datacenter, *v6.Response, error) {
	m.ctrl.T.Helper()
