...
func (m *MockUsersService) Create(u v5.UserPost) (*v5.User, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Delete(userId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Get(userId string) (*v5.User, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) GetResourceByTypeAndId(resourceType, resourceId string) (*v5.Resource, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourceByTypeAndId", resourceType, resourceId)
	ret0, _ := ret[0].(*v5.Resource)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) GetResourcesByType(resourceType string) (v5.Resources, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResourcesByType", resourceType)
	ret0, _ := ret[0].(v5.Resources)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) List() (v5.Users, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.Users)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockUsersService) ListResources() (v5.Resources, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockUsersService) Update(userId string, input v5.UserPut) (*v5.User, *v5.Response, error) {
	m.ctrl.T.Helper()
