...
func (m *MockS3KeysService) Create(userId string) (*v5.S3Key, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", userId)
	ret0, _ := ret[0].(*v5.S3Key)
...
func (m *MockS3KeysService) Delete(userId, keyId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockS3KeysService) Get(userId, keyId string) (*v5.S3Key, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockS3KeysService) List(userId string) (v5.S3Keys, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", userId)
	ret0, _ := ret[0].(v5.S3Keys)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockS3KeysService) Update(userId, keyId string, key v5.S3Key) (*v5.S3Key, *v5.Response, error) {
	m.ctrl.T.Helper()
