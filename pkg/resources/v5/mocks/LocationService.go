...
func (m *MockLocationsService) GetByRegionAndLocationId(regionId, locationId string) (*v5.Location, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByRegionAndLocationId", regionId, locationId)
	ret0, _ := ret[0].(*v5.Location)
...
func (m *MockLocationsService) GetByRegionId(regionId string) (v5.Locations, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByRegionId", regionId)
	ret0, _ := ret[0].(v5.Locations)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLocationsService) List() (v5.Locations, *v5.Response, error) {
	m.ctrl.T.Helper()
