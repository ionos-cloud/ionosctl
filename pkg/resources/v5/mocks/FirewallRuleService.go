...
func (m *MockFirewallRulesService) Create(datacenterId, serverId, nicId string, input v5.FirewallRule) (*v5.FirewallRule, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", datacenterId, serverId, nicId, input)
	ret0, _ := ret[0].(*v5.FirewallRule)
...
func (m *MockFirewallRulesService) Delete(datacenterId, serverId, nicId, firewallRuleId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockFirewallRulesService) Get(datacenterId, serverId, nicId, firewallRuleId string) (*v5.FirewallRule, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockFirewallRulesService) List(datacenterId, serverId, nicId string) (v5.FirewallRules, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId, serverId, nicId)
	ret0, _ := ret[0].(v5.FirewallRules)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockFirewallRulesService) Update(datacenterId, serverId, nicId, firewallRuleId string, input v5.FirewallRuleProperties) (*v5.FirewallRule, *v5.Response, error) {
	m.ctrl.T.Helper()
