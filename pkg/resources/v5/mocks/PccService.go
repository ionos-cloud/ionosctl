...
func (m *MockPccsService) Create(u v5.PrivateCrossConnect) (*v5.PrivateCrossConnect, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", u)
	ret0, _ := ret[0].(*v5.PrivateCrossConnect)
...
func (m *MockPccsService) Delete(pccId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPccsService) Get(pccId string) (*v5.PrivateCrossConnect, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockPccsService) GetPeers(pccId string) (*[]v5.Peer, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPeers", pccId)
	ret0, _ := ret[0].(*[]v5.Peer)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockPccsService) List() (v5.PrivateCrossConnects, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.PrivateCrossConnects)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockPccsService) Update(pccId string, input v5.PrivateCrossConnectProperties) (*v5.PrivateCrossConnect, *v5.Response, error) {
	m.ctrl.T.Helper()
