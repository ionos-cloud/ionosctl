...
func (m *MockRequestsService) Get(requestId string) (*v5.Request, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", requestId)
	ret0, _ := ret[0].(*v5.Request)
...
func (m *MockRequestsService) GetStatus(requestId string) (*v5.RequestStatus, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetStatus", requestId)
	ret0, _ := ret[0].(*v5.RequestStatus)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockRequestsService) List() (v5.Requests, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.Requests)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockRequestsService) Wait(requestId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
