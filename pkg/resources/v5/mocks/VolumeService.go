...
func (m *MockVolumesService) Create(datacenterId string, input v5.Volume) (*v5.Volume, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockVolumesService) Delete(datacenterId, volumeId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockVolumesService) Get(datacenterId, volumeId string) (*v5.Volume, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockVolumesService) List(datacenterId string) (v5.Volumes, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId)
	ret0, _ := ret[0].(v5.Volumes)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockVolumesService) Update(datacenterId, volumeId string, input v5.VolumeProperties) (*v5.Volume, *v5.Response, error) {
	m.ctrl.T.Helper()
