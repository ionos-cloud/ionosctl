...
func (m *MockNicsService) Create(datacenterId, serverId, name string, ips []string, dhcp bool, lan int32) (*v5.Nic, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) Delete(datacenterId, serverId, nicId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) Get(datacenterId, serverId, nicId string) (*v5.Nic, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockNicsService) List(datacenterId, serverId string) (v5.Nics, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId, serverId)
	ret0, _ := ret[0].(v5.Nics)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockNicsService) Update(datacenterId, serverId, nicId string, input v5.NicProperties) (*v5.Nic, *v5.Response, error) {
	m.ctrl.T.Helper()
