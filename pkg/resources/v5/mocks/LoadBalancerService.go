...
func (m *MockLoadbalancersService) AttachNic(datacenterId, loadbalancerId, nicId string) (*v5.Nic, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) Create(datacenterId, name string, dhcp bool) (*v5.Loadbalancer, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", datacenterId, name, dhcp)
	ret0, _ := ret[0].(*v5.Loadbalancer)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) Delete(datacenterId, loadbalancerId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) DetachNic(datacenterId, loadbalancerId, nicId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) Get(datacenterId, loadbalancerId string) (*v5.Loadbalancer, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) GetNic(datacenterId, loadbalancerId, nicId string) (*v5.Nic, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLoadbalancersService) List(datacenterId string) (v5.Loadbalancers, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId)
	ret0, _ := ret[0].(v5.Loadbalancers)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) ListNics(datacenterId, loadbalancerId string) (v5.BalancedNics, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListNics", datacenterId, loadbalancerId)
	ret0, _ := ret[0].(v5.BalancedNics)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLoadbalancersService) Update(datacenterId, loadbalancerId string, input v5.LoadbalancerProperties) (*v5.Loadbalancer, *v5.Response, error) {
	m.ctrl.T.Helper()
