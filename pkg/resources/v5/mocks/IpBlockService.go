...
func (m *MockIpBlocksService) Create(name, location string, size int32) (*v5.IpBlock, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", name, location, size)
	ret0, _ := ret[0].(*v5.IpBlock)
...
func (m *MockIpBlocksService) Delete(ipBlockId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockIpBlocksService) Get(IpBlockId string) (*v5.IpBlock, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockIpBlocksService) List() (v5.IpBlocks, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.IpBlocks)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockIpBlocksService) Update(ipBlockId string, input v5.IpBlockProperties) (*v5.IpBlock, *v5.Response, error) {
	m.ctrl.T.Helper()
