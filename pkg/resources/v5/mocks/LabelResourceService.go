...
func (m *MockLabelResourcesService) DatacenterCreate(datacenterId, key, value string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DatacenterCreate", datacenterId, key, value)
	ret0, _ := ret[0].(*v5.LabelResource)
...
func (m *MockLabelResourcesService) DatacenterDelete(datacenterId, key string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) DatacenterGet(datacenterId, key string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) DatacenterList(datacenterId string) (v5.LabelResources, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DatacenterList", datacenterId)
	ret0, _ := ret[0].(v5.LabelResources)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLabelResourcesService) GetByUrn(labelurn string) (*v5.Label, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetByUrn", labelurn)
	ret0, _ := ret[0].(*v5.Label)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLabelResourcesService) IpBlockCreate(ipblockId, key, value string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) IpBlockDelete(ipblockId, key string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) IpBlockGet(ipblockId, key string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) IpBlockList(ipblockId string) (v5.LabelResources, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) List() (v5.Labels, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.Labels)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockLabelResourcesService) ServerCreate(datacenterId, serverId, key, value string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) ServerDelete(datacenterId, serverId, key string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) ServerGet(datacenterId, serverId, key string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) ServerList(datacenterId, serverId string) (v5.LabelResources, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) SnapshotCreate(snapshotId, key, value string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) SnapshotDelete(snapshotId, key string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) SnapshotGet(snapshotId, key string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) SnapshotList(snapshotId string) (v5.LabelResources, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) VolumeCreate(datacenterId, serverId, key, value string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) VolumeDelete(datacenterId, serverId, key string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) VolumeGet(datacenterId, serverId, key string) (*v5.LabelResource, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockLabelResourcesService) VolumeList(datacenterId, serverId string) (v5.LabelResources, *v5.Response, error) {
	m.ctrl.T.Helper()
