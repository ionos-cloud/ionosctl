...
func (m *MockServersService) AttachCdrom(datacenterId, serverId, cdromId string) (*v5.Image, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) AttachVolume(datacenterId, serverId, volumeId string) (*v5.Volume, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AttachVolume", datacenterId, serverId, volumeId)
	ret0, _ := ret[0].(*v5.Volume)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockServersService) Create(datacenterId string, input v5.Server) (*v5.Server, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", datacenterId, input)
	ret0, _ := ret[0].(*v5.Server)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockServersService) Delete(datacenterId, serverId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) DetachCdrom(datacenterId, serverId, cdromId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) DetachVolume(datacenterId, serverId, volumeId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) Get(datacenterId, serverId string) (*v5.Server, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) GetCdrom(datacenterId, serverId, cdromId string) (*v5.Image, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) GetVolume(datacenterId, serverId, volumeId string) (*v5.Volume, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) List(datacenterId string) (v5.Servers, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", datacenterId)
	ret0, _ := ret[0].(v5.Servers)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockServersService) ListCdroms(datacenterId, serverId string) (v5.Cdroms, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListCdroms", datacenterId, serverId)
	ret0, _ := ret[0].(v5.Cdroms)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockServersService) ListVolumes(datacenterId, serverId string) (v5.AttachedVolumes, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListVolumes", datacenterId, serverId)
	ret0, _ := ret[0].(v5.AttachedVolumes)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockServersService) Reboot(datacenterId, serverId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) Start(datacenterId, serverId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) Stop(datacenterId, serverId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockServersService) Update(datacenterId, serverId string, input v5.ServerProperties) (*v5.Server, *v5.Response, error) {
	m.ctrl.T.Helper()
