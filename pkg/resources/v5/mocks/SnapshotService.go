...
func (m *MockSnapshotsService) Create(datacenterId, volumeId, name, description, licenceType string, secAuthProtection bool) (*v5.Snapshot, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", datacenterId, volumeId, name, description, licenceType, secAuthProtection)
	ret0, _ := ret[0].(*v5.Snapshot)
...
func (m *MockSnapshotsService) Delete(snapshotId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotsService) Get(snapshotId string) (*v5.Snapshot, *v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotsService) List() (v5.Snapshots, *v5.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].(v5.Snapshots)
	ret1, _ := ret[1].(*v5.Response)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockSnapshotsService) Restore(datacenterId, volumeId, snapshotId string) (*v5.Response, error) {
	m.ctrl.T.Helper()
...
func (m *MockSnapshotsService) Update(snapshotId string, snapshotProp v5.SnapshotProperties) (*v5.Snapshot, *v5.Response, error) {
	m.ctrl.T.Helper()
